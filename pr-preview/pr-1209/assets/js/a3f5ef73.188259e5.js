(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[44552],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_11_sign_universal_message_mdx_a3f_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-11-sign-universal-message-mdx-a3f.json
const site_docs_chain_03_build_11_sign_universal_message_mdx_a3f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-sign-universal-message","title":"Sign Universal Message","description":"Sign Message | Build | Push Chain Docs","source":"@site/docs/chain/03-build/11-Sign-Universal-Message.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/sign-universal-message","permalink":"/push-chain-website/pr-preview/pr-1209/docs/chain/build/sign-universal-message","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/11-Sign-Universal-Message.mdx","tags":[],"version":"current","sidebarPosition":11,"frontMatter":{"id":"docs-chain-build-sign-universal-message","title":"Sign Universal Message","hide_title":false,"slug":"./sign-universal-message","displayed_sidebar":"pushChainSidebar","sidebar_position":11,"image":"/assets/docs/previews/docs_chain_build--sign_universal_message.png"},"sidebar":"pushChainSidebar","previous":{"title":"Track Universal Transaction","permalink":"/push-chain-website/pr-preview/pr-1209/docs/chain/build/track-universal-transaction"},"next":{"title":"Utility Functions","permalink":"/push-chain-website/pr-preview/pr-1209/docs/chain/build/utility-functions"}}');
...
;// ./docs/chain/03-build/11-Sign-Universal-Message.mdx
