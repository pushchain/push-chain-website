"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[18383],{
...
/* harmony import */ var roughjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(252274);
...
var IshikawaDB = class {
  ...
  clear() {
    ...
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .clear */ .IU)();
  }
  getRoot() {
    return this.root;
  }
  addNode(rawLevel, text) {
    const label = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .common_default */ .Y2.sanitizeText(text, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)());
    if (!this.root) {
      this.root = { text: label, children: [] };
      this.stack = [{ level: 0, node: this.root }];
      (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setDiagramTitle */ .ke)(label);
      return;
    }
  ...
  getAccTitle() {
    return (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getAccTitle */ .iN)();
  }
  setAccTitle(title) {
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setAccTitle */ .SV)(title);
  }
  getAccDescription() {
    return (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getAccDescription */ .m7)();
  }
  setAccDescription(description) {
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setAccDescription */ .EI)(description);
  }
  getDiagramTitle() {
    return (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getDiagramTitle */ .ab)();
  }
  setDiagramTitle(title) {
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setDiagramTitle */ .ke)(title);
  }
};
...
var applyPaddedViewBox = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svgEl, pad, maxW) => {
  ...
  (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .configureSvgSize */ .a$)(svgEl, h, w, maxW);
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((_text, id, _version, diagram2) => {
  ...
  const drawConfig = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)();
  const { look, handDrawnSeed, themeVariables } = drawConfig;
  const fontSize = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_1__/* .parseFontSize */ .I5)(drawConfig.fontSize)[0] ?? FONT_SIZE_DEFAULT;
