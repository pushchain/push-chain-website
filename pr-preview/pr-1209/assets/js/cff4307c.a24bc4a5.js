"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[76317],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_04_ui_kit_102_examples_section_mdx_cff_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-04-ui-kit-102-examples-section-mdx-cff.json
const site_docs_chain_04_ui_kit_102_examples_section_mdx_cff_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/ui-kit/docs-chain-ui-kit-examples-section","title":"Examples","description":"Examples Section | UI Kit | Push Chain Docs","source":"@site/docs/chain/04-ui-kit/102-Examples-Section.mdx","sourceDirName":"chain/04-ui-kit","slug":"/chain/ui-kit/examples","permalink":"/push-chain-website/pr-preview/pr-1209/docs/chain/ui-kit/examples","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/04-ui-kit/102-Examples-Section.mdx","tags":[],"version":"current","sidebarPosition":102,"frontMatter":{"id":"docs-chain-ui-kit-examples-section","title":"Examples","hide_title":false,"slug":"./examples","displayed_sidebar":"pushChainSidebar","sidebar_position":102,"image":"/assets/docs/previews/docs_chain_ui_kit__section--examples.png"},"sidebar":"pushChainSidebar","previous":{"title":"Theme Variables","permalink":"/push-chain-website/pr-preview/pr-1209/docs/chain/ui-kit/customizations/theme-variables"},"next":{"title":"Single Wallet Example","permalink":"/push-chain-website/pr-preview/pr-1209/docs/chain/ui-kit/examples/single-wallet-example"}}');
...
;// ./docs/chain/04-ui-kit/102-Examples-Section.mdx
