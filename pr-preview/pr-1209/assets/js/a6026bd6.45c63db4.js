...
// customPropGTagEvent=send_transaction_route2_funds
  ...
  async function main() {
    ...
    await rl.question(':::prompt:::Please send Sepolia ETH to: ' + wallet.address + ', and ensure your UEA (' + client.universal.account + ') on Push Chain has pETH and at least 5 PC. Press Enter to continue.');
...
// customPropGTagEvent=send_transaction_route2_funds_erc20
  ...
  async function main() {
    ...
    console.log('UEA on Push Chain:', client.universal.account);
    await rl.question(':::prompt:::Please send Sepolia ETH to: ' + wallet.address + ', and ensure your UEA (' + client.universal.account + ') on Push Chain has pUSDT (BNB) and at least 5 PC. Press Enter to continue.');
...
// customPropGTagEvent=send_transaction_route3_native
  ...
  async function main() {
    ...
    await rl.question(':::prompt:::Please send Sepolia ETH to: ' + account.address + ', and ensure your CEA (' + ceaAddress + ') on BNB Testnet holds some BNB. Press Enter to continue.');
...
// customPropGTagEvent=send_transaction_route3_funds
  ...
  async function main() {
    ...
    await rl.question(':::prompt:::Please send Sepolia ETH to: ' + wallet.address + ', and ensure your CEA (' + ceaAddress + ') on BNB Testnet holds some USDT. Press Enter to continue.');
