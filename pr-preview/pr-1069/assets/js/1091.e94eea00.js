...
/* harmony export */ });
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(486079);
...
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(988626);
...
const addEntity = function(name, alias = void 0) {
  if (entities[name] === void 0) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Added new entity :", name);
  } else if (entities[name] && !entities[name].alias && alias) {
    entities[name].alias = alias;
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.info(`Add alias '${alias}' to entity '${name}'`);
  }
...
const addAttributes = function(entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function(entA, rolA, entB, rSpec) {
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Added new relationship :", rel);
};
...
const erDb = {
  Cardinality,
  Identification,
  getConfig: () => (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.c)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.x)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.c)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.c)().er;
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Drawing ER diagram");
  ...
  let g;
  g = new dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_0__/* .Graph */ .T({
    multigraph: true,
    directed: true,
    compound: false
  }).setGraph({
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
...
function generateId(str = "", prefix = "") {
  ...
  return `${strWithHyphen(prefix)}${strWithHyphen(simplifiedStr)}${(0,uuid__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)(
    str,
...
var forEach = __webpack_require__(585677);
