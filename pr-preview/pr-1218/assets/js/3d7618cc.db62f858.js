"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[30240],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_02_setup_101_tooling_section_mdx_3d7_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-02-setup-101-tooling-section-mdx-3d7.json
const site_docs_chain_02_setup_101_tooling_section_mdx_3d7_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/setup/docs-chain-setup-tooling-section","title":"Tooling","description":"Tooling Section | Setup | Push Chain Docs","source":"@site/docs/chain/02-setup/101-Tooling-Section.mdx","sourceDirName":"chain/02-setup","slug":"/chain/setup/tooling","permalink":"/push-chain-website/pr-preview/pr-1218/docs/chain/setup/tooling","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/02-setup/101-Tooling-Section.mdx","tags":[],"version":"current","sidebarPosition":101,"frontMatter":{"id":"docs-chain-setup-tooling-section","title":"Tooling","hide_title":false,"slug":"./tooling","displayed_sidebar":"pushChainSidebar","sidebar_position":101,"image":"/assets/docs/previews/docs_chain_setup__section--tooling.png"},"sidebar":"pushChainSidebar","previous":{"title":"Setup","permalink":"/push-chain-website/pr-preview/pr-1218/docs/chain/setup"},"next":{"title":"Wallet Setup","permalink":"/push-chain-website/pr-preview/pr-1218/docs/chain/setup/tooling/wallet-setup"}}');
...
;// ./docs/chain/02-setup/101-Tooling-Section.mdx
