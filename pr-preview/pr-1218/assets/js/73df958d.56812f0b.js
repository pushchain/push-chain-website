(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[36301],{
...
const CodeSnippetPlayground=()=>{return/*#__PURE__*/(0,jsx_runtime.jsx)(BrowserOnly/* default */.A,{fallback:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{display:'flex',justifyContent:'center',padding:'2rem'},children:/*#__PURE__*/(0,jsx_runtime.jsx)(SpinnerUnit/* default */.A,{type:SpinnerUnit/* SPINNER_TYPE */.N.PROCESSING,size:48})}),children:()=>/*#__PURE__*/(0,jsx_runtime.jsx)(CodeSnippetPlaygroundClient,{})});};const CodeSnippetPlaygroundClient=()=>{const _useState=(0,react.useState)(''),code=_useState[0],setCode=_useState[1];const _useState2=(0,react.useState)('react'),playgroundType=_useState2[0],setPlaygroundType=_useState2[1];const _useState3=(0,react.useState)(''),error=_useState3[0],setError=_useState3[1];const _useState4=(0,react.useState)(''),baseUrl=_useState4[0],setBaseUrl=_useState4[1];(0,react.useEffect)(()=>{// Set the base URL dynamically
