(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[18401],{
...
function DocItemMetadata(){var _assets$image;const _useDoc=(0,doc/* useDoc */.u)(),metadata=_useDoc.metadata,frontMatter=_useDoc.frontMatter,assets=_useDoc.assets;const image=(_assets$image=assets.image)!==null&&_assets$image!==void 0?_assets$image:frontMatter.image;return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(metadataUtils/* PageMetadata */.be,{title:metadata.title,description:metadata.description,keywords:frontMatter.keywords,image:image}),image&&/*#__PURE__*/(0,jsx_runtime.jsxs)(Head/* default */.A,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:card",content:"summary_large_image"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:site",content:"@PushChain"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:creator",content:"@PushChain"})]})]});}
...
// EXTERNAL MODULE: ./src/theme/PaginatorNavLink/index.js
var PaginatorNavLink = __webpack_require__(880222);
...
var client = __webpack_require__(444070);
...
var docsPreferredVersion = __webpack_require__(153886);
// EXTERNAL MODULE: ./node_modules/@docusaurus/plugin-content-docs/lib/client/docsVersion.js
var docsVersion = __webpack_require__(923025);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DocVersionBadge(_ref){let className=_ref.className;const versionMetadata=(0,docsVersion/* useDocsVersion */.r)();if(versionMetadata.badge){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)(className,ThemeClassNames/* ThemeClassNames */.G.docs.docVersionBadge,'badge badge--secondary'),children:/*#__PURE__*/(0,jsx_runtime.jsx)(Translate/* default */.A,{id:"theme.docs.versionBadge.label",values:{versionLabel:versionMetadata.label},children:'Version: {versionLabel}'})});}return null;}
// EXTERNAL MODULE: ./src/theme/TagsListInline/index.js
var TagsListInline = __webpack_require__(117290);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/EditMetaRow/index.js + 1 modules
var EditMetaRow = __webpack_require__(427807);
;// ./src/theme/DocItem/Footer/index.tsx
function DocItemFooter(){const _useDoc=(0,doc/* useDoc */.u)(),metadata=_useDoc.metadata;const editUrl=metadata.editUrl,lastUpdatedAt=metadata.lastUpdatedAt,lastUpdatedBy=metadata.lastUpdatedBy,tags=metadata.tags;const canDisplayTagsRow=tags.length>0;const canDisplayEditMetaRow=!!(editUrl||lastUpdatedAt||lastUpdatedBy);const canDisplayFooter=canDisplayTagsRow||canDisplayEditMetaRow;if(!canDisplayFooter){return null;}return/*#__PURE__*/(0,jsx_runtime.jsxs)("footer",{className:(0,clsx_m/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.docs.docFooter,'docusaurus-mt-lg'),children:[canDisplayTagsRow&&/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx_m/* default */.A)('row margin-top--sm',ThemeClassNames/* ThemeClassNames */.G.docs.docFooterTagsRow),children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"col",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagsListInline/* default */.A,{tags:tags})})}),canDisplayEditMetaRow&&/*#__PURE__*/(0,jsx_runtime.jsx)(EditMetaRow/* default */.A,{className:(0,clsx_m/* default */.A)('margin-top--sm',ThemeClassNames/* ThemeClassNames */.G.docs.docFooterEditMetaRow),editUrl:editUrl,lastUpdatedAt:lastUpdatedAt,lastUpdatedBy:lastUpdatedBy})]});}
...
// EXTERNAL MODULE: ./src/theme/TOCCollapsible/styles.module.css
var styles_module = __webpack_require__(890644);
;// ./src/theme/TOCCollapsible/index.tsx
const LINK_CLASS_NAME='table-of-contents__link toc-highlight';const LINK_ACTIVE_CLASS_NAME='table-of-contents__link--active';function TOCCollapsible(_ref){let toc=_ref.toc,className=_ref.className,minHeadingLevel=_ref.minHeadingLevel,maxHeadingLevel=_ref.maxHeadingLevel;const _useCollapsible=(0,Collapsible/* useCollapsible */.u)({initialState:true}),collapsed=_useCollapsible.collapsed,toggleCollapsed=_useCollapsible.toggleCollapsed;return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx_m/* default */.A)(styles_module/* default */.A.tocCollapsible,'thin-scrollbar',className),children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:styles_module/* default */.A.tocCollapsibleHeader,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("button",{type:"button",className:(0,clsx_m/* default */.A)('clean-btn',styles_module/* default */.A.tocCollapsibleButton,!collapsed&&styles_module/* default */.A.tocCollapsibleButtonExpanded,className),"aria-expanded":!collapsed,"aria-label":(0,Translate/* translate */.T)({id:'theme.TOCCollapsible.toggleButtonLabel',message:'Toggle table of contents',description:'The label used by the button on the collapsible TOC component'}),onClick:toggleCollapsed,children:[(0,Translate/* translate */.T)({id:'theme.TOCCollapsible.toggleButtonLabel',message:'On this page',description:'The label used by the button on the collapsible TOC component'}),/*#__PURE__*/(0,jsx_runtime.jsx)(index_esm/* FiChevronDown */.fK4,{className:styles_module/* default */.A.tocCollapsibleButtonIcon})]}),toc.length>0&&/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:styles_module/* default */.A.copyPageButtonWrapper,children:/*#__PURE__*/(0,jsx_runtime.jsx)(CopyPageButton/* CopyPageButton */.N,{})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Collapsible/* Collapsible */.N,{lazy:true,collapsed:collapsed,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TOCItems/* default */.A,{toc:toc,minHeadingLevel:minHeadingLevel,maxHeadingLevel:maxHeadingLevel,linkClassName:LINK_CLASS_NAME,linkActiveClassName:LINK_ACTIVE_CLASS_NAME})})]});}
// EXTERNAL MODULE: ./src/theme/DocItem/TOC/Mobile/styles.module.css
var Mobile_styles_module = __webpack_require__(53815);
;// ./src/theme/DocItem/TOC/Mobile/index.tsx
function DocItemTOCMobile(){const _useDoc=(0,doc/* useDoc */.u)(),toc=_useDoc.toc,frontMatter=_useDoc.frontMatter;return/*#__PURE__*/(0,jsx_runtime.jsx)(TOCCollapsible,{toc:toc,minHeadingLevel:frontMatter.toc_min_heading_level,maxHeadingLevel:frontMatter.toc_max_heading_level,className:(0,clsx_m/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.docs.docTocMobile,Mobile_styles_module/* default */.A.tocMobile)});}
// EXTERNAL MODULE: ./src/theme/TOC/index.js
var TOC = __webpack_require__(968000);
;// ./src/theme/DocItem/TOC/Desktop/index.tsx
function DocItemTOCDesktop(){const _useDoc=(0,doc/* useDoc */.u)(),toc=_useDoc.toc,frontMatter=_useDoc.frontMatter;return/*#__PURE__*/(0,jsx_runtime.jsx)(TOC/* default */.A,{toc:toc,minHeadingLevel:frontMatter.toc_min_heading_level,maxHeadingLevel:frontMatter.toc_max_heading_level,className:ThemeClassNames/* ThemeClassNames */.G.docs.docTocDesktop});}
...
function useSyntheticTitle(){const _useDoc=(0,doc/* useDoc */.u)(),metadata=_useDoc.metadata,frontMatter=_useDoc.frontMatter,contentTitle=_useDoc.contentTitle;const shouldRender=!frontMatter.hide_title&&typeof contentTitle==='undefined';if(!shouldRender){return null;}return metadata.title;}function DocItemContent(_ref){let children=_ref.children;const syntheticTitle=useSyntheticTitle();const contentRef=(0,react.useRef)(null);(0,InviteCodeWidget/* useInjectInviteCode */.x)(contentRef);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx_m/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.docs.docMarkdown,'markdown'),ref:contentRef,children:[syntheticTitle&&/*#__PURE__*/(0,jsx_runtime.jsx)("header",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* default */.A,{as:"h1",children:syntheticTitle})}),/*#__PURE__*/(0,jsx_runtime.jsx)(MDXContent/* default */.A,{children:children})]});}
...
// EXTERNAL MODULE: ./src/theme/DocBreadcrumbs/Items/Home/styles.module.css
var Home_styles_module = __webpack_require__(978375);
...
const homeHref=(0,useBaseUrl/* default */.Ay)('/docs');return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{className:"breadcrumbs__item",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{"aria-label":(0,Translate/* translate */.T)({id:'theme.docs.breadcrumbs.home',message:'Home page',description:'The ARIA label for the home page in the breadcrumbs'}),className:"breadcrumbs__link",href:homeHref,children:/*#__PURE__*/(0,jsx_runtime.jsx)(IconHome,{className:Home_styles_module/* default */.A.breadcrumbHomeIcon})})});}
// EXTERNAL MODULE: ./src/theme/DocBreadcrumbs/styles.module.css
var DocBreadcrumbs_styles_module = __webpack_require__(972890);
...
function BreadcrumbsItemLink(_ref){let children=_ref.children,href=_ref.href,isLast=_ref.isLast;const className='breadcrumbs__link';if(isLast){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:className,itemProp:"name",children:children});}return href?/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{className:className,href:href,itemProp:"item",children:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{itemProp:"name",children:children})}):/*#__PURE__*/// TODO Google search console doesn't like breadcrumb items without href.
...
function BreadcrumbsItem(_ref2){let children=_ref2.children,active=_ref2.active,index=_ref2.index,addMicrodata=_ref2.addMicrodata;return/*#__PURE__*/(0,jsx_runtime.jsxs)("li",Object.assign({},addMicrodata&&{itemScope:true,itemProp:'itemListElement',itemType:'https://schema.org/ListItem'},{className:(0,clsx_m/* default */.A)('breadcrumbs__item',{'breadcrumbs__item--active':active}),children:[children,/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{itemProp:"position",content:String(index+1)})]}));}function DocBreadcrumbs(){var _useLocation,_breadcrumbs;let breadcrumbs=(0,docsUtils/* useSidebarBreadcrumbs */.OF)();// override breadcrumps to add product as well
let locationpath=(_useLocation=(0,react_router/* useLocation */.zy)())===null||_useLocation===void 0?void 0:_useLocation.pathname;// remove /docs/ from path
...
// EXTERNAL MODULE: ./src/theme/DocItem/Layout/styles.module.css
var Layout_styles_module = __webpack_require__(627186);
;// ./src/theme/DocItem/Layout/index.tsx
/**
 * Decide if the toc should be rendered, on mobile or desktop viewports
 */function useDocTOC(){const _useDoc=(0,doc/* useDoc */.u)(),frontMatter=_useDoc.frontMatter,toc=_useDoc.toc;const windowSize=(0,useWindowSize/* useWindowSize */.l)();const hidden=frontMatter.hide_table_of_contents;const canRender=!hidden&&toc.length>0;const mobile=canRender?/*#__PURE__*/(0,jsx_runtime.jsx)(DocItemTOCMobile,{}):undefined;const desktop=canRender&&(windowSize==='desktop'||windowSize==='ssr')?/*#__PURE__*/(0,jsx_runtime.jsx)(DocItemTOCDesktop,{}):undefined;return{hidden,mobile,desktop};}function DocItemLayout(_ref){let children=_ref.children;const docTOC=useDocTOC();const _useDoc2=(0,doc/* useDoc */.u)(),metadata=_useDoc2.metadata;return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"row",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx_m/* default */.A)('col',Layout_styles_module/* default */.A.col,!!docTOC.desktop&&Layout_styles_module/* default */.A.docItemCol),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ContentVisibility/* default */.A,{metadata:metadata}),/*#__PURE__*/(0,jsx_runtime.jsx)(DocVersionBanner,{}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Layout_styles_module/* default */.A.docItemContainer,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("article",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(DocBreadcrumbs,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(DocVersionBadge,{}),docTOC.mobile,/*#__PURE__*/(0,jsx_runtime.jsx)(DocItemContent,{children:children}),/*#__PURE__*/(0,jsx_runtime.jsx)(DocItemFooter,{})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(DocItemPaginator,{})]})]}),docTOC.desktop&&/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"col col--3",children:docTOC.desktop})]});}
;// ./src/theme/DocItem/index.tsx
function DocItem(props){const docHtmlClassName="docs-doc-id-"+props.content.metadata.id;const MDXComponent=props.content;return/*#__PURE__*/(0,jsx_runtime.jsx)(doc/* DocProvider */._,{content:props.content,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(metadataUtils/* HtmlClassNameProvider */.e3,{className:docHtmlClassName,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(DocItemMetadata,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(DocItemLayout,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(MDXComponent,{})})]})});}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"breadcrumbHomeIcon":"breadcrumbHomeIcon_xK9p"});
    if(true) {
      (function() {
        var localsJsonString = "{\"breadcrumbHomeIcon\":\"breadcrumbHomeIcon_xK9p\"}";
        // 1778491104902
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"breadcrumbsContainer":"breadcrumbsContainer_Alpn"});
    if(true) {
      (function() {
        var localsJsonString = "{\"breadcrumbsContainer\":\"breadcrumbsContainer_Alpn\"}";
        // 1778491099260
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"docItemContainer":"docItemContainer_c0TR","docItemCol":"docItemCol_z5aJ","col":"col_Eq0k"});
    if(true) {
      (function() {
        var localsJsonString = "{\"docItemContainer\":\"docItemContainer_c0TR\",\"docItemCol\":\"docItemCol_z5aJ\",\"col\":\"col_Eq0k\"}";
        // 1778491077679
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"tocMobile":"tocMobile_bxCs"});
    if(true) {
      (function() {
        var localsJsonString = "{\"tocMobile\":\"tocMobile_bxCs\"}";
        // 1778491102920
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"tocCollapsible":"tocCollapsible_IbkY","tocCollapsibleHeader":"tocCollapsibleHeader_AQXz","tocCollapsibleButton":"tocCollapsibleButton_sE4w","tocCollapsibleButtonIcon":"tocCollapsibleButtonIcon_ns05","tocCollapsibleButtonExpanded":"tocCollapsibleButtonExpanded_DluM","copyPageButtonWrapper":"copyPageButtonWrapper_Oi11","table-of-contents__link--active":"table-of-contents__link--active_H3hm"});
    if(true) {
      (function() {
        var localsJsonString = "{\"tocCollapsible\":\"tocCollapsible_IbkY\",\"tocCollapsibleHeader\":\"tocCollapsibleHeader_AQXz\",\"tocCollapsibleButton\":\"tocCollapsibleButton_sE4w\",\"tocCollapsibleButtonIcon\":\"tocCollapsibleButtonIcon_ns05\",\"tocCollapsibleButtonExpanded\":\"tocCollapsibleButtonExpanded_DluM\",\"copyPageButtonWrapper\":\"copyPageButtonWrapper_Oi11\",\"table-of-contents__link--active\":\"table-of-contents__link--active_H3hm\"}";
        // 1778491104547
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
