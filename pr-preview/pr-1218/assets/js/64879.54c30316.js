"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[64879],{
...
/* harmony export */ });
/* harmony import */ var _chunk_4BX2VUAB_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(225871);
/* harmony import */ var _chunk_QZHKN3VN_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(572938);
/* harmony import */ var _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(928718);
/* harmony import */ var _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(617726);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(440797);
/* harmony import */ var _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(778731);
...
var DEFAULT_GITGRAPH_CONFIG = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.gitGraph;
var getConfig3 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(() => {
  const config = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)({
    ...DEFAULT_GITGRAPH_CONFIG,
    ...(0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)().gitGraph
  });
  return config;
}, "getConfig");
...
function getID() {
  return (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_2__/* .random */ .yT)({ length: 7 });
}
...
var commit = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(commitDB) {
  ...
  const config = getConfig3();
  id = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(id, config);
  msg = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(msg, config);
  tags = tags?.map((tag) => _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(tag, config));
  const newCommit = {
...
var branch = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(branchDB) {
  ...
  name = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(name, getConfig3());
...
var merge = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((mergeDB) => {
  ...
  const config = getConfig3();
  otherBranch = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(otherBranch, config);
  if (customId) {
    customId = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(customId, config);
  }
...
var cherryPick = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(cherryPickDB) {
  ...
  const config = getConfig3();
  sourceId = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(sourceId, config);
  targetId = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(targetId, config);
  tags = tags?.map((tag) => _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(tag, config));
  parentCommitId = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(parentCommitId, config);
...
var checkout = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(branch2) {
  branch2 = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(branch2, getConfig3());
...
var clear2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function() {
  state.reset();
  (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .clear */ .IU)();
}, "clear");
...
var db = {
  ...
  getDirection,
  getHead,
  setAccTitle: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setAccTitle */ .SV,
  getAccTitle: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getAccTitle */ .iN,
  getAccDescription: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getAccDescription */ .m7,
  setAccDescription: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setAccDescription */ .EI,
  setDiagramTitle: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setDiagramTitle */ .ke,
  getDiagramTitle: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getDiagramTitle */ .ab
};
...
var calcColorIndex = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((rawIndex, limit, avoidDefaultColor = false) => {
...
var drawCommitBullet = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
  const { theme } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
...
var getCommitPosition = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((commit2, pos, isParallelCommits) => {
  ...
  const useReduxGeometry = REDUX_GEOMETRY_THEMES.has((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)().theme ?? "");
...
var drawArrow = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((svg, commitA, commitB, allCommits) => {
  const { theme: arrowTheme } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
...
var drawBranches = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((svg, branches, gitGraphConfig, id) => {
  const { look, theme, themeVariables } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(txt, id, ver, diagObj) {
  ...
  _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin ?? 0,
    db2.getDiagramTitle()
  );
  (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setupGraphViewbox2 */ .mj)(void 0, diagram2, gitGraphConfig.diagramPadding, gitGraphConfig.useMaxWidth);
}, "draw");
...
var genGitGraphGradient = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((options) => {
  const { svgId } = options;
  let sections = "";
...
var genColor = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((options) => {
  const config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
...
var normalTheme = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((options) => {
