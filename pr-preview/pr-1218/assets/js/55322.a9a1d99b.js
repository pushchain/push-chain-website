"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[55322],{
...
/* harmony export */ });
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(440797);
...
/* harmony export */ });
/* harmony import */ var _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(617726);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(440797);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(416750);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9002);
...
var drawText = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)((element, textData) => {
  const nText = textData.text.replace(_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_0__/* .lineBreakRegex */ .H1, " ");
...
/* harmony export */ });
/* harmony import */ var _chunk_XPW4576I_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(843283);
/* harmony import */ var _chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(885685);
/* harmony import */ var _chunk_QZHKN3VN_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(572938);
/* harmony import */ var _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(928718);
/* harmony import */ var _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(617726);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(440797);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9002);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(416750);
...
var SequenceDB = class {
  constructor() {
    ...
    this.setAccTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccTitle */ .SV;
    this.setAccDescription = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccDescription */ .EI;
    this.setDiagramTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setDiagramTitle */ .ke;
    this.getAccTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getAccTitle */ .iN;
    this.getAccDescription = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getAccDescription */ .m7;
    this.getDiagramTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getDiagramTitle */ .ab;
    this.apply = this.apply.bind(this);
    this.parseBoxData = this.parseBoxData.bind(this);
    this.parseMessage = this.parseMessage.bind(this);
    this.clear();
    this.setWrap((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().wrap);
  ...
  autoWrap() {
    ...
    return (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().sequence?.wrap ?? false;
  }
  clear() {
    this.state.reset();
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .clear */ .IU)();
  }
  parseMessage(str) {
  ...
  parseBoxData(str) {
    ...
    return {
      text: cleanedText ? (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(cleanedText, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : void 0,
      color,
      wrap
    };
  }
  ...
  addLinks(actorId, text) {
    ...
    try {
      let sanitizedText = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(text.text, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
  ...
  addProperties(actorId, text) {
    const actor = this.getActor(actorId);
    try {
      const sanitizedText = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(text.text, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
    ...
    if (Array.isArray(param)) {
      ...
      switch (param.type) {
        ...
        case "altEnd":
          ...
          break;
        case "setAccTitle":
          (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccTitle */ .SV)(param.text);
          break;
        case "parStart":
  ...
  getConfig() {
    return (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().sequence;
  }
};
...
var getStyles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((options) => {
  ...
  const { look } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  return `.actor {
...
var drawRect2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(elem, rectData) {
  const rectElement = (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .drawRect */ .tk)(elem, rectData);
  if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)().look === "neo") {
...
var drawKatex = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(elem, textData, msgModel = null) {
  ...
  const linesSanitized = await (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .renderKatexSanitized */ .dj)(textData.text, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)());
...
var drawText = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(elem, textData) {
  ...
  let textHeight = 0;
  const lines = textData.text.split(_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.lineBreakRegex);
  const [_textFontSize, _textFontSizePx] = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseFontSize */ .I5)(textData.fontSize);
  let textElems = [];
  let dy = 0;
  ...
  for (let [i, line] of lines.entries()) {
    ...
    const text = line || _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .ZERO_WIDTH_SPACE */ .pe;
    if (textData.tspan) {
...
var drawActorTypeParticipant = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  ...
  const rect = (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getNoteRect */ .PB)();
  var cssclass = "actor";
  ...
  if (actor.properties?.icon) {
    ...
    if (iconSrc.charAt(0) === "@") {
      (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .drawEmbeddedImage */ .CP)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc.substr(1));
    } else {
      (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .drawImage */ .aC)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc);
    }
  }
  if (!isFooter) {
  ...
  _drawTextCandidateFunc(conf2, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(actor.description))(
    actor.description,
    g,
    rect.x,
    rect.y,
...
var drawActorTypeQueue = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  ...
  if (actor.properties?.icon) {
    ...
    if (iconSrc.charAt(0) === "@") {
      (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .drawEmbeddedImage */ .CP)(g, iconX, iconY, iconSrc.substr(1));
    } else {
      (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .drawImage */ .aC)(g, iconX, iconY, iconSrc);
    }
  }
  _drawTextCandidateFunc(conf2, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(actor.description))(
    actor.description,
...
var drawLoop = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(elem, loopModel, labelText, conf2, msg) {
  ...
  let txt = (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getTextObj */ .HT)();
  txt.text = labelText;
  ...
  txt.fontWeight = fontWeight;
  txt.wrap = true;
  let textElem = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(txt.text) ? await drawKatex(g, txt, loopModel) : drawText(g, txt);
  if (loopModel.sectionTitles !== void 0) {
    for (const [idx, item] of Object.entries(loopModel.sectionTitles)) {
      if (item.message) {
        ...
        if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(txt.text)) {
...
var drawBackgroundRect2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(elem, bounds2) {
  (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .drawBackgroundRect */ .lC)(elem, bounds2);
}, "drawBackgroundRect");
...
var _drawTextCandidateFunc = /* @__PURE__ */ (function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const [_actorFontSize, _actorFontSizePx] = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseFontSize */ .I5)(actorFontSize);
    const lines = content.split(_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.lineBreakRegex);
  ...
  async function byKatex(content, g, x, y, width, height, textAttrs, conf2) {
    const dim = await (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(content, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)());
    const s = g.append("switch");
    ...
    text.append("div").style("text-align", "center").style("vertical-align", "middle").html(await (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .renderKatexSanitized */ .dj)(content, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)()));
    byTspan(content, s, x, y, width, height, textAttrs, conf2);
    _setTextAttrs(text, textAttrs);
  }
...
var bounds = {
  ...
  init: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
    ...
    this.verticalPos = 0;
    setConf((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
  }, "init"),
  ...
  insert: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(startx, starty, stopx, stopy) {
    const _startx = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(startx, stopx);
    const _stopx = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(startx, stopx);
    const _starty = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(starty, stopy);
    const _stopy = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(starty, stopy);
  ...
  bumpVerticalPos: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(bump) {
    ...
    this.data.stopy = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(this.data.stopy, this.verticalPos);
  }, "bumpVerticalPos"),
...
var drawNote = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(elem, noteModel, id) {
  ...
  const textObj = (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getTextObj */ .HT)();
  ...
  const textElem = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(textObj.text) ? await drawKatex(g, textObj) : drawText(g, textObj);
...
async function boundMessage(_diagram, msgModel) {
  ...
  const lines = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.splitBreaks(message).length;
  const isKatexMsg = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(message);
  const textDims = isKatexMsg ? await (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(message, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(message, messageFont(conf));
  if (!isKatexMsg) {
  ...
  if (startx === stopx) {
    ...
    totalOffset += 30;
    const dx = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(textWidth / 2, conf.width / 2);
    bounds.insert(
      startx - dx,
...
var drawMessage = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(diagram2, msgModel, lineStartY, diagObj, msg, diagramId) {
  ...
  const textDims = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(message, messageFont(conf));
  const textObj = (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getTextObj */ .HT)();
  textObj.x = startx;
  textObj.y = starty + 10;
  ...
  textObj.tspan = false;
  if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(textObj.text)) {
  ...
  if (startx === stopx) {
    ...
    if (conf.rightAngles) {
      line = diagram2.append("path").attr(
        "d",
        `M  ${lineStartX},${lineStartY} H ${startx + _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`
      );
    } else {
      line = diagram2.append("path").attr(
        "d",
  ...
  if (conf.arrowMarkerAbsolute) {
    url = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getUrl */ .ID)(true);
  }
...
var addActorRenderingData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  ...
  for (const actorKey of actorKeys) {
    ...
    actor.width = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actor.width || conf.width, conf.width);
    actor.height = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actor.height || conf.height, conf.height);
    actor.margin = actor.margin || conf.actorMargin;
    maxHeight = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(maxHeight, actor.height);
...
var drawActors = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(diagram2, actors, actorKeys, isFooter, diagramId, diagObj, actorIndexMap) {
  if (!isFooter) {
    ...
    for (const actorKey of actorKeys) {
      ...
      maxHeight = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(maxHeight, height);
    }
...
var setConf = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(cnf) {
  (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .assignWithDepth_default */ .hH)(conf, cnf);
  if (cnf.fontFamily) {
...
var activationBounds = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(actor, actors) {
  ...
  const left = activations.reduce(
    function(acc, activation) {
      return _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(acc, activation.startx);
    },
    actorObj.x + actorObj.width / 2 - 1
  );
  const right = activations.reduce(
    function(acc, activation) {
      return _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(acc, activation.stopx);
    },
    actorObj.x + actorObj.width / 2 + 1
  );
  return [left, right];
...
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(msg.message, textConf);
    const totalOffset = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(textDims.height, conf.labelBoxHeight);
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(_text, id, _version, diagObj) {
  const { securityLevel, sequence, look } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  conf = sequence;
  let sandboxElement;
  ...
  (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .configureSvgSize */ .a$)(diagram2, height, width, conf.useMaxWidth);
...
async function getMaxMessageWidthPerActor(actors, messages, diagObj) {
  ...
  for (const msg of messages) {
    if (actors.get(msg.to) && actors.get(msg.from)) {
      ...
      const wrappedMessage = msg.wrap ? _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      const messageDimensions = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(wrappedMessage) ? await (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(msg.message, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(wrappedMessage, textFont);
      const messageWidth = messageDimensions.width + 2 * conf.wrapPadding;
      if (isMessage && msg.from === actor.nextActor) {
        maxMessageWidthPerActor[msg.to] = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
          maxMessageWidthPerActor[msg.to] || 0,
          messageWidth
        );
      } else if (isMessage && msg.from === actor.prevActor) {
        maxMessageWidthPerActor[msg.from] = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
        ...
        maxMessageWidthPerActor[actor.prevActor] = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
...
var getRequiredPopupWidth = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(actor) {
  ...
  for (const key in actor.links) {
    const labelDimensions = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(key, textFont);
...
async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
  ...
  for (const prop of actors.keys()) {
    ...
    if (actor.wrap) {
      actor.description = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(
        actor.description,
        conf.width - 2 * conf.wrapPadding,
        actorFont(conf)
      );
    }
    const actDims = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(actor.description) ? await (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(actor.description, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(actor.description, actorFont(conf));
    actor.width = actor.wrap ? conf.width : _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
    actor.height = actor.wrap ? _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actDims.height, conf.height) : conf.height;
    maxHeight = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(maxHeight, actor.height);
  }
  for (const actorKey in actorToMessageWidth) {
    ...
    if (!nextActor) {
      ...
      actor.margin = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actorWidth2, conf.actorMargin);
      continue;
    }
    const messageWidth = actorToMessageWidth[actorKey];
    const actorWidth = messageWidth + conf.actorMargin - actor.width / 2 - nextActor.width / 2;
    actor.margin = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actorWidth, conf.actorMargin);
  }
  let maxBoxHeight = 0;
  boxes.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(box.name, textFont);
    maxBoxHeight = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(boxMsgDimensions.height, maxBoxHeight);
    const minWidth = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(totalWidth, boxMsgDimensions.width + 2 * conf.wrapPadding);
  ...
  return _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(maxHeight, conf.height);
}
...
var buildNoteModel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(msg, actors, diagObj) {
  ...
  let textDimensions = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(msg.message) ? await (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(msg.message, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(
    shouldWrap ? _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
    width: shouldWrap ? conf.width : _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
    height: 0,
    startx: fromActor.x,
    stopx: 0,
    starty: 0,
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    noteModel.width = shouldWrap ? _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, textDimensions.width) : _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx + (fromActor.width + conf.actorMargin) / 2;
  } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
    noteModel.width = shouldWrap ? _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx - noteModel.width + (fromActor.width - conf.actorMargin) / 2;
  } else if (msg.to === msg.from) {
    textDimensions = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(
      shouldWrap ? _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(msg.message, _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, fromActor.width), noteFont(conf)) : msg.message,
      noteFont(conf)
    );
    noteModel.width = shouldWrap ? _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, fromActor.width) : _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(fromActor.width, conf.width, textDimensions.width + 2 * conf.noteMargin);
  ...
  if (shouldWrap) {
    noteModel.message = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(
      msg.message,
...
var buildMessageModel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(msg, actors, diagObj) {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(
      msg.message,
      _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
...
var calculateLoopBounds = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(messages, actors, _maxWidthPerActor, diagObj) {
  ...
  for (const msg of messages) {
    ...
    if (isNote) {
      ...
      stack.forEach((stk) => {
        current = stk;
        current.from = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(current.from, noteModel.startx);
        current.to = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(current.to, noteModel.startx + noteModel.width);
        current.width = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
      });
    } else {
      ...
      if (msgModel.startx && msgModel.stopx && stack.length > 0) {
        stack.forEach((stk) => {
          ...
          if (msgModel.startx === msgModel.stopx) {
            ...
            current.from = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(
              from.x - msgModel.width / 2,
              from.x - from.width / 2,
              current.from
            );
            current.to = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
              to.x + msgModel.width / 2,
              to.x + from.width / 2,
              current.to
            );
            current.width = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(current.width, Math.abs(current.to - current.from)) - conf.labelBoxWidth;
          } else {
            current.from = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(msgModel.startx, current.from);
            current.to = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(msgModel.stopx, current.to);
            current.width = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(current.width, msgModel.width) - conf.labelBoxWidth;
          }
        });
      }
    }
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((cnf) => {
    ...
    if (cnf.wrap) {
      ...
      (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setConfig2 */ .XV)({ sequence: { wrap: cnf.wrap } });
    }
  }, "init")
};
