"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[8334],{
...
/* harmony export */ });
/* harmony import */ var _chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(389625);
/* harmony import */ var _chunk_EDXVE4YY_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(789125);
/* harmony import */ var _chunk_336JU56O_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(29444);
/* harmony import */ var _chunk_ENJZ2VHE_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(873353);
/* harmony import */ var _chunk_BSJP7CBP_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(411334);
/* harmony import */ var _chunk_5FUZZQ4R_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(529092);
/* harmony import */ var _chunk_ZZ45TVLE_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(497963);
/* harmony import */ var _chunk_X2U36JSP_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(338278);
/* harmony import */ var _chunk_U2HBQHQK_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(940519);
/* harmony import */ var _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(928718);
/* harmony import */ var _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(617726);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(440797);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9002);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(225582);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(375937);
...
var ErDB = class {
  constructor() {
    ...
    this.setAccTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setAccTitle */ .SV;
    this.getAccTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getAccTitle */ .iN;
    this.setAccDescription = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setAccDescription */ .EI;
    this.getAccDescription = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getAccDescription */ .m7;
    this.setDiagramTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setDiagramTitle */ .ke;
    this.getDiagramTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getDiagramTitle */ .ab;
    this.getConfig = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(() => (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)().er, "getConfig");
    this.clear();
  ...
  addEntity(name, alias = "") {
    if (!this.entities.has(name)) {
      this.entities.set(name, {
        ...
        alias,
        shape: "erBox",
        look: (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)().look ?? "default",
        cssClasses: "default",
        cssStyles: [],
        labelType: "markdown"
      });
  ...
  clear() {
    ...
    this.classes = /* @__PURE__ */ new Map();
    this.relationships = [];
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .clear */ .IU)();
  }
  getData() {
    const nodes = [];
    const edges = [];
    const config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
    let colorIndex = 0;
    ...
    for (const relationship of this.relationships) {
      const edge = {
        id: (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getEdgeId */ .rY)(relationship.entityA, relationship.entityB, {
          prefix: "id",
          counter: count++
        }),
        type: "normal",
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(async function(text, id, _version, diag) {
  ...
  const { securityLevel, er: conf, layout } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramElement */ .A)(id, securityLevel);
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_336JU56O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  ...
  await (0,_chunk_336JU56O_mjs__WEBPACK_IMPORTED_MODULE_2__/* .render */ .XX)(data4Layout, svg);
  ...
  const padding = 8;
  _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default */ ._K.insertTitle(
    svg,
    "erDiagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_EDXVE4YY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, padding, "erDiagram", conf?.useMaxWidth ?? true);
}, "draw");
