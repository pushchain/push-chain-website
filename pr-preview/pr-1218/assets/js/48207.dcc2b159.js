"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[48207],{
...
var DEFAULT_PIE_CONFIG = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.pie;
var DEFAULT_PIE_DB = {
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((text, id, _version, diagObj) => {
  ...
  const globalConfig = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  const pieConfig = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(db2.getConfig(), globalConfig.pie);
  const MARGIN = 40;
  ...
  let [outerStrokeWidth] = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_2__/* .parseFontSize */ .I5)(themeVariables.pieOuterStrokeWidth);
  outerStrokeWidth ??= 2;
  ...
  (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */ .a$)(svg, height, totalWidth, pieConfig.useMaxWidth);
}, "draw");
var renderer = { draw };
