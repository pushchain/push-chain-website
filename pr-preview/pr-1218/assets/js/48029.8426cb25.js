"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[48029],{
...
var dagre = __webpack_require__(399051);
...
var clone = __webpack_require__(250053);
...
var graph = __webpack_require__(537981);
...
var recursiveRender = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  ...
  await Promise.all(
    graph.nodes().map(async function(v) {
      ...
      if (node?.clusterNode) {
        ...
        const newEl = o.elem;
        (0,chunk_5FUZZQ4R/* updateNodeBounds */.lC)(node, newEl);
        node.diff = o.diff || 0;
        chunk_AGHRB4JF/* log */.Rm.info(
        ...
        (0,chunk_5FUZZQ4R/* setNodeElem */.U7)(newEl, node);
      } else {
        if (graph.children(v).length > 0) {
          ...
          await (0,chunk_5FUZZQ4R/* insertNode */.on)(nodes, graph.node(v), { config: siteConfig, dir });
        }
      }
    })
  );
  const processEdges = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async () => {
    const edgePromises = graph.edges().map(async function(e) {
      ...
      await (0,chunk_ENJZ2VHE/* insertEdgeLabel */.jP)(edgeLabels, edge);
    });
  ...
  let diff = 0;
  let { subGraphTitleTotalMargin } = (0,chunk_ZZ45TVLE/* getSubGraphTitleMargins */.O)(siteConfig);
  await Promise.all(
    sortNodesByHierarchy(graph).map(async function(v) {
      ...
      if (node?.clusterNode) {
        ...
        (0,chunk_5FUZZQ4R/* positionNode */.U_)(node);
      } else {
        if (graph.children(v).length > 0) {
          chunk_AGHRB4JF/* log */.Rm.info(
          ...
          await (0,chunk_5FUZZQ4R/* insertCluster */.U)(clusters, node);
          clusterDb.get(node.id).node = node;
        } else {
  ...
  graph.edges().forEach(function(e) {
    ...
    const paths = (0,chunk_ENJZ2VHE/* insertEdge */.Jo)(edgePaths, edge, clusterDb, diagramType, startNode, endNode, id);
    (0,chunk_ENJZ2VHE/* positionEdgeLabel */.T_)(edge, paths);
  });
...
var render = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async (data4Layout, svg) => {
  ...
  (0,chunk_ENJZ2VHE/* markers_default */.g0)(element, data4Layout.markers, data4Layout.type, data4Layout.diagramId);
  (0,chunk_5FUZZQ4R/* clear2 */.gh)();
  (0,chunk_ENJZ2VHE/* clear */.IU)();
  (0,chunk_5FUZZQ4R/* clear */.IU)();
  clear4();
  ...
  const siteConfig = (0,chunk_ICPOFSXX/* getConfig2 */.D7)();
