"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[58484],{
...
/* harmony import */ var _chunk_XPW4576I_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(843283);
/* harmony import */ var _chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(885685);
/* harmony import */ var _chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(389625);
/* harmony import */ var _chunk_EDXVE4YY_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(789125);
/* harmony import */ var _chunk_336JU56O_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(29444);
/* harmony import */ var _chunk_ENJZ2VHE_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(873353);
/* harmony import */ var _chunk_BSJP7CBP_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(411334);
/* harmony import */ var _chunk_5FUZZQ4R_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(529092);
/* harmony import */ var _chunk_ZZ45TVLE_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(497963);
/* harmony import */ var _chunk_X2U36JSP_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(338278);
/* harmony import */ var _chunk_U2HBQHQK_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(940519);
/* harmony import */ var _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(928718);
/* harmony import */ var _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(617726);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(440797);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(9002);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(599418);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(225582);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(375937);
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getConfig2 */ .D7)();
    this.diagramId = "";
    ...
    this.funs = [];
    this.setAccTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .setAccTitle */ .SV;
    this.setAccDescription = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .setAccDescription */ .EI;
    this.setDiagramTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .setDiagramTitle */ .ke;
    this.getAccTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getAccTitle */ .iN;
    this.getAccDescription = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getAccDescription */ .m7;
    this.getDiagramTitle = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getDiagramTitle */ .ab;
  ...
  sanitizeText(txt) {
    return _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .common_default */ .Y2.sanitizeText(txt, this.config);
  }
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_5FUZZQ4R_mjs__WEBPACK_IMPORTED_MODULE_8__/* .isValidShape */ .aP)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    if (id && !this.edges.some((e) => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getEdgeId */ .rY)(edge.start, edge.end, { counter: 0, prefix: "L" });
      } else {
        edge.id = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getEdgeId */ .rY)(edge.start, edge.end, {
...
You have to call mermaid.initialize.`
  ...
  setClickFun(id, functionName, functionArgs) {
    if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getConfig2 */ .D7)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_12__/* .utils_default */ ._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_12__/* .utils_default */ ._K.formatUrl(linkStr, this.config);
  ...
  setupToolTips(element) {
    const tooltipElem = (0,_chunk_YZCP3GAM_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createTooltip */ .Ck)();
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getConfig2 */ .D7)();
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .clear */ .IU)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    let dir = result.dir;
    const flowchartConfig = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getConfig2 */ .D7)().flowchart ?? {};
    dir = dir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getConfig2 */ .D7)().direction ?? void 0 : void 0);
  ...
  getData() {
    const config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getConfig2 */ .D7)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_12__/* .getEdgeId */ .rY)(rawEdge.start, rawEdge.end, { counter: index, prefix: "L" }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .defaultConfig2 */ .ME.flowchart;
  }
};
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__/* .__name */ .K2)(async function(text, id, _version, diag) {
  ...
  const { securityLevel, flowchart: conf, layout } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .getConfig2 */ .D7)();
  ...
  data4Layout.layoutAlgorithm = (0,_chunk_336JU56O_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  ...
  await (0,_chunk_336JU56O_mjs__WEBPACK_IMPORTED_MODULE_5__/* .render */ .XX)(data4Layout, svg);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_12__/* .utils_default */ ._K.insertTitle(
    svg,
    "flowchartTitleText",
    conf?.titleTopMargin || 0,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_EDXVE4YY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setupViewPortForSVG */ .P)(svg, padding, "flowchart", conf?.useMaxWidth || false);
}, "draw");
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_14__/* .__name */ .K2)((cnf) => {
    ...
    if (cnf.layout) {
      (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .setConfig2 */ .XV)({ layout: cnf.layout });
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_13__/* .setConfig2 */ .XV)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
  }, "init")
};
