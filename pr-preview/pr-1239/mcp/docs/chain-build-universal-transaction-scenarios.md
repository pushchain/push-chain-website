...
Send a [PC-20 (Token born on Push Chain)](/push-chain-website/pr-preview/pr-1239/docs/chain/build/send-universal-transaction/#moving-pc-20-tokens) outward. The token is approved and locked into VaultPC20 on Push Chain, and its wrapper is minted on the destination chain. If the token has never been exported there, the wrapper is **deployed as part of this transaction**.  
  

**Pre-requisite:**. Mint yourself some **$UNICORN** from [Mint Universal ERC-20 Tokens](/push-chain-website/pr-preview/pr-1239/docs/chain/tutorials/basics/tutorial-mint-erc-20-tokens/). $UNICORN is an ordinary ERC-20 that exists on Push Chain.
...
-   Sequence multiple transactions with [Send Multichain Transactions](/push-chain-website/pr-preview/pr-1239/docs/chain/build/send-multichain-transactions/)
-   Trigger cross-chain execution from contracts with [Contract Initiated Multichain Execution](/push-chain-website/pr-preview/pr-1239/docs/chain/build/contract-initiated-multichain-execution/)
-   Track and poll transaction state with [Track Universal Transaction](/push-chain-website/pr-preview/pr-1239/docs/chain/build/track-universal-transaction/)
-   Sign arbitrary data with [Sign Universal Message](/push-chain-website/pr-preview/pr-1239/docs/chain/build/sign-universal-message/)
