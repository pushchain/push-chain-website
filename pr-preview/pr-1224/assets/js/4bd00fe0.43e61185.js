...
const site_docs_chain_01_tutorials_02_power_features_02_tutorial_derive_universal_executor_account_mdx_4bd_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/tutorials/power-features/docs-chain-tutorials-derive-universal-executor-account","title":"Derive Universal Executor Accounts (UEAs)","description":"Derive Universal Executor Accounts | Tutorials | Push Chain Docs","source":"@site/docs/chain/01-tutorials/02-power-features/02-Tutorial-Derive-Universal-Executor-Account.mdx","sourceDirName":"chain/01-tutorials/02-power-features","slug":"/chain/tutorials/power-features/tutorial-derive-universal-executor-account","permalink":"/push-chain-website/pr-preview/pr-1224/docs/chain/tutorials/power-features/tutorial-derive-universal-executor-account","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/01-tutorials/02-power-features/02-Tutorial-Derive-Universal-Executor-Account.mdx","tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"id":"docs-chain-tutorials-derive-universal-executor-account","title":"Derive Universal Executor Accounts (UEAs)","hide_title":false,"slug":"./tutorial-derive-universal-executor-account","displayed_sidebar":"pushChainSidebar","sidebar_position":2,"image":"/assets/docs/previews/docs_chain_tutorials_derive_universal_executor_account--derive_universal_executor_accounts_(ueas).png"},"sidebar":"pushChainSidebar","previous":{"title":"Batch Transactions (Multicall)","permalink":"/push-chain-website/pr-preview/pr-1224/docs/chain/tutorials/power-features/tutorial-batch-transactions"},"next":{"title":"Derive Chain Executor Accounts (CEAs)","permalink":"/push-chain-website/pr-preview/pr-1224/docs/chain/tutorials/power-features/tutorial-derive-chain-executor-account"}}');
...
const toc = [{
  ...
  "value": "What UEAs Unlock",
  "id": "what-ueas-unlock",
  "level": 2
}, {
  "value": "Frictionless Multi-Chain Onboarding",
  "id": "frictionless-multi-chain-onboarding",
  "level": 4
}, {
  "value": "One Contract, Every Chain",
  "id": "one-contract-every-chain",
  "level": 4
}, {
  "value": "Unified Protocol Liquidity",
  "id": "unified-protocol-liquidity",
  "level": 4
}, {
  "value": "Universal Identity and Permissions",
  "id": "universal-identity-and-permissions",
  "level": 4
}, {
  ...
  "value": "Universal Airdrops",
  "id": "universal-airdrops",
  "level": 3
}, {
  "value": "Universal Agents",
  "id": "universal-agents",
  "level": 3
}, {
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      ...
      children: (0,jsx_runtime.jsx)(_components.strong, {
        children: "Step 2: Derive the Executor Account"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-typescript",
        children: "const executorAddress = await PushChain.utils.account.deriveExecutorAccount(account);\n"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["This performs the deterministic derivation to get the UEA address on Push Chain. The returned object also includes a ", (0,jsx_runtime.jsx)(_components.code, {
        children: "deployed"
      }), " boolean indicating whether the UEA contract has been lazily deployed yet (pass ", (0,jsx_runtime.jsx)(_components.code, {
        children: "{ skipNetworkCheck: true }"
      }), " to skip the deployment check and get the address only)."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "supported-chains",
      ...
      id: "what-ueas-unlock",
      children: "What UEAs Unlock"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "UEAs enable app patterns that are extremely complex, awkward, or outright impossible to implement on single-chain stacks."
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "frictionless-multi-chain-onboarding",
      children: "Frictionless Multi-Chain Onboarding"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Skip the \"create a new wallet for chain X\" step entirely. Users keep their existing Ethereum, Solana, or any other wallet. Your contract sees their UEA regardless of which chain they signed from. New-user activation collapses from minutes to seconds with no chain-switching, no bridging, and no extra gas token setup."
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "one-contract-every-chain",
      children: "One Contract, Every Chain"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Deploy a single contract on Push Chain and accept interactions from users on any chain. No per-chain deployments, no relayer infrastructure, no state fragmentation across instances. One address, one state, every chain."
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "unified-protocol-liquidity",
      children: "Unified Protocol Liquidity"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Pool liquidity, balances, and protocol state under a single contract instead of sharding it across chains. Users from Ethereum, Solana, and Base all contribute to and draw from the same pool. This eliminates bridging friction and gives your protocol a single, accurate view of total liquidity."
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "universal-identity-and-permissions",
      children: "Universal Identity and Permissions"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Allowlists, reputation scores, KYC attestations, and access tiers all key against UEAs. The same person has the same UEA whether they sign from Ethereum or Solana, so trust accrues to them and not to a per-chain alias they have to maintain."
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "what-you-can-build",
      children: "What You Can Build"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "UEAs are the primitive. Here are the product verticals they unlock:"
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "universal-rwas",
      children: "Universal RWAs"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Tokenized real-world assets accessible to holders on any chain. Ownership records, compliance checks, and transfer logic all live in one contract, keyed by UEA."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "universal-defi",
      children: "Universal DeFi"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Lending, borrowing, swaps, and yield strategies that accept liquidity from every chain without bridges. Users interact from their home chain; your protocol sees a single, unified pool."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "universal-airdrops",
      children: "Universal Airdrops"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Distribute tokens to recipients across Ethereum, Solana, Base, and BNB from a single contract. Recipients claim with their existing wallet on their existing chain, with no bridging and no per-chain deployments."
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Build it end-to-end: ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/docs/chain/tutorials/token-systems/tutorial-universal-airdrop/",
        children: "Build a Universal Airdrop"
      })]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "universal-agents",
      children: "Universal Agents"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "AI agents or autonomous bots that hold a UEA and act on behalf of users across chains with no per-chain wallets or bridging logic required."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "universal-gaming",
      children: "Universal Gaming"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["A single game contract where players from every chain compete on the same leaderboard. UEA-keyed state means a Solana player and an Ethereum player appear side-by-side without per-chain accounts. See ", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://ballsy.push.org",
        children: "Ballsy"
      }), " for a live example of chain-vs-chain gameplay built on UEA primitives."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "live-playground",
      ...
      children: ["UEAs are how external wallets execute ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "on"
      }), " Push Chain. The mirror image, how a Push Chain account executes ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "on every external chain"
      }), ", is the ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "Chain Executor Account (CEA)"
      }), "."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Every Push-side account, whether a user, a contract, or an AI agent, gets a deterministic CEA on every supported destination, ready to be authorised on day zero."
      ...
      children: ["In the next tutorial, you'll learn how to ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      }), ", off-chain via the SDK and on-chain via ", (0,jsx_runtime.jsx)(_components.code, {
        children: "ICEAFactory"
      }), ", and use them to pre-authorise destination-chain protocols before any cross-chain activity has happened."]
    })]
  });
}
