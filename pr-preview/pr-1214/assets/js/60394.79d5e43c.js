"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[60394],{
...
var findOrCreateNode = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((ID) => {
  ID = chunk_ICPOFSXX/* common_default */.Y2.sanitizeText(ID, (0,chunk_ICPOFSXX/* getConfig2 */.D7)());
...
var sankeyDB_default = {
  nodesMap,
  getConfig: /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => (0,chunk_ICPOFSXX/* getConfig2 */.D7)().sankey, "getConfig"),
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,chunk_ICPOFSXX/* getConfig2 */.D7)();
  const defaultSankeyConfig = chunk_ICPOFSXX/* defaultConfig2 */.ME.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,chunk_ICPOFSXX/* setupGraphViewbox */.ot)(void 0, svg, 0, useMaxWidth);
}, "draw");
