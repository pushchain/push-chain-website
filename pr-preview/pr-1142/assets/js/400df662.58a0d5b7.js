...
module.exports = /*#__PURE__*/JSON.parse('{"permalink":"/push-chain-website/pr-preview/pr-1142/blog/epns-ライトペーパー","source":"@site/blog/2021-05-28-epns-ライトペーパー/index.md","title":"EPNS ライトペーパー","description":"EPNS ライトペーパー","date":"2021-05-28T00:00:00.000Z","tags":[{"inline":true,"label":"Japanese","permalink":"/push-chain-website/pr-preview/pr-1142/blog/tags/japanese"},{"inline":true,"label":"Ethereum","permalink":"/push-chain-website/pr-preview/pr-1142/blog/tags/ethereum"},{"inline":true,"label":"Blockchain","permalink":"/push-chain-website/pr-preview/pr-1142/blog/tags/blockchain"},{"inline":true,"label":"Annoucements","permalink":"/push-chain-website/pr-preview/pr-1142/blog/tags/annoucements"},{"inline":true,"label":"Notifications","permalink":"/push-chain-website/pr-preview/pr-1142/blog/tags/notifications"}],"readingTime":7.23,"hasTruncateMarker":true,"authors":[{"name":"Push Chain","url":"https://x.com/PushChain","page":{"permalink":"/push-chain-website/pr-preview/pr-1142/blog/authors/push"},"imageURL":"/push-chain-website/pr-preview/pr-1142/assets/blog/authors/authorpush.png","key":"push"}],"frontMatter":{"slug":"epns-ライトペーパー","title":"EPNS ライトペーパー","description":"EPNS ライトペーパー","authors":["push"],"image":"./cover-image.webp","text":"本文書では、ウォレットアドレスが、分散型キャリアと中央集権型キャリアの両方からの通知を、プラットフォームに依存しない方法で受信できるようにする分散型通知プロトコルを紹介します。プラットフォームの例としては、dApps、ユーザウォレット、iOSおよびAndroidアプリ、ChromeまたはFirefoxブラウザ、または他の任意のそのようなプラットフォームを挙げることができます.","tags":["Japanese","Ethereum","Blockchain","Annoucements","Notifications"]},"unlisted":false,"prevItem":{"title":"EPNS Monthly Blocks","permalink":"/push-chain-website/pr-preview/pr-1142/blog/epns-monthly-blocks-jun-2021"},"nextItem":{"title":"EPNS Partners With PlotX to Bring Push Notifications to DeFi Prediction Markets","permalink":"/push-chain-website/pr-preview/pr-1142/blog/epns-partners-with-plotx-to-bring"}}');
...
/* harmony export */   metadata: () => (/* reexport default export from named module */ _site_docusaurus_docusaurus_plugin_content_blog_blog_site_blog_2021_05_28_epns_index_md_400_json__WEBPACK_IMPORTED_MODULE_0__),
/* harmony export */   toc: () => (/* binding */ toc)
/* harmony export */ });
/* harmony import */ var _site_docusaurus_docusaurus_plugin_content_blog_blog_site_blog_2021_05_28_epns_index_md_400_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(120783);
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.p, {
      ...
      children: ["プロトコルはまた、ペイロードにコンテンツタイプを割り当てます。これは基本的に、サービスがユーザーと通信したい情報を自由に通信できることを意味します。ペイロードの様々な例とそれらがどのように動作するかについては、ホワイトペーパーで詳しく説明しています。[", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["プロトコルは、サービスがアクティベートし、そのサービスの加入者に通知を送信するために、$DAI のステーキングを要求します。この", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "ステーク"
      }), "は、その後、AAVEなどのDeFiプロトコル（執筆時）によって", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "貸し出され"
      }), "、通知を受信することを選択しているすべての加入者に重み付けされた割合で配布される", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "金利"
      }), "を生成し始めます。そして重み付けによってアーリーアダプターである初期の加入者に多くの報酬を与えます。[", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["通知は保存され、通知が異なるキャリアに到達したときに、異なるキャリアのルールに従って変換されるJSONペイロードのように扱われます。JSONペイロードは、コンテンツ、データ、ストレージの解釈、配信の柔軟性を保証するペイロードタイプと異なることができます。これは、通知の異なるルールとコンテンツの解釈を作成するのに役立ちます（例：画像、コールトゥアクション、ライブビデオなど）。[", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
        href: "https://whitepaper.epns.io/protocol-specs-section/specifications/notification-payload-specs#notification-json-payload",
        children: "詳細を読む"
      }), "]"]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.h1, {
      ...
      children: ["このプロトコルは、ユーザーがどのサービスから通知を受けるかを直接制御できるようにし、ユーザーのためのスパム保護、加入者としてウォレットを追加する能力の制限など、サービスにルールを課します。[", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
        href: "https://whitepaper.epns.io/protocol-specs-section/epns-protocol/subscribers/user-direct-action-subscribe",
        children: "詳細を読む"
      }), "]"]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.p, {
      children: ["各チャンネルには、0から1までの範囲のスパムスコアがあります。値が0の場合は、そのチャンネルが優れたスコアを持っていることを意味し、1の場合は非常に不健全なチャンネルであることを意味します。範囲は、時間の経過とともに購読者数が増えるなどのポジティブなアクションに基づいて調整されますが、ネガティブなアクションは、通常よりも高い購読解除者数、通常よりも高い通知などです。これはプロトコルによって誘導され、一定の範囲になると、プロトコルは通知のスロットリングを開始したり、スコアが健全な範囲に戻るまで通知を停止したりします。 [", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["プロトコルのガバナンスは、EPNSプロトコルの継続的なアダプションを促すように設計されています。これは、インセンティブとペナルティを通じて、報酬もしくは動機づけすることにより、関与するすべてのユーザーのためのインセンティブを確保することによって達成されます。これらの継続的な関与は、プロトコルの成長と採用に必要であり、**Web3通知標準になるというビジョンを達成するために必要であると考えられています。**EPNSのユーザーは、", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "サービスプロバイダ、サブスクライバ、ウォレット/インフラサービス、ガバナンスユーザー"
      }), "に分類され、それらのすべてが、ホワイトペーパーに記載されているゲーム理論に従って、健全なエコシステムのために他の当事者を牽制し続けることを保証するために、関与に報酬を与えられています。[", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.li, {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
          children: "将来の機能"
        }), " — 議論され、検討されている分散型ビデオを含むいくつかの将来の機能があります。[", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["EPNSプロトコルのネイティブ・デジタル暗号で保護されたユーティリティ・トークン（", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "$PUSH"
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "$PUSH"
      }), " トークンは、EPNSプロトコルの様々なコア機能を制御するために使用され、ユーザーがプロトコルの機能に投票することを可能にします。疑義を避けるために、投票権は、EPNSプロトコルの機能に関する投票のみに限定されています。投票権は、$PUSH保有者に、当社、配布者、またはそれらの関連会社の運営・管理、またはそれらの資産に関する投票権を与えるものではなく、また、前述の事業体の持分を構成するものでもありません。例えば、EPNSプロトコル内では、プロトコル料金は ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "$ETH"
      }), " または ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "$DAI"
      }), " で課金されますが、$PUSHトークン保有者はこれらの料金パラメータを変更するために投票することができます。[", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.p, {
        children: ["Huge shoutout and thanks to ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
