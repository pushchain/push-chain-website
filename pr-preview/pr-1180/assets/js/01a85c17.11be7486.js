 ...
 * their initials.
 */function tagsUtils_listTagsByLetters(tags){const groups={};Object.values(tags).forEach(tag=>{var _groups$initial;const initial=getTagLetter(tag.label);(_groups$initial=groups[initial])!==null&&_groups$initial!==void 0?_groups$initial:groups[initial]=[];groups[initial].push(tag);});return Object.entries(groups)// Sort letters
...
var theme_Tag = __webpack_require__(293751);
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.browser.esm.js + 3 modules
var styled_components_browser_esm = __webpack_require__(505873);
// EXTERNAL MODULE: ./src/config/globals.js
var globals = __webpack_require__(61530);
