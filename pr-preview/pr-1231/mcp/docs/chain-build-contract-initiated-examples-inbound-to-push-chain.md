...
For the conceptual background (UEAs, the Universal Gateway, the wire format), see [Contract-Initiated Multichain Execution](/push-chain-website/pr-preview/pr-1231/docs/chain/build/contract-initiated-multichain-execution/).
...
| **Funds movement** | None. The example dispatches a payload only. The same surface supports bridging native ETH (`token = 0`, `amount > 0`); see the [Advanced Patterns](/push-chain-website/pr-preview/pr-1231/docs/chain/build/contract-initiated-examples/advanced-patterns/) for funds variants. |
...
The Sepolia contract's UEA on Push is computable off-chain via [deriveExecutorAccount](/push-chain-website/pr-preview/pr-1231/docs/chain/build/utility-functions/#derive-executor-account), so a Push-side target can pre-authorize that UEA before the first cross-chain call.
...
-   Other Basic Examples → [Outbound from Push Chain](/push-chain-website/pr-preview/pr-1231/docs/chain/build/contract-initiated-examples/outbound-from-push-chain/) and the [Round-Trip with Auto Back-Leg](/push-chain-website/pr-preview/pr-1231/docs/chain/build/contract-initiated-examples/round-trip-auto-back-leg/).
-   [Advanced Patterns](/push-chain-website/pr-preview/pr-1231/docs/chain/build/contract-initiated-examples/advanced-patterns/) → Harder variants: deposit-and-execute, recipient bridge, FIFO state machine, three-chain cascade.
-   [How CEA Works](/push-chain-website/pr-preview/pr-1231/docs/chain/deep-dives/how-cea-works/) → The identity model behind UEA `msg.sender` attribution on Push.
