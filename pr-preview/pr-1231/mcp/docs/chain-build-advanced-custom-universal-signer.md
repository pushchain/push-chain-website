...
-   [Initialize Push Chain Client](/push-chain-website/pr-preview/pr-1231/docs/chain/build/initialize-push-chain-client/) with the Universal Signer
-   Abstract away creation of the Universal Signer using [UI Kit](/push-chain-website/pr-preview/pr-1231/docs/chain/ui-kit/)
