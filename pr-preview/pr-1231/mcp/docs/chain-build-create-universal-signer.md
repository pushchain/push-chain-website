...
> **Prerequisite**  
> Remember to install and import required libraries. See [Quickstart](/push-chain-website/pr-preview/pr-1231/docs/chain/quickstart/) for install steps.
...
-   Learn how to create [Universal Signer from public / private keypair](/push-chain-website/pr-preview/pr-1231/docs/chain/build/utility-functions/#create-universal-signer-from-keypair)
-   Create [custom implementation](/push-chain-website/pr-preview/pr-1231/docs/chain/build/advanced/custom-universal-signer/) of universal signer (Advanced)
