...
const EcosystemFeaturedListUrls=['https://www.lastone.fun/','https://eon-five.vercel.app','https://pushbet.fun/','https://www.thehodl.fun/'];const EcosystemPartnersList=[,];const EcosystemAppsList=[{id:10,name:'Push Ninja',description:'On-chain skill based game',icon:'/assets/ecosystem/push-ninja-icon.png',bgImage:'/assets/ecosystem/push-ninja-bg.png',bgGradientColor:'#591D5C',tags:['Gaming'],twitterId:'2014018188434964672',href:'https://push-ninja.abstractstudio.in',titleColor:'white',appoftheweek:true,spotlighttext:'Slice. Dodge. Score.',featured:true},{id:1,name:'Last One',description:'Last one to bid before timer runs out takes the pot',icon:'/assets/ecosystem/last-one-icon.png',bgImage:'/assets/ecosystem/last-one-bg.png',bgGradientColor:'#E5B92A',tags:['Gaming'],href:'https://www.lastone.fun/',titleColor:'black',descriptionColor:'black',twitterId:'1993681001076478131',tagsColor:'black',featured:true},{id:2,name:'Ballsy',description:'Battle for glory by logging in with your favorite chain',icon:'/assets/ecosystem/ballsy-icon.png',bgImage:'/assets/ecosystem/ballsy-bg.png',bgGradientColor:'rgba(0, 0, 0, 0.80)',tags:['Gaming'],href:'https://ballsy.push.org/',titleColor:'white',featured:true},{id:3,name:'Push Bet',description:'Showcase your degen superpowers to earn rewards.',icon:'/assets/ecosystem/push-bet-icon.png',bgImage:'/assets/ecosystem/push-bet-bg.png',bgGradientColor:'rgba(0, 0, 0, 0.80)',tags:['Gaming'],href:'https://pushbet.fun/',titleColor:'white',descriptionColor:'white',tagsColor:'white'},{id:4,name:'Hodl.fun',description:'Create & launch ERC-20 tokens',icon:'/assets/ecosystem/hodl-fun-icon.png',bgImage:'/assets/ecosystem/hodl-fun-bg.png',bgGradientColor:'rgba(0, 0, 0, 0.80)',tags:['DeFi'],twitterId:'1989664475784663041',href:'https://www.thehodl.fun/',titleColor:'white',featured:true},{id:4,name:'ZNS',description:'Multi-chain domains, GM + Deploy tools',icon:'/assets/ecosystem/zns-icon.png',bgImage:'/assets/ecosystem/zns-bg.png',bgGradientColor:'#A9D20A',tags:['Infra'],href:'https://zns.bio/gm-deploy?filter=all&tab=gm&search=push',titleColor:'black',descriptionColor:'black',tagsColor:'black',twitterId:'1998756795859550371'},{id:5,name:'Bountive',description:'Universal growth engine rewarding quality over clicks',icon:'/assets/ecosystem/bountive-icon.png',bgImage:'/assets/ecosystem/bountive-bg.png',bgGradientColor:'#000000',tags:['Social'],twitterId:'1989664498920403443',href:'https://bountive.vercel.app/',titleColor:'white'},{id:6,name:'Tachyon',description:'Blazing Fast Multichain Relayer',icon:'/assets/ecosystem/tachyon-icon.png',bgImage:'/assets/ecosystem/tachyon-bg.png',bgGradientColor:'#0536A0',tags:['Infra'],href:'https://docs.rath.fi/',titleColor:'white'},{id:7,name:'BeatBrawls',description:'Musical battles to never forget',icon:'/assets/ecosystem/beatbrawls-icon.png',bgImage:'/assets/ecosystem/beatbrawls-bg.png',bgGradientColor:'#301139',tags:['Gaming'],href:'https://push.beatbrawls.com/',titleColor:'white',twitterId:'2001278428788715678'},{id:8,name:'Push x402',description:'Pay-per-call API monetization for agentic infrastructure',icon:'/assets/ecosystem/push402-icon.png',bgImage:'/assets/ecosystem/push402-bg.png',bgGradientColor:'#010101',tags:['Infra'],href:'https://pushindexer.vercel.app',titleColor:'white'},{id:9,name:'APT Casino',description:'Universal, fair, & transparent wager to win',icon:'/assets/ecosystem/apt-casino-icon.png',bgImage:'/assets/ecosystem/apt-casino-bg.png',bgGradientColor:'#5E1140',tags:['Gaming'],twitterId:'1989664509439713780',href:'https://apt-casino-push-chain.vercel.app/',titleColor:'white'},{id:11,name:'OnchainVampireSurvivors',description:'Universal vampire survivors like game',icon:'/assets/ecosystem/onchain-vampires-icon.png',bgImage:'/assets/ecosystem/onchain-vampires-bg.png',bgGradientColor:'#5D261E',tags:['Gaming'],twitterId:'2003875166850531341',href:'https://catkevin.github.io/OnchainVampireSurvivors/',titleColor:'white'},{id:12,name:'TipUp',description:'Tip on any chain using any wallet',icon:'/assets/ecosystem/tip-up-icon.png',bgImage:'/assets/ecosystem/tip-up-bg.png',bgGradientColor:'#000000',tags:['DeFi'],twitterId:'1989664514686783920',href:'https://tip-up-push.vercel.app/',titleColor:'white'},{id:13,name:'CoNFT/CoDomain',description:'Web3 multi-chain hub: Domain Names, NFTs, launchpad.',icon:'/assets/ecosystem/conft-icon.png',bgImage:'/assets/ecosystem/conft-bg.png',bgGradientColor:'#000',tags:['NFT'],href:'https://conft.app/?chainId=42101',titleColor:'white'},{id:14,name:'ChainCircle',description:'Cross chain saving circles',icon:'/assets/ecosystem/chaincircle-icon.png',bgImage:'/assets/ecosystem/chaincircle-bg.png',bgGradientColor:'#000000',tags:['DeFi'],twitterId:'1989664436433637415',href:'https://www.chaincircle.org/',titleColor:'white'},{id:15,name:'EON: AI Butler',description:'Send, swap, and manage assets across supported networks',icon:'/assets/ecosystem/eon-icon.png',bgImage:'/assets/ecosystem/eon-bg.png',bgGradientColor:'#000000',tags:['NFT'],twitterId:'1989664469484728745',href:'https://eon-five.vercel.app',titleColor:'white'},{id:16,name:'Push Swap',description:'Seamless cross-chain token swaps without bridges',icon:'/assets/ecosystem/push-swap-icon.png',bgImage:'/assets/ecosystem/push-swap-bg.png',bgGradientColor:'#DD60C4',tags:['DeFi'],twitterId:'1989664440468590639',href:'https://push-swap-sepia.vercel.app/',titleColor:'black',descriptionColor:'black',tagsColor:'black'},{id:17,name:'Star Run',description:'A decentralized, player-owned economy',icon:'/assets/ecosystem/star-run-icon.png',bgImage:'/assets/ecosystem/star-run-bg.png',bgGradientColor:'#000000',tags:['Gaming'],twitterId:'1989664445501751672',href:'https://starrun.vercel.app/',titleColor:'white'},{id:18,name:'Forge Realm',description:'Mix and match base characters and traits from multiple creators',icon:'/assets/ecosystem/forge-realm-icon.png',bgImage:'/assets/ecosystem/forge-realm-bg.png',bgGradientColor:'#000000',tags:['NFT'],twitterId:'1989664480616464799',href:'https://forge-realm.vercel.app/',titleColor:'white'},{id:19,name:'Push Name Service',description:'Get your own .push domain',icon:'/assets/ecosystem/push-name-service-icon.png',bgImage:'/assets/ecosystem/push-name-service-bg.png',bgGradientColor:'#000000',tags:['Infra'],twitterId:'1989664485427351900',href:'https://push-name-service.vercel.app/',titleColor:'white'},{id:20,name:'Push Campus',description:'Reach students on Ethereum, Solana, Base, and 15+ chains',icon:'/assets/ecosystem/push-campus-icon.png',bgImage:'/assets/ecosystem/push-campus-bg.png',bgGradientColor:'#000000',tags:['Social'],twitterId:'1989664494503743894',href:'https://push-campus.vercel.app/',titleColor:'white'},{id:21,name:'PNS',description:'Your Identity Across Every Chain',icon:'/assets/ecosystem/pns-icon.png',bgImage:'/assets/ecosystem/pns-bg.png',bgGradientColor:'#4A1756',tags:['Infra'],twitterId:'1989664489902575819',href:'https://universal-name-service.vercel.app/',titleColor:'white'},{id:22,name:'Athera',description:'Automated crypto inheritance',icon:'/assets/ecosystem/athera-icon.png',bgImage:'/assets/ecosystem/athera-bg.png',bgGradientColor:'#000000',tags:['DeFi'],twitterId:'1989664503341129977',href:'https://atherra.vercel.app/',titleColor:'white'},{id:24,name:'NFTs2Me',description:'Deploy your NFT collection for free on any chain',icon:'/assets/ecosystem/nfts-me-icon.png',bgImage:'/assets/ecosystem/nfts-me-bg.png',bgGradientColor:'#010101',tags:['NFT'],href:'https://nfts2me.com/app/push-testnet/',titleColor:'#FFFFFF'},{id:25,name:'Copet',description:'Feed, play, and grow your virtual pet through on-chain activity',icon:'/assets/ecosystem/copet-icon.png',bgImage:'/assets/ecosystem/copet-bg.png',bgGradientColor:'#010101',tags:['NFT'],href:'https://copet.xyz/?chainId=42101',titleColor:'#FFFFFF'},{id:26,name:'Copass',description:'Proof of Human, sybil-resistant identity verification protocol.',icon:'/assets/ecosystem/copass-icon.png',bgImage:'/assets/ecosystem/copass-bg.png',bgGradientColor:'#020202',tags:['Security'],href:'https://copass.app/wallet?chainId=42101',titleColor:'#FFFFFF'},{id:27,name:'SurfLayer',description:'Build your identity and earn rewards across 70+ chains.',icon:'/assets/ecosystem/surflayer-icon.png',bgImage:'/assets/ecosystem/surflayer-bg.png',bgGradientColor:'#030303',tags:['DeFi'],href:'https://surflayer.xyz/',titleColor:'#FFFFFF'},{id:28,name:'PushDex',description:'DEX built on the Pushchain testnet',icon:'/assets/ecosystem/pushdex-icon.png',bgImage:'/assets/ecosystem/pushdex-bg.png',bgGradientColor:'#030303',tags:['DeFi'],href:'https://pushdex.lovable.app/',titleColor:'#FFFFFF',twitterId:'2011506398597955757'},{id:29,name:'Omnihub',description:'Create, buy, and sell blockchain collectibles',icon:'/assets/ecosystem/omnihub-icon.png',bgImage:'/assets/ecosystem/omnihub-bg.png',bgGradientColor:'#030303',tags:['NFT'],href:'https://omnihub.xyz/discover/push-testnet',titleColor:'#FFFFFF'},{id:30,name:'Freename',description:'Send Crypto To Domains, Not Hashes',icon:'/assets/ecosystem/freename-icon.png',bgImage:'/assets/ecosystem/freename-bg.png',bgGradientColor:'#030303',tags:['Infra'],href:'https://omnihub.xyz/discover/push-testnet',titleColor:'#FFFFFF',comingsoon:true},{id:31,name:'Hang4.fun',description:'Coming Soon',icon:'/assets/ecosystem/hangfun-icon.png',bgImage:'/assets/ecosystem/hangfun-bg.png',bgGradientColor:'rgba(148, 163, 184, 0.25)',tags:['TBA'],href:'https://hang4.fun/',titleColor:'white',comingsoon:true},{id:33,name:'Degen Chess',description:'Play chess, wager, universal',icon:'/assets/ecosystem/degen-chess-icon.png',bgImage:'/assets/ecosystem/degen-chess-bg.png',bgGradientColor:'rgba(148, 163, 184, 0.25)',tags:['Gaming'],href:'https://degenchess.example.com/',titleColor:'white',comingsoon:true}];
...
// @ts-nocheck
const EcosystemCard=_ref=>{let{app}=_ref;const{t}=(0,es/* useTranslation */.Bd)();const{data:twitterData}=(0,GetTwitterMetrics/* useTweetMetrics */.k)(app.twitterId||'');// Support both old format (name/description) and new format (nameKey/descriptionKey)
