...
-   ✅ Convert addresses from any chain to deterministic Push Chain addresses ([UEAs](/push-chain-website/pr-preview/pr-1235/docs/chain/tutorials/power-features/tutorial-derive-universal-executor-account/))
...
All three interact with the **same contract** on Push Chain through their [Universal Executor Accounts (UEAs)](/push-chain-website/pr-preview/pr-1235/docs/chain/tutorials/power-features/tutorial-derive-universal-executor-account/).
...
For each recipient, we convert their origin address to a deterministic **[Universal Executor Account (UEA)](/push-chain-website/pr-preview/pr-1235/docs/chain/tutorials/power-features/tutorial-derive-universal-executor-account/)** address on Push Chain:
...
1.  **ERC-20 Token Contract** - The token being airdropped ($UNICORN) - see [Mint Universal ERC-20 Tokens](/push-chain-website/pr-preview/pr-1235/docs/chain/tutorials/basics/tutorial-mint-erc-20-tokens/) for basics
...
-   Every claim was executed through a [Universal Executor Account (UEA)](/push-chain-website/pr-preview/pr-1235/docs/chain/tutorials/power-features/tutorial-derive-universal-executor-account/)
