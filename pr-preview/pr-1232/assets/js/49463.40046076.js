"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[49463],{
...
function decodeAddress({ coinType, data, args, }) {
    try {
        ...
        if (coinType == null)
            throw err;
        const address = (0,trim/* trim */.B)(data);
        if ((0,size/* size */.E)(address) === 20)
            return (0,getAddress/* getAddress */.b)(address);
        throw err;
    }
}
...
async function createAccessList(client, args) {
    ...
    try {
        ...
        if (response.error)
            throw new base/* BaseError */.C(response.error, { details: response.error });
        return {
...
var formatBlockParameter = __webpack_require__(836037);
...
async function getBlockReceipts(client, { blockHash, blockNumber, blockTag = client.experimental_blockTag ?? 'latest', } = {}) {
    ...
    if (!receipts)
        throw new errors_block/* BlockNotFoundError */.l({ blockHash, blockNumber });
...
// EXTERNAL MODULE: ./node_modules/viem/node_modules/ox/_esm/core/AbiItem.js + 3 modules
var AbiItem = __webpack_require__(432514);
// EXTERNAL MODULE: ./node_modules/viem/node_modules/ox/_esm/core/AbiParameters.js + 2 modules
var AbiParameters = __webpack_require__(326109);
