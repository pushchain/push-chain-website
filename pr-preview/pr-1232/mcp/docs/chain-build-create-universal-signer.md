...
> **Prerequisite**  
> Remember to install and import required libraries. See [Quickstart](/push-chain-website/pr-preview/pr-1232/docs/chain/quickstart/) for install steps.
...
-   [Initialize Push Chain Client](/push-chain-website/pr-preview/pr-1232/docs/chain/build/initialize-push-chain-client/) with the Universal Signer
-   Abstract away creation of the Universal Signer using [UI Kit](/push-chain-website/pr-preview/pr-1232/docs/chain/ui-kit/)
-   Learn how to create [Universal Signer from public / private keypair](/push-chain-website/pr-preview/pr-1232/docs/chain/build/utility-functions/#create-universal-signer-from-keypair)
-   Create [custom implementation](/push-chain-website/pr-preview/pr-1232/docs/chain/build/advanced/custom-universal-signer/) of universal signer (Advanced)
