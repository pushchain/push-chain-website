...
const site_docs_chain_06_node_and_system_tools_03_json_rpc_functions_mdx_8a7_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/node-and-system-tools/docs-chain-node-and-system-tools-json-rpc-functions","title":"JSON-RPC Functions","description":"JSON-RPC Functions | Deep Dives | Push Chain Docs","source":"@site/docs/chain/06-node-and-system-tools/03-JSON-RPC-Functions.mdx","sourceDirName":"chain/06-node-and-system-tools","slug":"/chain/node-and-system-tools/json-rpc-functions","permalink":"/push-chain-website/pr-preview/pr-1144/docs/chain/node-and-system-tools/json-rpc-functions","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/06-node-and-system-tools/03-JSON-RPC-Functions.mdx","tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"id":"docs-chain-node-and-system-tools-json-rpc-functions","title":"JSON-RPC Functions","hide_title":false,"slug":"./json-rpc-functions","displayed_sidebar":"pushChainSidebar","sidebar_position":3,"image":"/assets/docs/previews/docs_chain_node_and_system_tools--json-rpc_functions.png"},"sidebar":"pushChainSidebar","previous":{"title":"Running Localnet","permalink":"/push-chain-website/pr-preview/pr-1144/docs/chain/node-and-system-tools/localnet"},"next":{"title":"Changelog","permalink":"/push-chain-website/pr-preview/pr-1144/docs/chain/changelog"}}');
