...
`
      ...
      summary: "Move a PC20 Token to Push Chain (wrapper burn)",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["Bring a ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/send-universal-transaction/#moving-pc20-tokens",
          children: "PC20"
        }), " token home. The wrapper on Sepolia is burned and the canonical Push-native token is unlocked to your UEA. Unlike an ERC-20 bridge, ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "no approval transaction is sent"
        ...
        type: "note",
        children: [(0,jsx_runtime.jsxs)(_components.p, {
          children: ["These examples use ", (0,jsx_runtime.jsx)(_components.code, {
            children: "rain"
          }), ", a test PC20 on Donut Testnet at ", (0,jsx_runtime.jsx)(_components.code, {
            children: "0x14693f665cE282A451ba9a86F2EC04B43F931145"
          }), ". It has a public ", (0,jsx_runtime.jsx)(_components.code, {
            children: "mint(address,uint256)"
          }), ", so you can mint yourself as much as you need on Push Chain."]
        }), (0,jsx_runtime.jsxs)(_components.p, {
          children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "Sepolia wrapper"
          }), " (", (0,jsx_runtime.jsx)(_components.code, {
            children: "0x81E05001A1f3fB574E18c1B0b2596163c68144ae"
          }), ") is a different matter — only the gateway can mint it, and it only comes into existence when a PC20 is exported. So to run this example, first mint ", (0,jsx_runtime.jsx)(_components.code, {
            children: "rain"
          }), " on Push and run the ", (0,jsx_runtime.jsx)(_components.a, {
            href: "#route-2--execute-on-external-chain",
            children: "Route 2 export"
          }), " with ", (0,jsx_runtime.jsx)(_components.code, {
            children: "TARGET"
          }), " set to ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "your own address"
          }), ". That delivers the wrapper to you; then come back here to burn it."]
        })]
      }), (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
// customPropGTagEvent=send_transaction_route1_pc20_import
  ...
  // Route 1: burn a PC20 wrapper on Sepolia → unlock the canonical
  // Push-native PC20 to your UEA on Push Chain.
  import { PushChain } from '@pushchain/core';
  import { ethers } from 'ethers';
  import * as readline from 'node:readline/promises';
  ...
  // The PC20 wrapper deployed on Ethereum Sepolia.
  const PC20_WRAPPER_SEPOLIA = '0x81E05001A1f3fB574E18c1B0b2596163c68144ae';
  ...
  async function main() {
    ...
    // Resolve the wrapper so we know the canonical token and its decimals.
    const token = await PushChain.utils.tokens.getPC20Address(PC20_WRAPPER_SEPOLIA, {
      chain: PushChain.CONSTANTS.CHAIN.ETHEREUM_SEPOLIA,
      network: PushChain.CONSTANTS.PUSH_NETWORK.TESTNET,
    });
    console.log('🪙 Canonical PC20 on Push Chain:', token.address, '(' + token.symbol + ')');

    await rl.question(':::prompt:::Fund the following, then press Enter:\\\\n  • Send at least 0.005 Sepolia ETH to your UOA: ' + wallet.address + ' (gas to sign).\\\\n  • Send at least 1 ' + token.symbol + ' wrapper to the same UOA at ' + PC20_WRAPPER_SEPOLIA + ' on Sepolia (this is what gets burned).\\\\n  • Send at least 1 PC to your UEA: ' + client.universal.account + ' on Push Chain (pays the inbound execution gas — a wrapper burn has no native funds leg to fee-lock against).\\\\nSepolia faucet: https://cloud.google.com/application/web3/faucet/ethereum/sepolia');

    try {
      const tx = await client.universal.sendTransaction({
        to: client.universal.account, // unlock to self on Push Chain
        funds: {
      ...
      console.log('✅ Push Chain tx hash:', tx.hash);
      await tx.wait();
      console.log('🎉 Wrapper burned — canonical PC20 unlocked to', client.universal.account);
    } catch (err) {
      console.error('❌ Failed:', err && err.message ? err.message : err);
    }
  }
...
`
      ...
      summary: "Export a PC20 Token to an External Chain",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["Send a Push-native ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/send-universal-transaction/#moving-pc20-tokens",
          children: "PC20"
        }), " outward. The canonical token is approved and locked into VaultPC20, and the wrapper is minted on the destination chain. If the token has never been exported to that chain, the wrapper is ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "deployed as part of this transaction"
        }), " and its address is predicted before anything is locked."]
      }), (0,jsx_runtime.jsxs)(_components.p, {
        children: ["This is the example to run first — the test token's ", (0,jsx_runtime.jsx)(_components.code, {
          children: "mint(address,uint256)"
        }), " is public on Push Chain, so you can self-serve the ", (0,jsx_runtime.jsx)(_components.code, {
          children: "rain"
        }), " you need here. Set ", (0,jsx_runtime.jsx)(_components.code, {
          children: "TARGET"
        }), " to your own address and this also delivers the Sepolia wrapper that the ", (0,jsx_runtime.jsx)(_components.a, {
          href: "#route-1--execute-on-push-chain",
          children: "Route 1"
        }), " and ", (0,jsx_runtime.jsx)(_components.a, {
          href: "#route-3--execute-on-push-chain-from-cea",
          children: "Route 3"
        }), " PC20 examples burn."]
      }), (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
...
// customPropGTagEvent=send_transaction_route2_pc20_export
  ...
  // Route 2: export a Push-native PC20 → mint/deliver its wrapper on Sepolia.
  import { PushChain } from '@pushchain/core';
  import { ethers } from 'ethers';
  import * as readline from 'node:readline/promises';
  ...
  // The canonical Push-native PC20 on Donut Testnet.
  ...
  async function main() {
    ...
    await rl.question(':::prompt:::Fund the following, then press Enter:\\\\n  • Send at least 0.01 Sepolia ETH to your UOA: ' + wallet.address + ' (gas to sign — the export fee-lock needs more than a plain call).\\\\n  • Send at least 1 PC and 1 ' + token.symbol + ' to your UEA: ' + client.universal.account + ' on Push Chain (the PC20 is what gets locked and exported).\\\\nSepolia faucet: https://cloud.google.com/application/web3/faucet/ethereum/sepolia');
...
`
      ...
      summary: "Bring a PC20 Back from your CEA",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["Settle a ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/send-universal-transaction/#moving-pc20-tokens",
          children: "PC20"
        }), " wrapper held by your CEA on an external chain. The CEA burns its wrapper balance and the canonical Push-native token is unlocked to your UEA."]
      }), (0,jsx_runtime.jsxs)(_components.p, {
        children: ["As with ", (0,jsx_runtime.jsx)(_components.a, {
          href: "#route-1--execute-on-push-chain",
          children: "Route 1"
        }), ", you need the Sepolia wrapper before you can burn it — run the Route 2 export to your own address first."]
      }), (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
          url: "https://github.com/pushchain/push-chain-examples/tree/main/core-sdk-functions/send-universal-transaction"
...
// customPropHighlightRegexStart=universal\.sendTransaction
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=send_transaction_route3_pc20_cea_burn

  // Route 3: burn a PC20 wrapper held by your CEA on Sepolia → unlock the
  // canonical Push-native token to your UEA on Push Chain.
  import { PushChain } from '@pushchain/core';
  import { ethers } from 'ethers';
  import * as readline from 'node:readline/promises';
  ...
  async function main() {
    ...
    // Derive your CEA on Sepolia — this is the account that must hold the wrapper.
    const uoa = PushChain.utils.account.toUniversal(wallet.address, {
      chain: PushChain.CONSTANTS.CHAIN.ETHEREUM_SEPOLIA,
    });
    ...
    console.log('📍 CEA on Sepolia:', sepoliaCEA.address);
    ...
    await rl.question(':::prompt:::Fund the following, then press Enter:\\\\n  • Send at least 0.01 Sepolia ETH to your UOA: ' + wallet.address + ' (powers the UEA for the inbound on Push Chain).\\\\n  • Send at least 1 ' + token.symbol + ' wrapper to your CEA on Sepolia: ' + sepoliaCEA.address + ' (this is what gets burned).\\\\nSepolia faucet: https://cloud.google.com/application/web3/faucet/ethereum/sepolia');
    ...
    try {
      ...
      const receipt = await tx.wait();
      console.log('🌐 External TX Hash:', receipt.externalTxHash);
      console.log('🎉', token.symbol, 'unlocked to', client.universal.account);
    } catch (err) {
      console.error('❌ Failed:', err && err.message ? err.message : err);
    }
  }
