...
async function loadViemUtils() {
    if (!cachedViemUtils) {
        const { createPublicClient, http, defineChain } = await Promise.all(/* import() */[__webpack_require__.e(49463), __webpack_require__.e(48694)]).then(__webpack_require__.bind(__webpack_require__, 893456));
        cachedViemUtils = {
            createPublicClient,
            http,
            defineChain
