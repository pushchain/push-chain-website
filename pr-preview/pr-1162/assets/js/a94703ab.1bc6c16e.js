...
function DocSidebarItemCategoryEmpty(_ref4){let{item}=_ref4,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref4,Category_excluded);// If the category has no link, we don't render anything
...
const forwardableProps=(0,objectWithoutPropertiesLoose/* default */.A)(item,_excluded2);const linkItem=Object.assign({type:'link'},forwardableProps);return/*#__PURE__*/(0,jsx_runtime.jsx)(DocSidebarItemLink,Object.assign({item:linkItem},props));}function DocSidebarItemCategoryCollapsible(_ref5){let{item,onItemClick,activePath,level,index}=_ref5,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref5,_excluded3);const{items,label,collapsible,className,href}=item;const{docs:{sidebar:{autoCollapseCategories}}}=(0,useThemeConfig/* useThemeConfig */.p)();const hrefWithSSRFallback=useCategoryHrefWithSSRFallback(item);const isActive=(0,docsUtils/* isActiveSidebarItem */.w8)(item,activePath);const isCurrentPage=(0,routesUtils/* isSamePath */.ys)(href,activePath);const{collapsed,setCollapsed}=(0,Collapsible/* useCollapsible */.u)({// Active categories are always initialized as expanded. The default
