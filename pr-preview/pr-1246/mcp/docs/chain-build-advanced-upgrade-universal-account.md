...
-   Check UEA state before upgrading with [Get Account Status](/push-chain-website/pr-preview/pr-1246/docs/chain/build/initialize-push-chain-client/#get-account-status)
-   Send your first universal transaction after upgrading with [Send Universal Transaction](/push-chain-website/pr-preview/pr-1246/docs/chain/build/send-universal-transaction/)
