...
For the full response shape, see [Read Universal State - Returns UniversalReadResponse](/push-chain-website/pr-preview/pr-1246/docs/chain/build/universal-read/#returns-universal-read-response).
...
-   Read a single value on any chain with [Read Universal State](/push-chain-website/pr-preview/pr-1246/docs/chain/build/universal-read/)
-   Batch several reads into one transaction with [Read Multiple Universal States](/push-chain-website/pr-preview/pr-1246/docs/chain/build/read-multiple-universal-states/)
-   Trigger reads from Solidity with [Contract-Initiated Universal Read and Callback](/push-chain-website/pr-preview/pr-1246/docs/chain/build/contract-initiated-universal-read-and-callback/)
-   Follow the transaction that carried your request with [Track Universal Transaction](/push-chain-website/pr-preview/pr-1246/docs/chain/build/track-universal-transaction/)
