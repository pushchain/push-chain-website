"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[27955],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_104_universal_reads_section_mdx_ef7_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-104-universal-reads-section-mdx-ef7.json
const site_docs_chain_03_build_104_universal_reads_section_mdx_ef7_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-universal-reads-section","title":"Universal Reads","description":"Universal Reads | Build | Push Chain Docs","source":"@site/docs/chain/03-build/104-Universal-Reads-Section.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/universal-reads","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/universal-reads","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/104-Universal-Reads-Section.mdx","tags":[],"version":"current","sidebarPosition":104,"frontMatter":{"id":"docs-chain-build-universal-reads-section","title":"Universal Reads","hide_title":false,"slug":"./universal-reads","displayed_sidebar":"pushChainSidebar","sidebar_position":104,"image":"/assets/docs/previews/docs_chain_build__section--universal_reads.png"},"sidebar":"pushChainSidebar","previous":{"title":"Track Universal Transaction","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/track-universal-transaction"},"next":{"title":"Read Universal State","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/universal-read"}}');
...
;// ./docs/chain/03-build/104-Universal-Reads-Section.mdx
...
const frontMatter = {
	...
	image: '/assets/docs/previews/docs_chain_build__section--universal_reads.png'
};
const contentTitle = 'Universal Reads';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      children: (0,jsx_runtime.jsx)("title", {
        children: "Universal Reads | Build | Push Chain Docs"
      })
    }), "\n", "\n", (0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "universal-reads",
        children: "Universal Reads"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Bring state from other blockchains and web APIs onto Push Chain with validator agreement: single reads, batches, contract callbacks, and tracking."
