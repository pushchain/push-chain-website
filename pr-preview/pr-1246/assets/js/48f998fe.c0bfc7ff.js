(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[43380],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_05_sign_universal_message_mdx_48f_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-05-sign-universal-message-mdx-48f.json
const site_docs_chain_03_build_05_sign_universal_message_mdx_48f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-sign-universal-message","title":"Sign Universal Message","description":"Sign Message | Build | Push Chain Docs","source":"@site/docs/chain/03-build/05-Sign-Universal-Message.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/sign-universal-message","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/sign-universal-message","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/05-Sign-Universal-Message.mdx","tags":[],"version":"current","sidebarPosition":5,"frontMatter":{"id":"docs-chain-build-sign-universal-message","title":"Sign Universal Message","hide_title":false,"slug":"./sign-universal-message","displayed_sidebar":"pushChainSidebar","sidebar_position":5,"image":"/assets/docs/previews/docs_chain_build--sign_universal_message.png"},"sidebar":"pushChainSidebar","previous":{"title":"Track Universal Read","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/track-universal-read"},"next":{"title":"Utility Functions","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/utility-functions"}}');
...
;// ./docs/chain/03-build/05-Sign-Universal-Message.mdx
...
function _createMdxContent(props) {
  ...
  // customPropGTagEvent=sign_universal_message
...
`
  ...
  // customPropHighlightRegexEnd=\\);
  // customPropGTagEvent=sign_universal_typed_data
  import { PushChain } from '@pushchain/core';
  import { ethers } from 'ethers';
