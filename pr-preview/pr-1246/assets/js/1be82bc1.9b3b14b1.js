(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[10461],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_03_universal_transactions_03_universal_transaction_scenarios_mdx_1be_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-03-universal-transactions-03-universal-transaction-scenarios-mdx-1be.json
const site_docs_chain_03_build_03_universal_transactions_03_universal_transaction_scenarios_mdx_1be_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/universal-transactions/docs-chain-build-universal-transaction-scenarios","title":"Universal Transaction Scenarios","description":"Universal Transaction Scenarios | Build | Push Chain Docs","source":"@site/docs/chain/03-build/03-universal-transactions/03-Universal-Transaction-Scenarios.mdx","sourceDirName":"chain/03-build/03-universal-transactions","slug":"/chain/build/universal-transaction-scenarios","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/universal-transaction-scenarios","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/03-universal-transactions/03-Universal-Transaction-Scenarios.mdx","tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"id":"docs-chain-build-universal-transaction-scenarios","title":"Universal Transaction Scenarios","hide_title":false,"slug":"/chain/build/universal-transaction-scenarios","displayed_sidebar":"pushChainSidebar","sidebar_position":3,"image":"/assets/docs/previews/docs_chain_build--universal_transaction_scenarios.png"},"sidebar":"pushChainSidebar","previous":{"title":"Send Universal Transaction","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/send-universal-transaction"},"next":{"title":"Send Multichain Transactions","permalink":"/push-chain-website/pr-preview/pr-1246/docs/chain/build/send-multichain-transactions"}}');
...
;// ./docs/chain/03-build/03-universal-transactions/03-Universal-Transaction-Scenarios.mdx
...
const frontMatter = {
	...
	hide_title: false,
	slug: '/chain/build/universal-transaction-scenarios',
...
const toc = [{
  ...
  "value": "Route 1 → Execute on Push Chain",
  "id": "route-1--execute-on-push-chain",
  "level": 2
}, {
  "value": "Route 2 → Execute on External Chain",
  "id": "route-2--execute-on-external-chain",
  "level": 2
}, {
  "value": "Route 3 → Execute on Push Chain from CEA",
  "id": "route-3--execute-on-push-chain-from-cea",
  "level": 2
}, {
  "value": "Next Steps",
  "id": "next-steps",
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      children: (0,jsx_runtime.jsx)("title", {
        children: "Universal Transaction Scenarios | Build | Push Chain Docs"
      })
    }), "\n", "\n", "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "overview",
      children: "Overview"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["End-to-end playground examples for each universal transaction route. For API reference and argument details, see ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          children: "Route 1"
        }), " originates from a wallet on an external chain or a native Push Chain wallet → routes through the UEA associated with your Push Account (when the origin is external) → executes the transaction on Push Chain. See ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/send-universal-transaction/#how-routing-works",
          children: "How Universal Routing Works"
        }), " to learn more. Useful for funding your Push Account, bridging assets onto Push Chain, calling Push-side contracts from any source, etc."]
      }), "\n"]
...
`
      ...
      summary: "Move Native ETH to Push Chain (lands as pETH)",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["Bridge native Sepolia ETH into your UEA on Push Chain. It arrives as ", (0,jsx_runtime.jsx)(_components.code, {
          children: "pETH"
        }), " (the Push Chain wrapper for ETH from Ethereum). Only the source-chain UOA needs funding."]
...
`
      ...
      summary: "Move ERC-20 (USDT) to Push Chain (lands as USDT.eth)",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["Bridge USDT from Sepolia into your UEA on Push Chain. It arrives as ", (0,jsx_runtime.jsx)(_components.code, {
          children: "USDT.eth"
        }), " (the Push-side PRC-20 mirror; only native assets use the ", (0,jsx_runtime.jsx)(_components.code, {
          children: "p"
        }), " prefix, ERC-20s keep their symbol plus a chain suffix like ", (0,jsx_runtime.jsx)(_components.code, {
          children: ".eth"
...
`
      ...
      summary: "Move ERC-20 (USDT) + Call Contract in one Tx",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsx)(_components.p, {
        children: "Bridge USDT into Push Chain AND atomically call a contract in the same transaction. The funds land on the UEA, then the UEA executes your payload — all from one user signature."
      }), (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
          url: "https://github.com/pushchain/push-chain-examples/tree/main/core-sdk-functions/send-universal-transaction"
...
`
      ...
      summary: "Batch Transactions (Multicall)",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["Run two ", (0,jsx_runtime.jsx)(_components.code, {
          children: "increment()"
        }), " calls on the same Push Chain contract atomically, from a single Sepolia signature. The inline ", (0,jsx_runtime.jsx)(_components.code, {
          children: "progressHook"
        }), " lets you watch the full lifecycle (gas estimate -> UEA resolution -> fee-lock -> broadcast -> confirmation) without a separate tracking example."]
      }), (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
          url: "https://github.com/pushchain/push-chain-examples/tree/main/core-sdk-functions/multicall-universal-transaction"
        },
        children: `
...
`
      ...
      summary: "Move PC-20 Token from an External Chain to Push",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["A complete PC-20 round trip in one script. Mint ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "$UNICORN"
        }), " on Push Chain, export it to Sepolia as a wrapper, then burn that wrapper to bring it home. ", (0,jsx_runtime.jsx)("br", {}), " ", (0,jsx_runtime.jsx)("br", {}), (0,jsx_runtime.jsx)(_components.strong, {
          children: "Note:"
        }), " Ideally, you will be either moving PC-20 from external chains to Push or vice-versa. This example does the full route to make the understanding easier.  ", (0,jsx_runtime.jsx)("br", {}), " ", (0,jsx_runtime.jsx)("br", {})]
      }), (0,jsx_runtime.jsxs)(_components.admonition, {
        title: "Getting the test token",
        type: "note",
        children: [(0,jsx_runtime.jsxs)(_components.p, {
          children: ["These examples use ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "$UNICORN"
          }), ", the token you build in ", (0,jsx_runtime.jsx)(_components.a, {
            href: "/docs/chain/tutorials/basics/tutorial-mint-erc-20-tokens/",
            children: "Mint Universal ERC-20 Tokens"
          }), ". It is already deployed on Donut Testnet at ", (0,jsx_runtime.jsx)(_components.code, {
            children: "0x0165878A594ca255338adfa4d48449f69242Eb8F"
          }), " with a public ", (0,jsx_runtime.jsx)(_components.code, {
            children: "mint(address,uint256)"
          }), ", which was used to mint.", (0,jsx_runtime.jsx)("br", {}), (0,jsx_runtime.jsx)("br", {})]
        }), (0,jsx_runtime.jsxs)(_components.p, {
          children: ["Any ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "ERC-20"
          }), " on Push Chain with standard ", (0,jsx_runtime.jsx)(_components.code, {
            children: "name()"
          }), ", ", (0,jsx_runtime.jsx)(_components.code, {
            children: "symbol()"
          }), " and ", (0,jsx_runtime.jsx)(_components.code, {
            children: "decimals()"
          }), " is a PC-20. Your ERC-20 addresses born on Push will just work."]
        })]
      }), (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
// customPropHighlightRegexStart=universal\.sendTransaction
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=send_transaction_route1_pc20_import

  // Round trip: mint a PC-20 on Push Chain → export it to Sepolia →
  // burn the wrapper to unlock it back to your UEA.
  import { PushChain } from '@pushchain/core';
  import { ethers } from 'ethers';
  import * as readline from 'node:readline/promises';
  ...
  // $UNICORN on Push Chain. See the Mint Universal ERC-20 tutorial.
  const UNICORN = '0x0165878A594ca255338adfa4d48449f69242Eb8F';
  const MINT_ABI = [{
  ...
  async function main() {
    ...
    const token = await PushChain.utils.tokens.getPC20Address(UNICORN, {
      chain: PushChain.CONSTANTS.CHAIN.PUSH_TESTNET_DONUT,
      network: PushChain.CONSTANTS.PUSH_NETWORK.TESTNET,
    });
    const one = PushChain.utils.helpers.parseUnits('1', { decimals: token.decimals });

    await rl.question(':::prompt:::Send at least 0.03 Sepolia ETH to ' + wallet.address + ' on Ethereum Sepolia, then press Enter.\\\\n(This is the only account you fund — the SDK fee-locks it to mint the PC your UEA needs for all three legs.)\\\\nSepolia faucet: https://cloud.google.com/application/web3/faucet/ethereum/sepolia');

    // Re-prompt rather than exit: this wallet is generated per run, so bailing
    // out and re-running would strand whatever you just sent to it.
    while ((await provider.getBalance(wallet.address)) === 0n) {
      await rl.question(':::prompt:::Still 0 ETH at ' + wallet.address + '. Send Sepolia ETH there, then press Enter.');
    }

    try {
      // 1. Mint — $UNICORN's mint() is public, so the script self-serves.
      console.log('⚒️  Minting', token.symbol, 'on Push Chain...');
      const mintTx = await client.universal.sendTransaction({
        to: UNICORN,
        data: PushChain.utils.helpers.encodeTxData({
          abi: MINT_ABI,
          functionName: 'mint',
          args: [client.universal.account, PushChain.utils.helpers.parseUnits('10', { decimals: token.decimals })],
        }),
      });
      await mintTx.wait();

      // 2. Export to your own Sepolia address. First export deploys the wrapper.
      console.log('📤 Exporting 1', token.symbol, 'to Sepolia...');
      const outTx = await client.universal.sendTransaction({
        ...
        funds: {
          ...
          token: { chain: PushChain.CONSTANTS.CHAIN.PUSH_TESTNET_DONUT, address: UNICORN },
        },
      });
      await outTx.wait();
      // The registry is the authoritative record of where a PC-20 lives on
      // each chain, so resolve the wrapper from it.
      const exported = await PushChain.utils.tokens.getPC20Address(UNICORN, {
        chain: PushChain.CONSTANTS.CHAIN.PUSH_TESTNET_DONUT,
        network: PushChain.CONSTANTS.PUSH_NETWORK.TESTNET,
      });
      const wrapper = exported.registry.find((e) => e.chainName === 'ETHEREUM_SEPOLIA');
      if (!wrapper) throw new Error('Sepolia wrapper is not registered yet — retry in a moment.');
      console.log('📦 Wrapper on Sepolia:', wrapper.address);

      // 3. Wait for the wrapper to actually land, as settlement takes a few seconds.
      const erc20 = new ethers.Contract(wrapper.address, ['function balanceOf(address) view returns (uint256)'], provider);
      console.log('⏳ Waiting for delivery on Sepolia...');
      for (let tries = 0; (await erc20.balanceOf(wallet.address)) < one; tries++) {
        if (tries > 60) throw new Error('Wrapper never arrived on Sepolia after ~5 minutes.');
        if (tries > 0 && tries % 6 === 0) console.log('   still waiting (' + (tries * 5) + 's)...');
        await new Promise((r) => setTimeout(r, 5000));
      }
      console.log('📬 Delivered.');

      // 4. Burn the wrapper to bring it home. No approval is sent.
      console.log('🔥 Burning the wrapper back to Push Chain...');
      const backTx = await client.universal.sendTransaction({
        // A plain address means Route 1 — execute on Push Chain. This is
        // where the unlocked $UNICORN lands, so send it to your own UEA.
        to: client.universal.account,
        funds: {
          amount: one,
          // 'chain' is where the token IS — Sepolia now, not the destination.
          token: { chain: PushChain.CONSTANTS.CHAIN.ETHEREUM_SEPOLIA, address: wrapper.address },
        },
        progressHook: (p) => console.log('[' + p.id + '] ' + p.level + ' — ' + (p.title || '')),
      });
      await backTx.wait();
      console.log('🎉 Round trip complete —', token.symbol, 'is back at', client.universal.account);
    } catch (err) {
      console.error('❌ Failed:', err && err.message ? err.message : err);
    }
  }
...
`
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          children: "Route 2"
        }), " originates from a wallet on an external chain or a Push Account (UEA, native Push Chain wallet, or smart contract on Push) → routes through your CEA on a target external chain → executes the transaction on that target chain. See ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/send-universal-transaction/#how-routing-works",
          children: "How Universal Routing Works"
        }), " to learn more. Useful for cross-chain transfers, calling external-chain contracts from a single account, atomic move-and-call workflows, etc."]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(Details/* default */.A, {
      summary: "Contract Call on External Chain",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Funds Transfer (Native Value to External Chain)",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Funds Transfer (Assets to External Chain)",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Funds with Payload (Move Assets and Call Contract on External Chain)",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Multicall (Batch Contract Calls on External Chain)",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Contract Call on Solana from Ethereum Sepolia",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Move PC-20 Token from Push to an External Chain",
      className: "alert alert--live-play",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["Send a ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/send-universal-transaction/#moving-pc-20-tokens",
          children: "PC-20 (Token born on Push Chain)"
        }), " outward. The token is approved and locked into VaultPC20 on Push Chain, and its wrapper is minted on the destination chain. If the token has never been exported there, the wrapper is ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "deployed as part of this transaction"
        }), ".", (0,jsx_runtime.jsx)("br", {}), (0,jsx_runtime.jsx)("br", {})]
      }), (0,jsx_runtime.jsxs)(_components.p, {
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          children: "Pre-requisite:"
        }), ". Mint yourself some ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "$UNICORN"
        }), " from ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/tutorials/basics/tutorial-mint-erc-20-tokens/",
          children: "Mint Universal ERC-20 Tokens"
        }), ". $UNICORN is an ordinary ERC-20 that exists on Push Chain."]
      }), (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
          url: "https://github.com/pushchain/push-chain-examples/tree/main/core-sdk-functions/send-universal-transaction"
...
// customPropHighlightRegexStart=universal\.sendTransaction
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=send_transaction_route2_pc20_export

  // Route 2: export a PC-20 from Push Chain → mint its wrapper on Sepolia.
  import { PushChain } from '@pushchain/core';
  import { ethers } from 'ethers';
  import * as readline from 'node:readline/promises';
  ...
  async function main() {
    ...
    console.log('🪙 Exporting', token.symbol, '— known deployments:');
    for (const entry of token.registry) {
      console.log('   -', entry.chainName, '→', entry.address);
    }

    // The wrapper is delivered here on Sepolia. Defaults to this run's own
    // wallet so the example is self-contained — set it to anything you like.
    const TARGET = wallet.address;

    await rl.question(':::prompt:::Send at least 0.02 Sepolia ETH to ' + wallet.address + ' on Ethereum Sepolia, then press Enter.\\\\n(The SDK fee-locks it to mint the PC your UEA needs, and the script mints its own ' + token.symbol + ' — this is the only account you fund.)\\\\nSepolia faucet: https://cloud.google.com/application/web3/faucet/ethereum/sepolia');
    ...
    // $UNICORN has a public mint(), so the script can self-serve what it exports.
    console.log('⚒️  Minting', token.symbol, 'to your UEA...');
    const mintTx = await client.universal.sendTransaction({
      to: UNICORN,
      data: PushChain.utils.helpers.encodeTxData({
        abi: MINT_ABI,
    ...
    await mintTx.wait();
    console.log('✅ Minted — exporting 1', token.symbol, 'to', TARGET, 'on Sepolia');

    try {
      const tx = await client.universal.sendTransaction({
        to: {
          address: TARGET,
          chain: PushChain.CONSTANTS.CHAIN.ETHEREUM_SEPOLIA, // destination
        },
        funds: {
      ...
      const receipt = await tx.wait();
      console.log('🌐 External tx:', receipt.externalTxHash);
      // Read the wrapper back from the registry.
      const exported = await PushChain.utils.tokens.getPC20Address(UNICORN, {
        chain: PushChain.CONSTANTS.CHAIN.PUSH_TESTNET_DONUT,
        network: PushChain.CONSTANTS.PUSH_NETWORK.TESTNET,
      });
      const wrapper = exported.registry.find((e) => e.chainName === 'ETHEREUM_SEPOLIA');
      console.log('📦 Wrapper on Sepolia:', wrapper ? wrapper.address : '(not registered yet)');
      console.log('🔍 Explorer:', receipt.externalExplorerUrl);
    } catch (err) {
      console.error('❌ Failed:', err && err.message ? err.message : err);
    }
...
`
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          children: "Route 3"
        }), " originates from a Push Account (UEA, native Push Chain wallet, or smart contract on Push) → bridges out through your CEA on an external chain → executes the transaction back on Push Chain. See ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/send-universal-transaction/#how-routing-works",
          children: "How Universal Routing Works"
        }), " to learn more. Useful for rebalancing at the universal account level, executing DeFi strategies, settling external-chain holdings back to Push Chain, etc."]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(Details/* default */.A, {
      summary: "Contract Call on Push Chain from BNB CEA",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Bridge Native Back (Native Value from CEA to Push Chain)",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Bridge Funds Back (Assets from CEA to Push Chain)",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Funds with Payload (Bridge Assets and Call Contract on Push Chain)",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Multicall (Batch Contract Calls on Push Chain from CEA)",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      summary: "Contract Call on Push Chain from a Solana CEA",
      className: "alert alert--live-play",
      children: (0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A, {
        repo: {
          title: "Open in Github",
...
`
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Sequence multiple transactions with ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/send-multichain-transactions",
          children: "Send Multichain Transactions"
        })]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Trigger cross-chain execution from contracts with ", (0,jsx_runtime.jsx)(_components.a, {
          href: "/docs/chain/build/contract-initiated-multichain-execution",
          children: "Contract Initiated Multichain Execution"
        })]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Track and poll transaction state with ", (0,jsx_runtime.jsx)(_components.a, {
...
const sourceCode=userPassedCode.split('\n').filter(line=>!/^\s*\/\/\s*customProp\w+=/.test(line)).join('\n').trim();return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_theme_Playground__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A,{showLineNumbers:true,sourceCode:sourceCode// pass everything your snippet needs into the scope
