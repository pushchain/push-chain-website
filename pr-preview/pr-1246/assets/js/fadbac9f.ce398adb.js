      ...
      children: (0,jsx_runtime.jsxs)(_components.table, {
        children: [(0,jsx_runtime.jsx)(_components.thead, {
          ...
          children: [(0,jsx_runtime.jsxs)(_components.tr, {
            ...
            children: [(0,jsx_runtime.jsx)(_components.td, {
              children: (0,jsx_runtime.jsx)(_components.code, {
                children: "options.signAuthorization"
              })
            }), (0,jsx_runtime.jsx)(_components.td, {
              children: (0,jsx_runtime.jsx)(_components.code, {
                children: "(params: SignAuthorizationParams) => Promise<SignedAuthorization>"
              })
            }), (0,jsx_runtime.jsx)(_components.td, {
              children: "Optional. Function to sign an EIP-7702 authorization delegating the EOA's code to a contract"
            })]
          })]
        })]
      })
    }), "\n", (0,jsx_runtime.jsxs)(Details/* default */.A, {
      summary: "Optional `signAuthorization` for EIP-7702 atomic batching",
      className: "alert alert--fn-args",
      children: [(0,jsx_runtime.jsxs)(_components.p, {
        children: ["Provide ", (0,jsx_runtime.jsx)(_components.code, {
          children: "signAuthorization"
        }), " when your wallet can sign raw EIP-7702 authorizations. With it, multicall batches sent from a native Push Chain EOA execute atomically in a single EIP-7702 (type-4) transaction, which means that all calls succeed or the whole transaction reverts. Without it, the SDK safely falls back to the sequential per-call execution (the transaction response's ", (0,jsx_runtime.jsx)(_components.code, {
          children: "atomic"
        }), " field tells you which path ran).", (0,jsx_runtime.jsx)("br", {}), (0,jsx_runtime.jsx)("br", {})]
      }), (0,jsx_runtime.jsxs)(_components.p, {
        children: ["The SDK wires this automatically for ethers v6 ", (0,jsx_runtime.jsx)(_components.code, {
          children: "Wallet"
        }), " (local key) and viem local accounts (e.g. ", (0,jsx_runtime.jsx)(_components.code, {
          children: "privateKeyToAccount"
        }), "). JSON-RPC accounts like browser wallets like MetaMask cannot sign raw EIP-7702 authorizations, and neither can ethers v5 signers."]
      }), (0,jsx_runtime.jsx)(_components.pre, {
        children: (0,jsx_runtime.jsx)(_components.code, {
          className: "language-typescript",
          children: "// SignAuthorizationParams\n{\n  contractAddress: `0x${string}`; // contract to delegate the EOA's code to\n  chainId?: number;               // defaults to the signer's chain\n  nonce?: number;                 // omit to let the wallet fill it\n  executor?: 'self';              // set when the signing EOA also submits the tx\n}\n\n// SignedAuthorization (viem-compatible)\n{\n  address: `0x${string}`;\n  chainId: number;\n  nonce: number;\n  r: `0x${string}`;\n  s: `0x${string}`;\n  yParity: number;\n  v?: bigint;\n}\n"
        })
      })]
