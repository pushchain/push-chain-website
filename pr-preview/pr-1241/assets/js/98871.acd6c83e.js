"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[98871],{
    ...
    async onConnectProxy() {
        try {
            ...
            if (this.connector) {
                ...
                const isPopupBasedConnector = this.connector.id === ConstantsUtil/* ConstantsUtil */.o.CONNECTOR_ID.COINBASE_SDK ||
                    this.connector.id === ConstantsUtil/* ConstantsUtil */.o.CONNECTOR_ID.BASE_ACCOUNT;
    ...
    render() {
      ...
      <wui-flex flexDirection="column" .padding=${['0', '3', '3', '3']} gap="2">
        ...
        <w3m-list-wallet
          ...
          size="sm"
          @click=${() => {
            CoreHelperUtil/* CoreHelperUtil */.w.openHref('https://walletguide.walletconnect.network/', '_blank');
        }}
        ></w3m-list-wallet>
      </wui-flex>
    `;
