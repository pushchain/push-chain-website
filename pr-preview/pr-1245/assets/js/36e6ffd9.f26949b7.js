"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[18056],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_103_universal_transactions_section_mdx_36e_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-103-universal-transactions-section-mdx-36e.json
const site_docs_chain_03_build_103_universal_transactions_section_mdx_36e_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-universal-transactions-section","title":"Universal Transactions","description":"Universal Transactions | Build | Push Chain Docs","source":"@site/docs/chain/03-build/103-Universal-Transactions-Section.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/universal-transactions","permalink":"/push-chain-website/pr-preview/pr-1245/docs/chain/build/universal-transactions","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/103-Universal-Transactions-Section.mdx","tags":[],"version":"current","sidebarPosition":103,"frontMatter":{"id":"docs-chain-build-universal-transactions-section","title":"Universal Transactions","hide_title":false,"slug":"./universal-transactions","displayed_sidebar":"pushChainSidebar","sidebar_position":103,"image":"/assets/docs/previews/docs_chain_build__section--universal_transactions.png"},"sidebar":"pushChainSidebar","previous":{"title":"Initialize EVM Client","permalink":"/push-chain-website/pr-preview/pr-1245/docs/chain/build/initialize-evm-client"},"next":{"title":"Understanding Universal Transactions","permalink":"/push-chain-website/pr-preview/pr-1245/docs/chain/build/understanding-universal-transactions"}}');
...
;// ./docs/chain/03-build/103-Universal-Transactions-Section.mdx
...
const contentTitle = 'Universal Transactions';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      children: (0,jsx_runtime.jsx)("title", {
        children: "Universal Transactions | Build | Push Chain Docs"
      })
      ...
      children: "Send, batch, track, and trigger from contracts: everything about moving value and calls across chains through one Push Chain interface."
