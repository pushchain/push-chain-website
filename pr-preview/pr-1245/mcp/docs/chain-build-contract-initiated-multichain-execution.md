...
> All directions run through the same primitives (UEAs, CEAs, the gateway pair) but the wire format and the on-chain identity differ. For real examples, see the [Contract-Initiated Examples](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/).
...
**Deployed Address**: Per supported chain (Sepolia, BNB Testnet, Arbitrum Sepolia, Base Sepolia, Solana Devnet). See [Smart Contract Address Book - External Chain Gateway Contracts](/push-chain-website/pr-preview/pr-1245/docs/chain/setup/smart-contract-address-book/#external-chain-gateway-contracts).
...
A complete runnable version (Sepolia dispatcher plus Push target) is in the [Inbound to Push](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/inbound-to-push-chain/) example.
...
**Deployed Address**: [**_`0x00000000000000000000000000000000000000C1`_**](/push-chain-website/pr-preview/pr-1245/docs/chain/setup/smart-contract-address-book/#push-chain-core-functionalities)
...
A complete runnable version is in the [Plain Outbound](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/outbound-from-push-chain/) example.
...
> For a visual breakdown of how the four payload layers nest, see the [layered diagram in the Round-Trip example](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/round-trip-auto-back-leg/#the-wire-format).
...
[**_`0x14191Ea54B4c176fCf86f51b0FAc7CB1E71Df7d7`_**](/push-chain-website/pr-preview/pr-1245/docs/chain/setup/smart-contract-address-book/#push-chain-core-functionalities)
...
A complete runnable version is in the [Round-Trip with Auto Back-Leg](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/round-trip-auto-back-leg/) example.
...
-   Explore [Inbound Contract example](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/inbound-to-push-chain/) to see External Chain → Push Chain
-   Explore [Outbound Contract example](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/outbound-from-push-chain/) to see Push Chain → External Chain
-   Explore [Round-Trip Contract example](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/round-trip-auto-back-leg/) to see Push Chain → External Chain → Push Chain
-   Checkout [advanced patterns in Contract-Initiated Examples](/push-chain-website/pr-preview/pr-1245/docs/chain/build/contract-initiated-examples/advanced-patterns/)
-   Compare with user-initiated flows in [Send Universal Transaction](/push-chain-website/pr-preview/pr-1245/docs/chain/build/send-universal-transaction/)
