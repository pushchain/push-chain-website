...
| `PushChain.CONSTANTS.CHAIN.WEB2` | `web2:https` | Web2 / HTTPS endpoint. A read-only destination for [Read Universal State](/push-chain-website/pr-preview/pr-1245/docs/chain/build/universal-read/), not a transaction destination |
...
-   Learn how to [initialize the Push Chain client](/push-chain-website/pr-preview/pr-1245/docs/chain/build/initialize-push-chain-client/)
-   Explore [utility functions](/push-chain-website/pr-preview/pr-1245/docs/chain/build/utility-functions/) that use these constants
-   Build [universal transactions](/push-chain-website/pr-preview/pr-1245/docs/chain/build/send-universal-transaction/) across chains
