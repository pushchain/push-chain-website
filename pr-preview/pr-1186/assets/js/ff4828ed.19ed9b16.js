(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[798],{
...
function _createMdxContent(props) {
  ...
  // customPropGTagEvent=initialize_evm_client_ethers
...
`
  ...
  // customPropHighlightRegexEnd=\\);
  // customPropGTagEvent=initialize_evm_client_viem
...
`
  ...
  // customPropHighlightRegexEnd=\\);
  // customPropGTagEvent=initialize_evm_client_readonly
  import { ethers } from 'ethers';
...
`
  ...
  // customPropHighlightRegexEnd=\\);
  // customPropGTagEvent=initialize_evm_client_viem_fetch_tx
  import { createPublicClient, http } from 'viem';
