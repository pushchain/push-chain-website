(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[6301],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_900_code_snippet_mdx_73d_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-900-code-snippet-mdx-73d.json
const site_docs_chain_900_code_snippet_mdx_73d_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/code-snippet","title":"Code Snippet Playground","description":"Interactive code playground for Push Chain docs","source":"@site/docs/chain/900-Code-Snippet.mdx","sourceDirName":"chain","slug":"/chain/code-snippet","permalink":"/push-chain-website/pr-preview/pr-1186/docs/chain/code-snippet","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/900-Code-Snippet.mdx","tags":[],"version":"current","sidebarPosition":900,"frontMatter":{"id":"code-snippet","title":"Code Snippet Playground","hide_title":false,"slug":"./code-snippet","description":"Interactive code playground for Push Chain docs","displayed_sidebar":"pushChainSidebar","sidebar_position":900,"image":"/assets/docs/previews/code_snippet--code_snippet_playground.png"},"sidebar":"pushChainSidebar"}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
...
// EXTERNAL MODULE: ./src/components/reusables/spinners/SpinnerUnit.tsx + 5 modules
var SpinnerUnit = __webpack_require__(495466);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-live-codeblock/lib/theme/CodeBlock/index.js + 27 modules
var CodeBlock = __webpack_require__(977259);
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(296540);
;// ./src/components/CodeSnippet/CodeSnippetPlayground.tsx
const CodeSnippetPlayground=()=>{return/*#__PURE__*/(0,jsx_runtime.jsx)(BrowserOnly/* default */.A,{fallback:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{display:'flex',justifyContent:'center',padding:'2rem'},children:/*#__PURE__*/(0,jsx_runtime.jsx)(SpinnerUnit/* default */.A,{type:SpinnerUnit/* SPINNER_TYPE */.N.PROCESSING,size:48})}),children:()=>/*#__PURE__*/(0,jsx_runtime.jsx)(CodeSnippetPlaygroundClient,{})});};const CodeSnippetPlaygroundClient=()=>{const[code,setCode]=(0,react.useState)('');const[playgroundType,setPlaygroundType]=(0,react.useState)('react');const[error,setError]=(0,react.useState)('');const[baseUrl,setBaseUrl]=(0,react.useState)('');(0,react.useEffect)(()=>{// Set the base URL dynamically
setBaseUrl(window.location.origin);},[]);(0,react.useEffect)(()=>{const decompressCode=compressedCode=>{try{// Use the base64 string directly - don't URL-decode it
const base64String=compressedCode;console.debug('Decompressing base64, length:',base64String.length);// Decode base64 using TextEncoder/TextDecoder for proper Unicode handling
const binaryString=atob(base64String);const bytes=new Uint8Array(binaryString.length);for(let i=0;i<binaryString.length;i++){bytes[i]=binaryString.charCodeAt(i);}const decoder=new TextDecoder('utf-8',{fatal:false});const decoded=decoder.decode(bytes);console.debug('Decompression successful, decoded length:',decoded.length);return decoded;}catch(err){console.error('Decompression error:',err);// If decompression fails, return as-is
return compressedCode;}};const parseUrl=()=>{try{const hash=window.location.hash;console.debug('Parsing URL hash:',hash.substring(0,100)+'...');if(!hash){setError('No code snippet provided in URL');return;}// Parse hash manually to avoid URLSearchParams corrupting base64 strings
const hashParams=hash.substring(1);const codeMatch=hashParams.match(/code=([^&]+)/);const ideMatch=hashParams.match(/ide=([^&]+)/);const codeParam=codeMatch?codeMatch[1]:null;const ideParam=ideMatch?ideMatch[1]:null;console.debug('Parsed params - code length:',codeParam===null||codeParam===void 0?void 0:codeParam.length,'ide:',ideParam);console.debug('codeParam first 100 chars:',codeParam===null||codeParam===void 0?void 0:codeParam.substring(0,100));if(!codeParam){setError('No code parameter found in URL');return;}const decodedCode=decompressCode(codeParam);setCode(decodedCode);if(ideParam==='node'||ideParam==='react'){setPlaygroundType(ideParam);}else if(ideParam){setError("Invalid playground type: "+ideParam+". Using default (react)");}}catch(err){setError("Error parsing URL: "+((err===null||err===void 0?void 0:err.message)||(err===null||err===void 0?void 0:err.toString())||'Unknown error'));}};parseUrl();},[]);if(error&&!code){return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{padding:'0.5rem',borderRadius:'12px',marginBottom:'1rem'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{children:"\u26A0\uFE0F Error"}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{style:{backgroundColor:'var(--ifm-surface-alert-warning-subtle',borderColor:'var(--ifm-border-alert-warning-subtle)',padding:'0.5rem',borderRadius:'12px',marginBottom:'1rem'},children:error})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{children:"Examples \uD83D\uDC47"}),/*#__PURE__*/(0,jsx_runtime.jsx)("h3",{children:"React Code Snippet"}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{backgroundColor:'var(--ifm-navbar-search-bg)',padding:'0.5rem',borderRadius:'12px',marginTop:'0.5rem',marginBottom:'1.5rem'},children:/*#__PURE__*/(0,jsx_runtime.jsxs)("a",{href:"/docs/chain/code-snippet#code=YOUR_CODE&ide=react",style:{color:'var(--ifm-color-primary)',cursor:'pointer'},children:[baseUrl,"/docs/chain/code-snippet#code=YOUR_CODE&ide=react"]})}),/*#__PURE__*/(0,jsx_runtime.jsx)("h3",{children:"Virtual IDE Code Snippet"}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{backgroundColor:'var(--ifm-navbar-search-bg)',padding:'0.5rem',borderRadius:'12px',marginTop:'0.5rem',marginBottom:'0.5rem'},children:/*#__PURE__*/(0,jsx_runtime.jsxs)("a",{href:"/docs/chain/code-snippet#code=YOUR_CODE&ide=node",style:{color:'var(--ifm-color-primary)',cursor:'pointer'},children:[baseUrl,"/docs/chain/code-snippet#code=YOUR_CODE&ide=node"]})})]})]});}return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:playgroundType==='node'?/*#__PURE__*/(0,jsx_runtime.jsx)(NodeJSVirtualIDE/* default */.A,{repo:null,children:code}):/*#__PURE__*/(0,jsx_runtime.jsx)(ReactPlayground,{code:code})});};const ReactPlayground=_ref=>{let{code}=_ref;return/*#__PURE__*/(0,jsx_runtime.jsx)(CodeBlock/* default */.A,{language:"jsx",live:true,children:code});};/* harmony default export */ const CodeSnippet_CodeSnippetPlayground = (CodeSnippetPlayground);
;// ./src/components/CodeSnippet/index.ts

;// ./docs/chain/900-Code-Snippet.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      children: (0,jsx_runtime.jsx)("title", {
        children: "Code Snippet Platground | Push Chain Docs"
      })
    }), "\n", "\n", (0,jsx_runtime.jsx)(CodeSnippet_CodeSnippetPlayground, {})]
  });
}
