(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[8442],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_09_reading_blockchain_state_mdx_348_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-09-reading-blockchain-state-mdx-348.json
const site_docs_chain_03_build_09_reading_blockchain_state_mdx_348_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-reading-blockchain-state","title":"Reading Blockchain State","description":"Reading Blockchain State | Build | Push Chain Docs","source":"@site/docs/chain/03-build/09-Reading-Blockchain-State.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/reading-blockchain-state","permalink":"/push-chain-website/pr-preview/pr-1197/docs/chain/build/reading-blockchain-state","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/09-Reading-Blockchain-State.mdx","tags":[],"version":"current","sidebarPosition":9,"frontMatter":{"id":"docs-chain-build-reading-blockchain-state","title":"Reading Blockchain State","hide_title":false,"slug":"./reading-blockchain-state","displayed_sidebar":"pushChainSidebar","sidebar_position":9,"image":"/assets/docs/previews/docs_chain_build--reading_blockchain_state.png"},"sidebar":"pushChainSidebar","previous":{"title":"Utility Functions","permalink":"/push-chain-website/pr-preview/pr-1197/docs/chain/build/utility-functions"},"next":{"title":"Contract Helpers","permalink":"/push-chain-website/pr-preview/pr-1197/docs/chain/build/contract-helpers"}}');
...
;// ./docs/chain/03-build/09-Reading-Blockchain-State.mdx
...
// customPropGTagEvent=setup_ethers_http_provider
...
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=setup_viem_http_client
import { createPublicClient, http } from 'viem';

  // HTTP client
  const viemClient = createPublicClient({ transport: http('https://evm.donut.rpc.push.org/') });
...
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=get_transaction_ethers
import { ethers } from 'ethers';
...
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=get_transaction_viem
import { createPublicClient, http } from 'viem';
...
`
  ...
  // customPropHighlightRegexEnd=\\);
  // customPropGTagEvent=get_latest_block_ethers
  import { ethers } from 'ethers';
...
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=get_latest_block_viem
import { createPublicClient, http } from 'viem';
...
// customPropHighlightRegexStart=provider\.getBlock
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=get_specific_block_ethers
import { ethers } from 'ethers';
...
// customPropHighlightRegexStart=viemClient\.getBlock
// customPropHighlightRegexEnd=\\);
// customPropGTagEvent=get_specific_block_viem
import { createPublicClient, http } from 'viem';
...
`
  ...
  // customPropHighlightRegexEnd=\\);
  // customPropGTagEvent=setup_ethers_websocket_provider
  import { ethers } from 'ethers';

  const ws = new ethers.WebSocketProvider('https://evm.donut.rpc.push.org/');
...
`
  ...
  // customPropHighlightRegexStart=createPublicClient\\(
  // customPropHighlightRegexEnd=\\);
  // customPropGTagEvent=setup_viem_websocket_client
...
`
  ...
  // customPropHighlightRegexEnd=}\\);
  // customPropGTagEvent=subscribe_new_blocks_ethers
  import { ethers } from 'ethers';
...
// customPropHighlightRegexStart=ws\.on
// customPropHighlightRegexEnd=}\\);
// customPropGTagEvent=subscribe_pending_transactions_ethers
import { ethers } from 'ethers';
...
`
  ...
  // customPropHighlightRegexEnd=}\\);
  // customPropGTagEvent=watch_pending_transactions_viem
  import { createPublicClient, webSocket } from 'viem';
