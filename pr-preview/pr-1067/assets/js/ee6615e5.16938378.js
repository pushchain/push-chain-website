(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[90301],{
...
;// ./src/components/Chain/config/ChainKnowledgeBasePartners.tsx
const ChainKnowledgeBasePartners=[{slug:'push-chain-joins-forces-with-fuse',imageDirectory:(__webpack_require__(310724)/* ["default"] */ .A),title:'Push Chain Joins Forces With Fuse',subtitle:'Push Chain is joining forces with the Fuse Network to transform the way enterprises and users transact and operate in the web3 economy. Learn what usecases does this collaboration unlocks',url:'/blog/push-chain-joins-forces-with-fuse'},{slug:'push-chain-joins-forces-with-stacks',imageDirectory:(__webpack_require__(582523)/* ["default"] */ .A),title:'Push Chain Joins Forces With Stacks',subtitle:'Push Chain is building with Stacks to unlock accessibility to Bitcoin apps from any chain, any app, and any wallet.',url:'/blog/push-chain-joins-forces-with-stacks'},{slug:'push-chain-joins-forces-with-morph',imageDirectory:(__webpack_require__(376831)/* ["default"] */ .A),title:'Push Chain Joins Forces With Morph',subtitle:'Push Chain is about to facelift the consumer app experience by teaming up with Morph L2!. Learn everything about our collaboration with Morph - what it means for Push and Morph...',url:'/blog/push-chain-joins-forces-with-stacks'},{slug:'push-chain-joins-forces-with-zkpass',imageDirectory:(__webpack_require__(316986)/* ["default"] */ .A),title:'Push Chain Joins Forces With zkPass',subtitle:'Push chain is pumped to join forces with zkPass to transform user privacy in the new internet world. Discover how this collaboration empowers devs, users and the entire web3',url:'/blog/push-chain-joins-forces-with-zkpass/'},{slug:'push-chain-joins-forces-with-plume',imageDirectory:(__webpack_require__(50329)/* ["default"] */ .A),title:'Push Chain Joins Forces With Plume',subtitle:'Push Chain is set to revolutionize RWAfi by joining forces with Plume! Learn what this announcement means for Plume and Push Chain users, the use cases it unlocks, and how the...',url:'/blog/push-chain-joins-forces-with-plume/'},{slug:'push-chain-joins-forces-with-zklink',imageDirectory:(__webpack_require__(270803)/* ["default"] */ .A),title:'Push Chain Joins Forces With zkLink',subtitle:"Push Chain's road to testnet has kickstarted in full swing. Learn everything about our collaboration with zkLink - what it means for Push and zkLink users, the use cases it unlocks and more!",url:'/blog/push-chain-joins-forces-with-zklink'},{slug:'push-chain-joins-forces-with-aptos',imageDirectory:(__webpack_require__(979825)/* ["default"] */ .A),title:'Push Chain Joins Forces With Aptos',subtitle:"Push Chain's road to testnet has kickstarted in full swing. Learn everything about our collaboration with Aptos - what it means for Push and Aptos users, the use cases it unlocks and more!",url:'/blog/push-chain-joins-forces-with-aptos'}];
...
;// ./src/components/Chain/ChainKnowledgeBasePartners/ChainKnowledgeBasePartnersGrid.tsx
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-nocheck
const ChainKnowledgeBaseGridPartners=()=>{const isMobile=(0,useMediaQuery/* default */.A)(globals/* device */.jO.mobileL);const isTablet=(0,useMediaQuery/* default */.A)(globals/* device */.jO.tablet);const gridRows=(0,CreateGridRows/* createGridRows */.y)(ChainKnowledgeBasePartners);console.log(gridRows,'grid grid',ChainKnowledgeBasePartners);return/*#__PURE__*/(0,jsx_runtime.jsxs)(ChainKnowledgeBaseGridWrapper,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(SharedStyling/* ItemV */.y8,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(SharedStyling.H2,{fontSize:isMobile?'32px':'40px',fontWeight:"500",fontFamily:"N27",lineHeight:isMobile?'100%':'140%',letterSpacing:"-0.8px",textAlign:"center",children:"Hey! Meet our Partners"})}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ChainKnowledgeGridWrapper,{children:[!isTablet&&(gridRows===null||gridRows===void 0?void 0:gridRows.map((row,rowIndex)=>/*#__PURE__*/(0,jsx_runtime.jsx)(ChainKnowledgeGrid,{itemsInRow:row.length,children:row.map((item,index)=>/*#__PURE__*/(0,jsx_runtime.jsx)(ChannelKnowledgeBaseComponentItem/* default */.A,{item:item,index:index}))},rowIndex))),/*#__PURE__*/(0,jsx_runtime.jsx)(ChainKnowledgeGrid,{children:isTablet&&(ChainKnowledgeBasePartners===null||ChainKnowledgeBasePartners===void 0?void 0:ChainKnowledgeBasePartners.map((item,index)=>/*#__PURE__*/(0,jsx_runtime.jsx)(ChannelKnowledgeBaseComponentItem/* default */.A,{item:item,index:index})))})]})]});};/* harmony default export */ const ChainKnowledgeBasePartnersGrid = (ChainKnowledgeBaseGridPartners);const ChainKnowledgeBaseGridWrapper=styled_components_browser_esm["default"].div.withConfig({displayName:"ChainKnowledgeBasePartnersGrid__ChainKnowledgeBaseGridWrapper",componentId:"sc-j718i0-0"})(["margin:200px auto 0 auto;@media ","{margin:153px auto 0 auto;}"],globals/* device */.jO.mobileL);const ChainKnowledgeGridWrapper=styled_components_browser_esm["default"].div.withConfig({displayName:"ChainKnowledgeBasePartnersGrid__ChainKnowledgeGridWrapper",componentId:"sc-j718i0-1"})(["display:flex;flex-direction:column;gap:24px;margin:48px 0 0 0;"]);const ChainKnowledgeGrid=styled_components_browser_esm["default"].div.withConfig({displayName:"ChainKnowledgeBasePartnersGrid__ChainKnowledgeGrid",componentId:"sc-j718i0-2"})(["display:grid;grid-template-columns:",";gap:24px;width:100%;justify-content:center;@media ","{grid-template-columns:repeat(2,1fr);}@media ","{grid-template-columns:1fr;}"],_ref=>{let{itemsInRow}=_ref;return itemsInRow===3?'repeat(3, 1fr)':'repeat(2, 1fr)';},globals/* device */.jO.tablet,globals/* device */.jO.mobileL);
;// ./src/components/Chain/ChainKnowledgeBasePartners/ChainKnowledgeBasePartners.tsx
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-nocheck
const ChainKnowledgeBasePartners_ChainKnowledgeBasePartners=()=>{return/*#__PURE__*/(0,jsx_runtime.jsx)(ChainWrapper,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(ChainInnerWrapper,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ChainKnowledgeBasePartnersGrid,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(ChainBottomComponent/* default */.A,{})]})});};/* harmony default export */ const Chain_ChainKnowledgeBasePartners_ChainKnowledgeBasePartners = (ChainKnowledgeBasePartners_ChainKnowledgeBasePartners);const ChainWrapper=(0,styled_components_browser_esm["default"])(SharedStyling/* ItemV */.y8).withConfig({displayName:"ChainKnowledgeBasePartners__ChainWrapper",componentId:"sc-ymkh5j-0"})(["width:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;background:#e8eff8;font-family:N27,sans-serif;"]);const ChainInnerWrapper=(0,styled_components_browser_esm["default"])(SharedStyling/* ItemV */.y8).withConfig({displayName:"ChainKnowledgeBasePartners__ChainInnerWrapper",componentId:"sc-ymkh5j-1"})(["width:1200px;margin:0 auto;@media ","{width:1400px;}@media ","{width:1200px;}@media (max-width:1248px){width:100%;padding:0 24px;}@media ","{padding:0 24px;}@media ","{padding:0 16px;}"],globals/* device */.jO.desktopL,globals/* device */.jO.desktop,globals/* device */.jO.tablet,globals/* device */.jO.mobileL);
// EXTERNAL MODULE: ./src/config/pageMeta.ts
var pageMeta = __webpack_require__(353760);
;// ./src/pages/knowledge/partners.tsx
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-nocheck
// React + Web3 Essentials
// Internal Component
// Internal Configs
function PushChainKnowledgeBase(){return/*#__PURE__*/(0,jsx_runtime.jsxs)(Layout/* default */.A,{title:pageMeta/* PageMeta */.t.PARTNERS.pageTitle,description:pageMeta/* PageMeta */.t.PARTNERS.pageDescription,showNavbar:'chain',children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Head/* default */.A,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:url",content:"https://push.org/chain/knowledge/partners"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:type",content:"website"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:title",content:"Push Chain | Knowledge Base"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"og:description",content:"Meet our Partners."}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{property:"og:image",content:(0,useBaseUrl/* default */.A)((__webpack_require__(644629)/* ["default"] */ .A),{absolute:true})}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:card",content:"summary_large_image"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:site",content:"@PushChain"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:title",content:"Push Chain | Knowledge Base Partners"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:description",content:"Meet our Partners"}),/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{name:"twitter:image",content:(0,useBaseUrl/* default */.A)((__webpack_require__(644629)/* ["default"] */ .A),{absolute:true})}),/*#__PURE__*/(0,jsx_runtime.jsx)("script",{type:"application/ld+json",children:JSON.stringify({'@context':'https://schema.org/','@type':'Organization',name:'Push Chain',description:'Any Chain. Any User. Any App',url:'https://push.org',logo:'/assets/website/favicon.ico',sameAs:['https://x.com/PushChain','https://www.linkedin.com/company/push-protocol/mycompany/']})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Chain_ChainKnowledgeBasePartners_ChainKnowledgeBasePartners,{})]});}/* harmony default export */ const partners = (PushChainKnowledgeBase);
