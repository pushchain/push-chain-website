...
var usePluralForm = __webpack_require__(853465);
// EXTERNAL MODULE: ./node_modules/@docusaurus/core/lib/client/exports/Translate.js + 1 modules
var Translate = __webpack_require__(721312);
// EXTERNAL MODULE: ./node_modules/moment/moment.js
var moment = __webpack_require__(795093);
var moment_default = /*#__PURE__*/__webpack_require__.n(moment);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
;// ./src/components/reusables/date.tsx
function useReadingTimePlural(){const{selectMessage}=(0,usePluralForm/* usePluralForm */.W)();return readingTimeFloat=>{const readingTime=Math.ceil(readingTimeFloat);return selectMessage(readingTime,(0,Translate/* translate */.T)({id:'theme.blog.post.readingTime.plurals',description:'Pluralized label for "{readingTime} min read". Use as much plural forms (separated by "|") as your language support (see https://www.unicode.org/cldr/cldr-aux/charts/34/supplemental/language_plural_rules.html)',message:'One min read|{readingTime} min read'},{readingTime}));};}function Spacer(){return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:' · '});}function ReadingTime(_ref){let{readingTime}=_ref;const readingTimePlural=useReadingTimePlural();return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:readingTimePlural(readingTime)});}function date_Date(_ref2){let{date,formattedDate,mr}=_ref2;const year=moment_default()().year();const isPresentYear=formattedDate===null||formattedDate===void 0?void 0:formattedDate.includes(year);const newDate=moment_default()(formattedDate,'MMM DD, YYYY').format(!isPresentYear?'MMM DD,  YYYY':'MMM DD');return/*#__PURE__*/(0,jsx_runtime.jsx)("time",{style:{marginRight:mr},dateTime:date,itemProp:"datePublished",children:newDate});}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogPostItemHeaderInfo(_ref){let{className,morePosts}=_ref;const{metadata,isBlogPostPage}=(0,blogPost/* useBlogPost */.e)();const{date,formattedDate,readingTime}=metadata;if(morePosts){const blogDate=morePosts.date;const blogFormattedDate=morePosts.formattedDate;const blogReadingTime=morePosts.readingTime;return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx_m/* default */.A)(styles_module.container,!isBlogPostPage?'margin-vert--sm':'',className),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(date_Date,{date:blogDate,formattedDate:blogFormattedDate}),typeof blogReadingTime!=='undefined'&&/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Spacer,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(ReadingTime,{readingTime:blogReadingTime})]})]});}else{return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx_m/* default */.A)(styles_module.container,!isBlogPostPage?'margin-vert--sm':'',className),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(date_Date,{date:date,formattedDate:formattedDate}),typeof readingTime!=='undefined'&&/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Spacer,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(ReadingTime,{readingTime:readingTime})]})]});}}
...
/* harmony import */ var react_live__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(791409);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(474848);
...
}function loadClientSideLibrarySolana(constantName){return typeof window!=='undefined'?__webpack_require__(854417)[constantName]:Promise.resolve({});// Return an empty object or appropriate placeholder for SSR.
...
}function loadClientSideLibraryPushProtocolUIWeb(constantName){return typeof window!=='undefined'?__webpack_require__(921086)[constantName]:Promise.resolve({});// Return an empty object or appropriate placeholder for SSR.
...
const matchEnd=line.match(/\/\/\s*customPropHighlightRegexEnd=(.+)$/);if(matchEnd){highlightRegexEnd=matchEnd[1].trim();}// remove any customProp flags from this line
lines[idx]=lines[idx].replace(/\/\/\s*customPropMinimized=['"](\w+)['"]/,'').replace(/\/\/\s*customPropHidden=['"](\w+)['"]/,'').replace(/\/\/\s*customPropNodeJSEnv=['"](\w+)['"]/,'').replace(/\/\/\s*customPropHighlightRegexStart=.*$/,'').replace(/\/\/\s*customPropHighlightRegexEnd=.*$/,'');// if line is now just whitespace or comment, drop it
...
/* harmony import */ var _theme_Layout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(994160);
...
var lib = __webpack_require__(120312);
var lib_default = /*#__PURE__*/__webpack_require__.n(lib);
;// ./src/theme/BlogPostPage/FooterItem.js
// Internal Components
// Internal Configs
const FooterItem=()=>{const isMobile=(0,useMediaQuery/* default */.A)(globals/* device */.jO.tablet);const[open,setOpen]=react.useState(false);const openModal=()=>{setOpen(true);// document.body.style.overflow = "hidden";
...
};const customStyles={overlay:{background:'rgba(0, 0, 0, 0.60)',backdropFilter:'blur(10px)'},content:{height:'230px',width:'348px',top:'50%',left:'50%',transform:'translate(-50%, -50%)',borderRadius:'16px',border:'none',background:'var(--ifm-color-primary-inverse)'}};const OpenURL=link=>{window.open(link,'_blank');};const LinkModal=()=>{const openLink=link=>{window.open(link,'_blank');};return/*#__PURE__*/(0,jsx_runtime.jsx)((lib_default()),{isOpen:open,onRequestClose:closeModal,style:customStyles,onAfterOpen:afterOpenModal,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(ModalItem,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(ModalDiv,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ModalTopic,{children:"Share"}),/*#__PURE__*/(0,jsx_runtime.jsx)(index_esm.BsX,{color:"",size:28,onClick:closeModal,className:"closeIcon"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ModalIcons,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ModalFigure,{color:"#1DA1F2",onClick:()=>openLink("https://twitter.com/intent/tweet?text="+window.location.href),children:/*#__PURE__*/(0,jsx_runtime.jsx)(index_esm.BsTwitter,{size:32,color:"#fff"})}),/*#__PURE__*/(0,jsx_runtime.jsx)(ModalFigure,{color:"#0077B5",onClick:()=>openLink("https://www.linkedin.com/sharing/share-offsite/?url="+window.location.href),children:/*#__PURE__*/(0,jsx_runtime.jsx)(fa_index_esm/* FaLinkedinIn */.H1h,{size:32,color:"#fff"})}),/*#__PURE__*/(0,jsx_runtime.jsx)(ModalFigure,{color:"#4867AA",onClick:()=>openLink("https://www.facebook.com/sharer/sharer.php?u="+window.location.href),children:/*#__PURE__*/(0,jsx_runtime.jsx)(fa_index_esm/* FaFacebookF */.ok6,{size:32,color:"#fff"})})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ModalLink,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ModalInput,{children:window.location.href}),/*#__PURE__*/(0,jsx_runtime.jsx)(ModalCopy,{onClick:()=>navigator.clipboard.writeText(window.location.href),children:"Copy link"})]})]})});};return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(ShareRow,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ResponsiveH2,{size:isMobile?'16px':'24px',weight:"500",spacing:"-0.02em",lineHeight:"110%",color:"#00000",children:"Be a part of the conversation by sharing this article"}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ShareButton,{title:"Developer Docs",background:"#D53A94",radius:"12px",padding:"14px 20px",size:"16px",weight:"500",spacing:"-0.03em",lineHeight:"26px",display:"flex",flexDirection:"row",alignItems:"center",self:isMobile?'stretch':'self',onClick:openModal,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(bi_index_esm/* BiShareAlt */.e7V,{size:23,color:"#fff",style:{marginRight:'10px'}}),"Share"]})]}),open&&/*#__PURE__*/(0,jsx_runtime.jsx)(LinkModal,{}),/*#__PURE__*/(0,jsx_runtime.jsxs)(AboutSection,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(AboutTitle,{children:"About Push Chain"}),/*#__PURE__*/(0,jsx_runtime.jsx)(AboutSpan,{fontFamily:"DM Sans, sans-serif",textAlign:"center",fontSize:"19px",fontWeight:"400",lineHeight:"32px",children:"Push Chain is a Proof of Stake (PoS) layer 1 blockchain network designed to revolutionize web3 by addressing scalability, interoperability, and user experience challenges. Its shared-state architecture empowers developers to create universal applications that can blend financial and non-financial use cases with ease, all while achieving sub-second finality."})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(KPIBanner,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(BannerItem,{onClick:()=>OpenURL('https://x.com/PushChain'),gap:"18px",className:"kpiItem",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(index_esm.BsTwitter,{size:32}),/*#__PURE__*/(0,jsx_runtime.jsx)(KPIMetric,{children:"Twitter"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(BannerItem,{onClick:()=>OpenURL('https://discord.gg/pushprotocol'),gap:"18px",className:"kpiItem",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(fa_index_esm/* FaDiscord */.O4U,{size:32}),/*#__PURE__*/(0,jsx_runtime.jsx)(KPIMetric,{children:"Discord"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(BannerItem,{onClick:()=>OpenURL('https://www.youtube.com/@pushprotocol'),gap:"18px",className:"kpiItem",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(index_esm.BsYoutube,{size:32}),/*#__PURE__*/(0,jsx_runtime.jsx)(KPIMetric,{children:"YouTube"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(BannerItem,{onClick:()=>OpenURL('https://www.linkedin.com/company/push-protocol/'),gap:"18px",className:"kpiItem",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(index_esm.BsLinkedin,{size:32}),/*#__PURE__*/(0,jsx_runtime.jsx)(KPIMetric,{children:"Linkedin"})]})]})]});};/* harmony default export */ const BlogPostPage_FooterItem = (FooterItem);const AboutSection=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__AboutSection",componentId:"sc-wqmvol-0"})(["margin-top:99px;span{font-size:18px;line-height:37px;color:#282a2d;letter-spacing:-0.002em;@media ","{font-size:16px;line-height:36px;}}"],globals/* device */.jO.mobileL);const AboutTitle=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__AboutTitle",componentId:"sc-wqmvol-1"})(["font-family:DM Sans,sans-serif !important;font-weight:700;font-size:28px;line-height:38px;color:var(--ifm-color-primary-blog);margin-bottom:10px;letter-spacing:-0.02em;@media ","{font-weight:700;font-size:24px;line-height:30px;}"],globals/* device */.jO.mobileL);const AboutSpan=(0,styled_components_browser_esm["default"])(SharedStyling/* Span */.L9).withConfig({displayName:"FooterItem__AboutSpan",componentId:"sc-wqmvol-2"})(["color:var(--ifm-color-blog-tag) !important;"]);const KPIBanner=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__KPIBanner",componentId:"sc-wqmvol-3"})(["background:var(--ifm-color-blog-footer);border-radius:24px;display:flex;align-items:center;justify-content:center;width:100%;padding:20px 0px;font-family:DM Sans,sans-serif;font-style:normal;margin-top:30px;margin-bottom:100px;& .kpiItem{display:flex;flex-direction:row;align-items:center !important;}@media ","{flex-direction:row;flex-wrap:wrap;width:100%;row-gap:32px;column-gap:8px;margin-top:30px;& .kpiItem{flex-direction:row;row-gap:8px;flex:0 0 48%;}}"],globals/* device */.jO.tablet);const BannerItem=(0,styled_components_browser_esm["default"])(SharedStyling/* ItemV */.y8).withConfig({displayName:"FooterItem__BannerItem",componentId:"sc-wqmvol-4"})(["color:var(--ifm-color-footer);grid-gap:8px;cursor:pointer align-items:center !important;&:hover{color:#d53893;}"]);const KPIMetric=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__KPIMetric",componentId:"sc-wqmvol-5"})(["font-weight:500;font-size:16px;line-height:110%;letter-spacing:-0.03em;@media ","{font-size:16px;font-weight:400;}"],globals/* device */.jO.tablet);const ResponsiveH2=(0,styled_components_browser_esm["default"])(SharedStyling.H2).withConfig({displayName:"FooterItem__ResponsiveH2",componentId:"sc-wqmvol-6"})([""]);const ShareRow=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ShareRow",componentId:"sc-wqmvol-7"})(["margin:50px 0 0px 0;display:flex;justify-content:space-between;align-items:center;@media ","{flex-direction:row;margin-top:52px;align-items:center;}@media ","{display:flex;flex-direction:column;justify-content:space-between;align-items:center;}"],globals/* device */.jO.tablet,globals/* device */.jO.mobileL);const ShareButton=(0,styled_components_browser_esm["default"])(SharedStyling/* Button */.$n).withConfig({displayName:"FooterItem__ShareButton",componentId:"sc-wqmvol-8"})(["@media ","{width:100%;margin:20px;}"],globals/* device */.jO.mobileL);// modal url
const ModalDiv=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ModalDiv",componentId:"sc-wqmvol-9"})(["width:100%;display:flex;flex-direction:row;justify-content:space-between;align-items:center;margin-bottom:32px;&.closeIcon{cursor:pointer;}"]);const ModalTopic=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ModalTopic",componentId:"sc-wqmvol-10"})(["color:var(--ifm-color-primary-text);font-size:20px;font-family:DM Sans,sans-serif;line-height:142%;letter-spacing:-0.6px;"]);const ModalIcons=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ModalIcons",componentId:"sc-wqmvol-11"})(["width:fit-content;margin:0 auto;display:flex;flex-direction:row;grid-gap:32px;"]);const ModalLink=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ModalLink",componentId:"sc-wqmvol-12"})(["width:100%;display:flex;flex-direction:row;align-items:center;margin-top:28px;justify-content:center;"]);const ModalCopy=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ModalCopy",componentId:"sc-wqmvol-13"})(["color:#fff;font-size:14px;font-family:DM Sans,sans-serif;font-weight:500;line-height:142%;letter-spacing:-0.42px;border-radius:0px 8px 8px 0px;background:#d53a94;padding:8px 12px;height:35.88px;cursor:pointer;"]);const ModalInput=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ModalInput",componentId:"sc-wqmvol-14"})(["border-radius:8px 0px 0px 8px;border:var(--ifm-modal-border-input);background:var(--ifm-modal-input);color:var(--ifm-color-primary-text);padding:8px 12px;max-width:212px;min-width:212px;height:35.88px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:flex;align-items:center;@media ","{max-width:200px;min-width:200px;}@media ","{max-width:150px;min-width:150px;}"],globals/* device */.jO.mobileL,globals/* device */.jO.mobileM);const ModalFigure=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ModalFigure",componentId:"sc-wqmvol-15"})(["width:52px;height:52px;border-radius:16px;background:",";display:flex;justify-content:center;align-items:center;cursor:pointer;"],props=>props.color);const ModalItem=styled_components_browser_esm["default"].div.withConfig({displayName:"FooterItem__ModalItem",componentId:"sc-wqmvol-16"})([""]);
// EXTERNAL MODULE: ./node_modules/@docusaurus/core/lib/client/exports/Link.js + 1 modules
var Link = __webpack_require__(175489);
// EXTERNAL MODULE: ./src/theme/BlogPostItem/Header/Info/index.js + 2 modules
var Info = __webpack_require__(231198);
...
// Internal Components
// Internal Configs
const MorePosts=_ref=>{let{allPosts,post}=_ref;const isMobile=(0,useMediaQuery/* default */.A)(globals/* device */.jO.tablet);const[filteredArray,setFilteredArray]=(0,react.useState)();const filterPost=()=>{var _post$Preview;const tagList=post===null||post===void 0||(_post$Preview=post.Preview)===null||_post$Preview===void 0||(_post$Preview=_post$Preview.metadata)===null||_post$Preview===void 0?void 0:_post$Preview.tags;// Get tags of the current post
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogPostPageContent(_ref){let{allPosts,post,children}=_ref;const{metadata,toc}=(0,blogPost/* useBlogPost */.e)();const{frontMatter}=metadata;const{hide_table_of_contents:hideTableOfContents,toc_min_heading_level:tocMinHeadingLevel,toc_max_heading_level:tocMaxHeadingLevel}=frontMatter;return/*#__PURE__*/(0,jsx_runtime.jsx)(BlogLayout/* default */.A,{toc:!hideTableOfContents&&toc.length>0?/*#__PURE__*/(0,jsx_runtime.jsx)(TOC/* default */.A,{toc:toc,minHeadingLevel:tocMinHeadingLevel,maxHeadingLevel:tocMaxHeadingLevel}):undefined,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(BlogItem,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItem/* default */.A,{children:children}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostPage_FooterItem,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostPage_MorePosts,{allPosts:allPosts,post:post})]})});}function BlogPostPage(props){const blogPath=props.location.pathname.substring(0,props.location.pathname.length-1);const allPosts=props.allPosts;const contentName=allPosts===null||allPosts===void 0?void 0:allPosts.filter(x=>{var _x$Preview;return x===null||x===void 0||(_x$Preview=x.Preview)===null||_x$Preview===void 0||(_x$Preview=_x$Preview.metadata)===null||_x$Preview===void 0?void 0:_x$Preview.permalink.includes(blogPath);})[0];const BlogPostContent=contentName===null||contentName===void 0?void 0:contentName.Preview;return/*#__PURE__*/(0,jsx_runtime.jsx)(blogPost/* BlogPostProvider */.i,{content:contentName===null||contentName===void 0?void 0:contentName.Preview,isBlogPostPage:true,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(metadataUtils/* HtmlClassNameProvider */.e3,{className:(0,clsx_m/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.wrapper.blogPages,ThemeClassNames/* ThemeClassNames */.G.page.blogPostPage),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostPageMetadata,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostPageContent,{allPosts:allPosts,post:contentName,children:/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostContent,{})})]})});}const BlogItem=styled_components_browser_esm["default"].div.withConfig({displayName:"BlogPostPage__BlogItem",componentId:"sc-jhnfyo-0"})(["width:800px !important;margin:0 auto;& article .markdown{*{font-size:1.15rem;}h1{font-size:2.65rem;font-weight:700;}h2{font-size:2rem;font-weight:700;}h3{font-size:1.5rem;font-weight:700;}h4{font-size:1.25rem;font-weight:700;}h5{font-size:1.15rem;font-weight:700;}h6{font-size:1rem;font-weight:700;}}@media (max-width:820px){width:100% !important;padding:",";box-sizing:border-box;}"],""+globals/* default */.Ay.STRUCTURE.PADDING.MOBILE);
