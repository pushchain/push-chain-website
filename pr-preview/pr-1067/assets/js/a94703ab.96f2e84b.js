...
/* harmony import */ var _site_static_assets_website_chain_ChainLogoDark_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(307320);
...
const SvgChainLogoDark = _ref => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("svg", _extends({
    ...
    d: "M18.095 44C16.94 44 16 43.074 16 41.944V17.73c0-1.136.94-2.055 2.095-2.055h5.413c1.265 0 2.288-1.008 2.288-2.247V8.056c0-1.137.94-2.056 2.094-2.056h18.015C47.06 6 48 6.919 48 8.056v14.718c0 1.13-.94 2.056-2.095 2.056h-5.413c-1.264 0-2.288 1.007-2.288 2.246v5.31c0 1.13-.94 2.056-2.094 2.056h-8.026c-1.265 0-2.288 1.008-2.288 2.247v5.255c0 1.13-.94 2.056-2.095 2.056h-5.606Zm9.989-28.388c-1.265 0-2.288 1.008-2.288 2.247v4.724c0 1.24 1.023 2.247 2.288 2.247h7.832c1.265 0 2.288-1.008 2.288-2.247V17.86c0-1.24-1.023-2.247-2.288-2.247h-7.832Z",
    fill: "#D548EC"
  })), _path2 || (_path2 = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("path", {
    d: "M68.74 16.145a10.17 10.17 0 0 0-1.415-.098h-6.918a.406.406 0 0 0-.407.403v17.06c0 .222.182.403.407.403h2.153c.224 0 .407-.181.407-.404V27.86c0-.222.182-.403.407-.403h3.95c.32 0 .96-.024 1.415-.098 3.053-.463 4.518-2.715 4.518-5.6 0-2.887-1.441-5.14-4.518-5.614Zm-.419 8.45c-.344.097-.788.121-1.12.121h-3.827a.406.406 0 0 1-.407-.403v-5.111c0-.223.182-.404.407-.404h3.828c.332 0 .775.025 1.119.11 1.476.377 1.945 1.728 1.945 2.849 0 1.12-.469 2.471-1.945 2.836v.002ZM101.467 23.81l-3.175-.877c-1.194-.317-2.56-.79-2.56-2.094 0-1.303 1.55-2.276 3.324-2.24 1.707.044 3.253.958 3.753 2.596a.408.408 0 0 0 .459.273l2.374-.408a.405.405 0 0 0 .322-.512c-.905-2.98-3.395-4.655-6.873-4.69-3.606-.024-6.473 1.741-6.473 5.125 0 3.093 2.376 4.03 3.95 4.48l4.58 1.34c1.342.402 1.968 1.047 1.968 2.022 0 1.62-1.771 2.521-3.668 2.521-2.025 0-3.73-1.056-4.347-2.932a.409.409 0 0 0-.448-.279l-2.306.348a.405.405 0 0 0-.338.483c.716 3.195 3.539 5.132 7.255 5.132 3.717 0 6.955-1.827 6.955-5.467 0-3.64-3.028-4.358-4.75-4.821h-.002ZM89.57 16.154h-2.173a.406.406 0 0 0-.407.403v13.738a.55.55 0 0 1-.559.553h-7.206a.55.55 0 0 1-.559-.554V16.557a.406.406 0 0 0-.407-.404h-2.172a.406.406 0 0 0-.407.404v13.89c0 .222.182.402.407.402h2.019a.551.551 0 0 1 .559.554v2.001c0 .223.182.404.406.404h7.512c.225 0 .407-.181.407-.404v-2a.55.55 0 0 1 .559-.554h2.019c.224 0 .407-.181.407-.404v-13.89a.406.406 0 0 0-.407-.403l.002.002ZM122.794 16.213h-2.142a.406.406 0 0 0-.407.403v6.573a.406.406 0 0 1-.407.403h-7.581a.405.405 0 0 1-.407-.403v-6.573a.406.406 0 0 0-.407-.403h-2.153a.405.405 0 0 0-.407.403v16.728c0 .222.182.403.407.403h2.153c.224 0 .407-.18.407-.403v-6.597c0-.222.182-.403.407-.403h7.581c.224 0 .407.18.407.403v6.597c0 .222.183.403.407.403h2.142c.224 0 .407-.18.407-.403V16.616a.406.406 0 0 0-.407-.403ZM138.172 17.925c2.982 0 4.834 1.619 5.56 4.22l2.22-.584c-1.006-3.479-3.693-5.704-7.78-5.704-5.289 0-8.246 3.722-8.246 9.121 0 5.4 2.957 9.121 8.246 9.121 4.087 0 6.774-2.225 7.78-5.703l-2.22-.584c-.724 2.602-2.578 4.22-5.56 4.22-3.95 0-5.962-2.858-5.938-7.055.024-4.196 1.988-7.055 5.938-7.055v.003ZM159.766 24.253h-9.301v-7.724h-2.184v17.514h2.184v-7.735h9.301v7.735h2.185V16.529h-2.185v7.724ZM171.518 16.486l3.088 10.466-6.176.003 3.088-10.469h-2.106L164.082 34h2.271l1.52-5.01h7.302l1.51 5.01h2.269l-5.346-17.514h-2.09ZM182.992 16.615h-2.183v17.512h2.183V16.615ZM197.806 16.629v13.683l-9.214-13.683h-2.209v17.513h2.209V20.448l9.214 13.694h2.21V16.63h-2.21Z",
    fill: "#fff"
  })));
};
...
var ExternalLink = __webpack_require__(143186);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DocSidebarItems(_ref){let{items}=_ref,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,DocSidebarItems_excluded);const visibleItems=(0,docsUtils/* useVisibleSidebarItems */.Y)(items,props.activePath);return/*#__PURE__*/(0,jsx_runtime.jsx)(DocSidebarItemsExpandedStateProvider,{children:visibleItems.map((item,index)=>/*#__PURE__*/(0,jsx_runtime.jsx)(DocSidebarItem,Object.assign({item:item,index:index},props),index))});}// Optimize sidebar at each "level"
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const ExpandButton_styles_module = ({"expandButton":"expandButton_k9J9","expandButtonIcon":"expandButtonIcon_zpMS"});
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Sidebar_styles_module = ({"docSidebarContainer":"docSidebarContainer_RSuS","docSidebarContainerHidden":"docSidebarContainerHidden_kI50","sidebarViewport":"sidebarViewport_pYEE"});
...
if(!hiddenSidebar&&(0,accessibilityUtils/* prefersReducedMotion */.O)()){setHiddenSidebar(true);}setHiddenSidebarContainer(value=>!value);},[setHiddenSidebarContainer,hiddenSidebar]);return/*#__PURE__*/(0,jsx_runtime.jsx)("aside",{className:(0,clsx_m/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.docs.docSidebarContainer,Sidebar_styles_module.docSidebarContainer,hiddenSidebarContainer&&Sidebar_styles_module.docSidebarContainerHidden),onTransitionEnd:e=>{if(!e.currentTarget.classList.contains(Sidebar_styles_module.docSidebarContainer)){return;}if(hiddenSidebarContainer){setHiddenSidebar(true);}},children:/*#__PURE__*/(0,jsx_runtime.jsx)(ResetOnSidebarChange,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx_m/* default */.A)(Sidebar_styles_module.sidebarViewport,hiddenSidebar&&Sidebar_styles_module.sidebarViewportHidden),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(DocSidebar,{sidebar:sidebar,path:pathname,onCollapse:toggleSidebar,isHidden:hiddenSidebar}),hiddenSidebar&&/*#__PURE__*/(0,jsx_runtime.jsx)(DocRootLayoutSidebarExpandButton,{toggleSidebar:toggleSidebar})]})})});}
;// ./src/theme/DocRoot/Layout/Main/styles.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const Main_styles_module = ({"docMainContainer":"docMainContainer_hjYf","docMainContainerEnhanced":"docMainContainerEnhanced_of6x","docItemWrapperEnhanced":"docItemWrapperEnhanced_s6pk"});
;// ./src/theme/DocRoot/Layout/Main/index.js
function DocRootLayoutMain(_ref){let{hiddenSidebarContainer,children}=_ref;const sidebar=(0,docsSidebar/* useDocsSidebar */.t)();return/*#__PURE__*/(0,jsx_runtime.jsx)("main",{className:(0,clsx_m/* default */.A)(Main_styles_module.docMainContainer,(hiddenSidebarContainer||!sidebar)&&Main_styles_module.docMainContainerEnhanced),children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx_m/* default */.A)('container padding-top--md padding-bottom--lg',Main_styles_module.docItemWrapper,hiddenSidebarContainer&&Main_styles_module.docItemWrapperEnhanced),children:children})});}
;// ./src/theme/DocRoot/Layout/styles.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const Layout_styles_module = ({"docRoot":"docRoot_cWv0","docsWrapper":"docsWrapper_bSxm"});
...
// Internal Components
function DocRootLayout(_ref){let{children}=_ref;const sidebar=(0,docsSidebar/* useDocsSidebar */.t)();const[hiddenSidebarContainer,setHiddenSidebarContainer]=(0,react.useState)(false);return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Layout_styles_module.docsWrapper,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(BackToTopButton,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(SharedStyling/* Section */.wn,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(SharedStyling/* Content */.UC,{className:"skeletonextrasmall docs",flexDirection:"row",children:[sidebar&&/*#__PURE__*/(0,jsx_runtime.jsx)(DocRootLayoutSidebar,{sidebar:sidebar.items,hiddenSidebarContainer:hiddenSidebarContainer,setHiddenSidebarContainer:setHiddenSidebarContainer}),/*#__PURE__*/(0,jsx_runtime.jsx)(DocRootLayoutMain,{hiddenSidebarContainer:hiddenSidebarContainer,children:children})]})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Footer/* default */.A,{})]});}
