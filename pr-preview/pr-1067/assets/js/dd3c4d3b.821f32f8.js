...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_01_tutorials_01_tutorial_simple_counter_mdx_dd3_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-01-tutorials-01-tutorial-simple-counter-mdx-dd3.json
const site_docs_chain_01_tutorials_01_tutorial_simple_counter_mdx_dd3_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/tutorials/docs-chain-tutorials-simple-counter","title":"Build a Counter App","description":"Build a Counter App | Tutorials | Push Chain Docs","source":"@site/docs/chain/01-tutorials/01-Tutorial-Simple-Counter.mdx","sourceDirName":"chain/01-tutorials","slug":"/chain/tutorials/tutorial-simple-counter","permalink":"/push-chain-website/pr-preview/pr-1067/docs/chain/tutorials/tutorial-simple-counter","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/01-tutorials/01-Tutorial-Simple-Counter.mdx","tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"id":"docs-chain-tutorials-simple-counter","title":"Build a Counter App","hide_title":false,"slug":"./tutorial-simple-counter","displayed_sidebar":"pushChainSidebar","sidebar_position":1,"image":"/assets/docs/previews/docs_chain_tutorials_simple_counter--build_a_counter_app.png"},"sidebar":"pushChainSidebar","previous":{"title":"Tutorials","permalink":"/push-chain-website/pr-preview/pr-1067/docs/chain/tutorials"},"next":{"title":"Build a Universal Counter App","permalink":"/push-chain-website/pr-preview/pr-1067/docs/chain/tutorials/tutorial-universal-counter"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
...
;// ./docs/chain/01-tutorials/01-Tutorial-Simple-Counter.mdx
