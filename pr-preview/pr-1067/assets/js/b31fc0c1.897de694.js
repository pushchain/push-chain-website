...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-nocheck
const Template=()=>{const isTablet=(0,useMediaQuery/* default */.A)(globals/* device */.jO.tablet);const featuresCard=[{text:'Webtwo ipsum unigo. Elgg skype woopra fleck ifttt imvu, hipmunk handango.'},{text:'Webtwo ipsum unigo. Elgg skype woopra fleck ifttt imvu, hipmunk handango.'},{text:'Webtwo ipsum unigo. Elgg skype woopra fleck ifttt imvu, hipmunk handango.'}];const StarIcon=()=>{return/*#__PURE__*/(0,jsx_runtime.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:"28",height:"29",viewBox:"0 0 28 29",fill:"none",children:/*#__PURE__*/(0,jsx_runtime.jsx)("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M15.3524 1.31893C14.8155 0.0899936 13.0473 0.103007 12.529 1.33972L10.7439 5.59859C9.57977 8.37604 7.3245 10.5676 4.49458 11.6714L0.970016 13.0461C-0.32334 13.5506 -0.323339 15.3593 0.970021 15.8637L4.52088 17.2487C7.33613 18.3468 9.58332 20.5217 10.7527 23.2801L12.5313 27.4753C13.0524 28.7044 14.8101 28.7175 15.3498 27.4962L17.2695 23.1523C18.4543 20.4715 20.6628 18.3617 23.4143 17.2823L27.0328 15.8626C28.3224 15.3567 28.3224 13.5532 27.0328 13.0473L23.4411 11.6382C20.6746 10.5528 18.4576 8.42604 17.2778 5.72569L15.3524 1.31893Z",fill:"white"})});};return/*#__PURE__*/(0,jsx_runtime.jsx)(TemplateWrapper,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(TemplateContent,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(ItemContainer,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(TextContainer,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ChainAlertBar/* default */.A,{text:"Push Chain Governance is live",backgroundColor:"transparent",textColor:"#FFF",borderColor:"#D42D2D",iconColor:"#FFF",showStarIcon:false,center:isTablet&&true}),/*#__PURE__*/(0,jsx_runtime.jsx)(TemplateImage,{src:(__webpack_require__(384705)/* ["default"] */ .A),alt:`Poker Image`}),/*#__PURE__*/(0,jsx_runtime.jsx)(MobileImageItem,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(TextSpan,{children:"Webtwo ipsum unigo. Elgg skype woopra fleck ifttt imvu, hipmunk handango empressr."}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{children:"Launch App"}),featuresCard.map(item=>/*#__PURE__*/(0,jsx_runtime.jsxs)(Features,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(StarIcon,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(FeaturesSpan,{children:item.text})]}))]}),/*#__PURE__*/(0,jsx_runtime.jsx)(DesktopImageItem,{})]})})});};/* harmony default export */ const Template_Template = (Template);const TemplateWrapper=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"Template__TemplateWrapper",componentId:"sc-1dlrt9t-0"})(["height:100vh;background:#000;@media (max-width:768px){min-height:100vh;height:auto;}"]);const TemplateContent=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"Template__TemplateContent",componentId:"sc-1dlrt9t-1"})(["margin:auto auto;height:100%;display:flex;align-items:center;@media (max-width:2560px){width:1400px;}@media (max-width:2000px){width:1200px;}@media (max-width:1548px){width:100%;padding:0 48px;}@media (max-width:768px){padding:0 24px;margin:24px auto;}@media (max-width:470px){padding:0 16px;}"]);const ItemContainer=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"Template__ItemContainer",componentId:"sc-1dlrt9t-2"})(["display:flex;flex-direction:row;align-items:center;gap:150px;width:100%;@media (max-width:768px){flex-direction:column;}"]);const TextContainer=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"Template__TextContainer",componentId:"sc-1dlrt9t-3"})(["display:flex;flex-direction:column;align-items:flex-start;"]);const TextSpan=styled_components_browser_esm/* default */.Ay.span.withConfig({displayName:"Template__TextSpan",componentId:"sc-1dlrt9t-4"})(["color:#fff;font-family:N27;font-size:20px;font-style:normal;font-weight:400;line-height:140%;@media (max-width:768px){margin-top:16px;}@media (max-width:470px){font-size:17px;}"]);const TemplateImage=styled_components_browser_esm/* default */.Ay.img.withConfig({displayName:"Template__TemplateImage",componentId:"sc-1dlrt9t-5"})(["width:300px;margin:24px 0;@media (max-width:768px){margin:24px auto;}"]);const Features=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"Template__Features",componentId:"sc-1dlrt9t-6"})(["display:flex;border-bottom:1px solid #fff;padding:24px 0;gap:24px;align-items:center;width:100%;"]);const FeaturesSpan=styled_components_browser_esm/* default */.Ay.span.withConfig({displayName:"Template__FeaturesSpan",componentId:"sc-1dlrt9t-7"})(["color:#fff;font-family:N27;font-size:18px;font-style:normal;font-weight:400;line-height:140%;@media (max-width:470px){font-size:15px;}"]);const Button=styled_components_browser_esm/* default */.Ay.button.withConfig({displayName:"Template__Button",componentId:"sc-1dlrt9t-8"})(["background:#d42d2d;width:100%;margin:48px 0 32px 0;height:58px;padding:16px 32px;justify-content:center;align-items:center;align-self:stretch;color:#fff;font-family:N27;font-size:18px;font-style:normal;font-weight:500;border-radius:16px;border:none;line-height:16px;cursor:pointer;"]);const DesktopImageItem=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"Template__DesktopImageItem",componentId:"sc-1dlrt9t-9"})(["height:700px;background:#202020;border-radius:32px;width:500px;display:block;@media (max-width:768px){display:none;}"]);const MobileImageItem=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"Template__MobileImageItem",componentId:"sc-1dlrt9t-10"})(["height:200px;background:#202020;border-radius:32px;width:100%;display:none;@media (max-width:768px){display:block;}"]);
