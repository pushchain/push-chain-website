"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[67371],{
...
var index_dom = __webpack_require__(296206);
...
function tokenizeCharacterReference(effects, ok, nok) {
  ...
  function value(code) {
    if (code === 59 && size) {
      ...
      if (
        test === asciiAlphanumeric &&
        !(0,index_dom/* decodeNamedCharacterReference */.s)(self.sliceSerialize(token))
      ) {
        return nok(code)
      }
...
function decode($0, $1, $2) {
  ...
  return (0,index_dom/* decodeNamedCharacterReference */.s)($2) || $0
}
...
function compiler(options) {
  ...
  function onexitcharacterreferencevalue(token) {
    ...
    if (type) {
      ...
      const result = (0,index_dom/* decodeNamedCharacterReference */.s)(data)
      value = result
    }
    const tail = this.stack.pop()
    tail.value += value
...
/* harmony export */   s: () => (/* binding */ decodeNamedCharacterReference)
/* harmony export */ });
/// <reference lib="dom" />
