...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      ...
      examples: {
        'Counter.sol': {
          absoluteFileURL: 'https://github.com/pushchain/push-chain-examples/blob/main/contracts/hello-world/src/Counter.sol',
          ctaTitle: 'View on GitHub',
          ctaURL: 'https://github.com/pushchain/push-chain-examples/blob/main/contracts/hello-world/'
        }
      }
