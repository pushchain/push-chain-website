...
}function loadClientSideLibraryPushProtocolUIWeb(constantName){return typeof window!=='undefined'?__webpack_require__(766441)[constantName]:Promise.resolve({});// Return an empty object or appropriate placeholder for SSR.
...
// Internal Components
// Internal Configs
const FooterItem=()=>{const{t}=(0,es/* useTranslation */.Bd)();const isMobile=(0,useMediaQuery/* default */.A)(globals/* device */.jO.tablet);const[open,setOpen]=react.useState(false);const openModal=()=>{setOpen(true);// document.body.style.overflow = "hidden";
