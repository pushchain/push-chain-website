"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[13382],{
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function MaybeLink(props){if(props.href){return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,Object.assign({},props));}return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:props.children});}function AuthorTitle(_ref){let{title}=_ref;return/*#__PURE__*/(0,jsx_runtime.jsx)("small",{className:Author_styles_module.authorTitle,title:title,children:title});}function AuthorName(_ref2){let{name,as}=_ref2;if(!as){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:Author_styles_module.authorName,children:name});}else{return/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* default */.A,{as:as,className:Author_styles_module.authorName,children:name});}}function AuthorBlogPostCount(_ref3){let{count}=_ref3;return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)(Author_styles_module.authorBlogPostCount),children:count});}// Note: in the future we might want to have multiple "BlogAuthor" components
