"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[2233],{
...
var esm_hmac = __webpack_require__(621454);
// EXTERNAL MODULE: ./node_modules/@noble/hashes/esm/utils.js + 1 modules
var esm_utils = __webpack_require__(968279);
;// ./node_modules/@walletconnect/utils/node_modules/viem/node_modules/@noble/curves/esm/utils.js
/**
...
function weierstrass_normFnElement(Fn, key) {
...
function weierstrassN(params, extraOpts = {}) {
    ...
    function pointToBytes(_c, point, isCompressed) {
        ...
        if (isCompressed) {
            ...
            return (0,esm_utils/* concatBytes */.Id)(pprefix(hasEvenY), bx);
        }
        else {
            return (0,esm_utils/* concatBytes */.Id)(Uint8Array.of(0x04), bx, Fp.toBytes(y));
        }
    }
    ...
    class Point {
        ...
        toHex(isCompressed = true) {
            return (0,esm_utils/* bytesToHex */.My)(this.toBytes(isCompressed));
        }
        toString() {
        ...
        static fromPrivateKey(privateKey) {
            return Point.BASE.multiply(weierstrass_normFnElement(Fn, privateKey));
        }
    }
...
function ecdh(Point, ecdhOpts = {}) {
    ...
    function isValidSecretKey(secretKey) {
        try {
            return !!weierstrass_normFnElement(Fn, secretKey);
        }
        catch (error) {
            return false;
        }
    ...
    function randomSecretKey(seed = randomBytes_(lengths.seed)) {
        return modular_mapHashToField(_abytes2(seed, lengths.seed, 'seed'), Fn.ORDER);
    }
    /**
    ...
    function getPublicKey(secretKey, isCompressed = true) {
        return Point.BASE.multiply(weierstrass_normFnElement(Fn, secretKey)).toBytes(isCompressed);
    }
    ...
    function getSharedSecret(secretKeyA, publicKeyB, isCompressed = true) {
        ...
        const s = weierstrass_normFnElement(Fn, secretKeyA);
    ...
    const utils = {
        ...
        normPrivateKeyToScalar: (key) => weierstrass_normFnElement(Fn, key),
...
function ecdsa(Point, hash, ecdsaOpts = {}) {
    ...
    const randomBytes = ecdsaOpts.randomBytes || esm_utils/* randomBytes */.po;
    const hmac = ecdsaOpts.hmac ||
        ((key, ...msgs) => (0,esm_hmac/* hmac */.w)(hash, key, (0,esm_utils/* concatBytes */.Id)(...msgs)));
    const { Fp, Fn } = Point;
    ...
    class Signature {
        ...
        static fromHex(hex, format) {
            return this.fromBytes((0,esm_utils/* hexToBytes */.aT)(hex), format);
        }
        ...
        toBytes(format = defaultSigOpts_format) {
            validateSigFormat(format);
            if (format === 'der')
                return (0,esm_utils/* hexToBytes */.aT)(DER.hexFromSig(this));
            const r = Fn.toBytes(this.r);
            const s = Fn.toBytes(this.s);
            if (format === 'recovered') {
                if (this.recovery == null)
                    throw new Error('recovery bit must be present');
                return (0,esm_utils/* concatBytes */.Id)(Uint8Array.of(this.recovery), r, s);
            }
            return (0,esm_utils/* concatBytes */.Id)(r, s);
        }
        toHex(format) {
            return (0,esm_utils/* bytesToHex */.My)(this.toBytes(format));
        }
        // TODO: remove
        assertValidity() { }
        ...
        toDERHex() {
            return (0,esm_utils/* bytesToHex */.My)(this.toBytes('der'));
        }
        toCompactRawBytes() {
            return this.toBytes('compact');
        }
        toCompactHex() {
            return (0,esm_utils/* bytesToHex */.My)(this.toBytes('compact'));
        }
    }
    ...
    function prepSig(message, privateKey, opts) {
        ...
        const d = weierstrass_normFnElement(Fn, privateKey); // validate secret key, convert to bigint
    ...
    function tryParsingSig(sg) {
        ...
        let sig = undefined;
        const isHex = typeof sg === 'string' || (0,esm_utils/* isBytes */.aY)(sg);
        const isObj = !isHex &&
            sg !== null &&
            typeof sg === 'object' &&
            typeof sg.r === 'bigint' &&
...
const secp256k1_0n = /* @__PURE__ */ (/* unused pure expression or super */ null && (BigInt(0)));
const secp256k1_1n = /* @__PURE__ */ (/* unused pure expression or super */ null && (BigInt(1)));
 ...
 * ```
 */
const secp256k1 = createCurve({ ...secp256k1_CURVE, Fp: Fpk1, lowS: true, endo: secp256k1_ENDO }, sha2/* sha256 */.sc);
...
const Pointk1 = /* @__PURE__ */ (/* unused pure expression or super */ null && ((() => secp256k1.Point)()));
