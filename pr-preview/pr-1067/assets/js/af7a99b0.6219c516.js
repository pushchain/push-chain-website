...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      ...
      children: ["Welcome to the first tutorial of building a truly universal smart contract. The smart contract we are going to build here is the popular ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "Counter app"
      }), ", that all Solidity developers are familiar with. This counter app, however, is going to be ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "Universal"
      }), "."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["We will first understand what we are building and why it is a unique (", (0,jsx_runtime.jsx)(_components.em, {
      ...
      children: ["A typical Solidity counter app allows you to increment a specific variable when a caller (", (0,jsx_runtime.jsx)(_components.strong, {
        children: "msg.sender"
      }), ") calls it."]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Different ", (0,jsx_runtime.jsx)(_components.code, {
          children: "uint256"
        }), " counter variables for different chains (e.g., ", (0,jsx_runtime.jsx)(_components.code, {
          children: "countETH"
        ...
        children: ["A check on the caller (", (0,jsx_runtime.jsx)(_components.strong, {
          children: "msg.sender"
        }), ") who invokes the ", (0,jsx_runtime.jsx)(_components.code, {
          children: "increment()"
        }), " function."]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Bob is an Ethereum user → Bob calls ", (0,jsx_runtime.jsx)(_components.code, {
          children: "increment()"
        }), " → ", (0,jsx_runtime.jsx)(_components.code, {
          children: "countETH"
        }), " variable is incremented."]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Dan is a Push Chain user → Dan calls ", (0,jsx_runtime.jsx)(_components.code, {
          children: "increment()"
        }), " → ", (0,jsx_runtime.jsx)(_components.code, {
          children: "countPC"
        }), " variable is incremented."]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        ...
        }), "\nYou’ll be able to build this cross-chain functionality ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "without"
        }), " using oracles, message passing systems, or third-party interoperability providers."]
      }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
        children: ["It’s all ", (0,jsx_runtime.jsx)(_components.strong, {
      ...
      children: ["The unique aspect of this smart contract is its ability to determine all imperative details of the user ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "( msg.sender )"
      ...
      children: ["This function plays the critical role of fetching and returning the information about the caller ( ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "msg.sender"
      }), " )."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      children: [(0,jsx_runtime.jsx)("summary", {
        ...
        children: [(0,jsx_runtime.jsxs)("li", {
          ...
          children: [(0,jsx_runtime.jsx)("strong", {
            ...
            children: "UniversalAccountId"
          }), " shall provide all information like ", (0,jsx_runtime.jsx)("em", {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["however, if ", (0,jsx_runtime.jsx)(_components.strong, {
          children: "isUEA is true,"
        }), " this indicates the user is a external chain user."]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["for such users the function checks the ", (0,jsx_runtime.jsx)(_components.strong, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          ...
          href: "https://donut.push.network/address/0x07E7Ca060A4b5BcDa61A6B701305ef0Ee29E1A3e?tab=contract",
          children: "0x07E7Ca060A4b5BcDa61A6B701305ef0Ee29E1A3e"
        })]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: [(0,jsx_runtime.jsx)(_components.strong, {
...
const GitHubRepoContainer=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"GitHubRepo__GitHubRepoContainer",componentId:"sc-102xx6v-0"})(["margin:24px 0;padding:0;"]);const RepoButton=styled_components_browser_esm/* default */.Ay.button.withConfig({displayName:"GitHubRepo__RepoButton",componentId:"sc-102xx6v-1"})(["display:flex;align-items:center;gap:12px;width:100%;padding:16px 20px;background:transparent;border:1px solid var(--ifm-color-emphasis-200);border-radius:8px;cursor:pointer;transition:all 0.2s ease;text-align:left;&:hover{border-color:var(--ifm-color-primary-unified);}&:active{transform:translateY(0);}@media ","{padding:14px 16px;gap:10px;}@media ","{padding:12px 14px;gap:8px;}"],globals/* device */.jO.tablet,globals/* device */.jO.mobileL);const GitHubIcon=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"GitHubRepo__GitHubIcon",componentId:"sc-102xx6v-2"})(["display:flex;align-items:center;justify-content:center;width:40px;height:40px;background:var(--ifm-color-black);border-radius:6px;color:var(--ifm-color-white);flex-shrink:0;@media ","{width:36px;height:36px;}@media ","{width:32px;height:32px;svg{width:16px;height:16px;}}"],globals/* device */.jO.tablet,globals/* device */.jO.mobileL);const RepoContent=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"GitHubRepo__RepoContent",componentId:"sc-102xx6v-3"})(["flex:1;min-width:0;"]);const RepoTitle=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"GitHubRepo__RepoTitle",componentId:"sc-102xx6v-4"})(["font-size:16px;font-weight:600;color:var(--ifm-color-content);margin-bottom:4px;word-break:break-word;@media ","{font-size:15px;}@media ","{font-size:14px;}"],globals/* device */.jO.tablet,globals/* device */.jO.mobileL);const RepoSubtext=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"GitHubRepo__RepoSubtext",componentId:"sc-102xx6v-5"})(["font-size:14px;color:var(--ifm-color-content-secondary);font-weight:400;@media ","{font-size:13px;}@media ","{font-size:12px;}"],globals/* device */.jO.tablet,globals/* device */.jO.mobileL);const ExternalLinkIcon=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"GitHubRepo__ExternalLinkIcon",componentId:"sc-102xx6v-6"})(["display:flex;align-items:center;justify-content:center;color:var(--ifm-color-content-secondary);flex-shrink:0;opacity:0.7;transition:opacity 0.2s ease;",":hover &{opacity:1;}@media ","{svg{width:14px;height:14px;}}"],RepoButton,globals/* device */.jO.mobileL);/* harmony default export */ const GitHubRepo_GitHubRepo = ((/* unused pure expression or super */ null && (GitHubRepo)));
