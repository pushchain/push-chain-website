"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[83930],{
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(text, id, _version, diag) {
  ...
  const { securityLevel, state: conf, layout } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  ...
  _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.insertTitle(
    svg,
    "statediagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_EDXVE4YY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, padding, CSS_DIAGRAM, conf?.useMaxWidth ?? true);
}, "draw");
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(item.description ?? "", (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()),
  ...
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(itemId, config),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeTextOrArray(newNode.description, config);
    }
...
var StateDB = class {
  ...
  docTranslator(parent, node, first) {
    ...
    if (doc.length > 0 && currentDoc.length > 0) {
      const newNode = {
        stmt: STMT_STATE,
        id: (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_3__/* .generateId */ .$C)(),
        type: "divider",
  ...
  addState(id, type = DEFAULT_STATE_TYPE, doc = void 0, descr = void 0, note = void 0, classes = void 0, styles = void 0, textStyles = void 0) {
    ...
    if (note) {
      ...
      doc2.note = note;
      doc2.note.text = _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(doc2.note.text, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
    }
    if (classes) {
  ...
  addRelationObjs(item1, item2, relationTitle = "") {
    ...
    this.currentDocument.relations.push({
      id1,
      id2,
      relationTitle: _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(relationTitle, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)())
    });
  }
  /**
  ...
  addRelation(item1, item2, title) {
    if (typeof item1 === "object" && typeof item2 === "object") {
      ...
      this.currentDocument.relations.push({
        id1,
        id2,
        relationTitle: title ? _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(title, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : void 0
      });
    }
  }
  addDescription(id, descr) {
    ...
    theState?.descriptions?.push(_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(_descr, (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()));
  }
  cleanupLabel(label) {
  ...
  getConfig() {
    return (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().state;
  }
};
