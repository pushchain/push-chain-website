"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[87082],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_04_ui_kit_101_customizations_section_mdx_cea_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-04-ui-kit-101-customizations-section-mdx-cea.json
const site_docs_chain_04_ui_kit_101_customizations_section_mdx_cea_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/ui-kit/docs-chain-ui-kit-customizations-section","title":"Customizations","description":"Customizations Section | UI Kit | Push Chain Docs","source":"@site/docs/chain/04-ui-kit/101-Customizations-Section.mdx","sourceDirName":"chain/04-ui-kit","slug":"/chain/ui-kit/customizations","permalink":"/push-chain-website/pr-preview/pr-1212/docs/chain/ui-kit/customizations","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/04-ui-kit/101-Customizations-Section.mdx","tags":[],"version":"current","sidebarPosition":101,"frontMatter":{"id":"docs-chain-ui-kit-customizations-section","title":"Customizations","hide_title":false,"slug":"./customizations","displayed_sidebar":"pushChainSidebar","sidebar_position":101,"image":"/assets/docs/previews/docs_chain_ui_kit__section--customizations.png"},"sidebar":"pushChainSidebar","previous":{"title":"Integrate Push Universal Wallet","permalink":"/push-chain-website/pr-preview/pr-1212/docs/chain/ui-kit/integrate-push-universal-wallet"},"next":{"title":"Push Universal Wallet Provider","permalink":"/push-chain-website/pr-preview/pr-1212/docs/chain/ui-kit/customizations/push-universal-wallet-provider"}}');
...
;// ./docs/chain/04-ui-kit/101-Customizations-Section.mdx
