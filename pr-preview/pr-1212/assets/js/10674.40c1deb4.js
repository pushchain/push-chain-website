"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[10674],{
...
var RequirementDB = class {
  constructor() {
    ...
    this.getConfig = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(() => (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)().requirement, "getConfig");
    this.clear();
...
var genColor = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)((options) => {
  const config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig */ .zj)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K2)(async function(text, id, _version, diag) {
  ...
  const { securityLevel, state: conf, layout, look } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .D7)();
  ...
  (0,_chunk_EDXVE4YY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, padding, "requirementDiagram", conf?.useMaxWidth ?? true);
}, "draw");
