"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[23180],{
...
/* harmony export */   metadata: () => (/* reexport default export from named module */ _site_docusaurus_docusaurus_plugin_content_blog_blog_site_blog_2020_11_06_epns_litepaper_index_md_69f_json__WEBPACK_IMPORTED_MODULE_0__),
/* harmony export */   toc: () => (/* binding */ toc)
/* harmony export */ });
/* harmony import */ var _site_docusaurus_docusaurus_plugin_content_blog_blog_site_blog_2020_11_06_epns_litepaper_index_md_69f_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(489076);
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.p, {
      ...
      children: ["The Ethereum Push Notification Service(EPNS) Litepaper can be also downloaded from ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["The document introduces a decentralized notifications protocol that enables wallet addresses to receive notifications in a platform-agnostic fashion from both decentralized and centralized carriers. ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.em, {
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.img, {
        ...
        src: (__webpack_require__(560210)/* ["default"] */ .A) + "",
        width: "1400",
        height: "1798"
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.p, {
      ...
      children: ["The protocol requires services that want to send notifications to their subscribers to activate themselves by staking $DAI, this ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "stake"
      }), " is then ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "lend"
      }), " out by protocol to AAVE DeFi protocol (at the time of writing) and starts generating ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "interest"
      }), " which is then distributed in a weighted proportion to all the subscribers that have opted in to receive notifications, the weightage rewards the early subscribers a bit more as they become the early adopters. ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["The protocol allows retrievable information (encrypted or plain) of each notification. IPFS stores most of the payload storage, but different storage (decentralized or centralized) are possible in the future for different payload types. This enables universal notification delivery to any crypto wallets, mobile apps, web browsers, dApps, or other platforms as long as they integrate the protocol. As a reward for the integration, the fees paid by the service for these notifications is shared between all wallets and infrastructure providers that enable the delivery of notifications to user wallets. ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["Notification is stored and treated like JSON payload which is transformed as per the rules of the different carriers when the notification reaches them. JSON Payload can differ with payload types which ensures the flexibility of the content, data, storage interpretation, and delivery. This helps in creating different rules and content interpretation of the notification (for example: carrying images, call to action, live videos, etc). ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
        href: "https://whitepaper.epns.io/protocol-specs-section/specifications/notification-payload-specs#notification-json-payload",
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.strong, {
          children: ["[", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
            children: "Read in Detail"
      ...
      children: ["The protocol allows users to be in direct control of what services they get notification from; it imposes rules on the services including spam protection for users, limiting their ability to add wallets as subscribers, etc. ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["The protocol governance is designed to incentivize continued adoption of the EPNS protocol. This is achieved by ensuring incentives for all the users involved by rewarding or encouraging them through incentives and penalty, their continued involvement is seen to be necessary for the growth and adoption of the protocol and to achieve the ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "vision of becoming a web3 notification standard"
      }), ". The EPNS user are categorized as ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "Service Providers, Subscribers, Wallet / Infra Services, and Governance Users"
      }), ", all of them are rewarded for their involvement and to ensure that they keep other parties in check for a healthy ecosystem according to the game theory described in the whitepaper. ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.li, {
        ...
        }), " There are some future features including decentralized video that is getting discussed and explored as well, you can read a brief synopsis of them over here. ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
      ...
      children: ["The native digital cryptographically - secured utility token of the EPNS protocol (", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.strong, {
        children: "$PUSH"
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.img, {
        alt: "Image of Ethereum Push Notification Service (EPNS) Litepaper",
        src: (__webpack_require__(394483)/* ["default"] */ .A) + "",
        width: "1400",
        height: "788"
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.p, {
      ...
      children: ["Ethereum Push Notification Service ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
...
module.exports = /*#__PURE__*/JSON.parse('{"permalink":"/push-chain-website/pr-preview/pr-1150/blog/epns-litepaper","source":"@site/blog/2020-11-06-epns-litepaper/index.md","title":"Ethereum Push Notification Service (EPNS) Litepaper","description":"Ethereum Push Notification Service (EPNS) Litepaper","date":"2020-11-06T00:00:00.000Z","tags":[{"inline":true,"label":"Lite Paper","permalink":"/push-chain-website/pr-preview/pr-1150/blog/tags/lite-paper"},{"inline":true,"label":"Cryptocurrency","permalink":"/push-chain-website/pr-preview/pr-1150/blog/tags/cryptocurrency"},{"inline":true,"label":"Defi","permalink":"/push-chain-website/pr-preview/pr-1150/blog/tags/defi"},{"inline":true,"label":"Ethereum","permalink":"/push-chain-website/pr-preview/pr-1150/blog/tags/ethereum"},{"inline":true,"label":"Blog","permalink":"/push-chain-website/pr-preview/pr-1150/blog/tags/blog"}],"readingTime":5.81,"hasTruncateMarker":true,"authors":[{"name":"Push Chain","url":"https://x.com/PushChain","page":{"permalink":"/push-chain-website/pr-preview/pr-1150/blog/authors/push"},"imageURL":"/push-chain-website/pr-preview/pr-1150/assets/blog/authors/authorpush.png","key":"push"}],"frontMatter":{"slug":"epns-litepaper","title":"Ethereum Push Notification Service (EPNS) Litepaper","description":"Ethereum Push Notification Service (EPNS) Litepaper","authors":["push"],"image":"./cover-image.webp","text":"The Ethereum Push Notification Service(EPNS) Litepaper can be also downloaded from here. The content of the Litepaper is included in the article below.","tags":["Lite Paper","Cryptocurrency","Defi","Ethereum","Blog"]},"unlisted":false,"prevItem":{"title":"Notify Decentralized Prediction Markets (DPM) with EPNS","permalink":"/push-chain-website/pr-preview/pr-1150/blog/notify-decentralized-prediction-markets"},"nextItem":{"title":"DeFi Forensics🕵️‍️- HARVEST Finance","permalink":"/push-chain-website/pr-preview/pr-1150/blog/defi-forensics-harvest-finance"}}');
