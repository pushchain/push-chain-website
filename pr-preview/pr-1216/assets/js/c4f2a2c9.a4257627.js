"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[1247],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_104_ui_kit_section_mdx_c4f_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-104-ui-kit-section-mdx-c4f.json
const site_docs_chain_104_ui_kit_section_mdx_c4f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/docs-chain-ui-kit-section","title":"UI Kit","description":"UI Kit Section | Push Chain Docs","source":"@site/docs/chain/104-UI-Kit-Section.mdx","sourceDirName":"chain","slug":"/chain/ui-kit","permalink":"/push-chain-website/pr-preview/pr-1216/docs/chain/ui-kit","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/104-UI-Kit-Section.mdx","tags":[],"version":"current","sidebarPosition":103,"frontMatter":{"id":"docs-chain-ui-kit-section","title":"UI Kit","hide_title":false,"slug":"./ui-kit","displayed_sidebar":"pushChainSidebar","sidebar_position":103,"image":"/assets/docs/previews/docs_chain__section--ui_kit.png"},"sidebar":"pushChainSidebar","previous":{"title":"Upgrade Universal Account","permalink":"/push-chain-website/pr-preview/pr-1216/docs/chain/build/advanced/upgrade-universal-account"},"next":{"title":"Integrate Push Universal Wallet","permalink":"/push-chain-website/pr-preview/pr-1216/docs/chain/ui-kit/integrate-push-universal-wallet"}}');
...
;// ./docs/chain/104-UI-Kit-Section.mdx
...
const contentTitle = 'UI Kit Section';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      children: (0,jsx_runtime.jsx)("title", {
        children: "UI Kit Section | Push Chain Docs"
      })
    }), "\n", "\n", (0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "ui-kit-section",
        children: "UI Kit Section"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "UI Kit from Push Chain allows you to seamlessly make your app compatible with all layer 1s and l2s instantly. It abstracts away the wallet connection logic, no matter from which chain you connect app your from."
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Integration takes less than 5 minutes and is plug and play for use by any ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "React based app"
      }), ", no matter from which chain you connect your app from."]
