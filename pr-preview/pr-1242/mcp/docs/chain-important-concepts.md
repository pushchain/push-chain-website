...
> **Deep dives and conceptual guides** live in our [Knowledge Base](/push-chain-website/pr-preview/pr-1242/knowledge/).
...
-   **PRC-20 → foreign tokens, mirrored inward**  
    ...
    Push Chain creates one PRC-20 per source token, per origin chain. See the [Address Book](/push-chain-website/pr-preview/pr-1242/docs/chain/setup/smart-contract-address-book/) for every PRC-20 and its source token.
...
-   Setup your [Environment and Tooling](/push-chain-website/pr-preview/pr-1242/docs/chain/setup/)
-   See SDK reference in [Build](/push-chain-website/pr-preview/pr-1242/docs/chain/build/)
-   Try your first transaction in [Send Transaction](/push-chain-website/pr-preview/pr-1242/docs/chain/build/send-universal-transaction/)
-   Integrate and abstract implementation and UI via [UI Kit](/push-chain-website/pr-preview/pr-1242/docs/chain/ui-kit/)
-   Follow a full walkthrough in [Tutorials](/push-chain-website/pr-preview/pr-1242/docs/chain/tutorials/)
