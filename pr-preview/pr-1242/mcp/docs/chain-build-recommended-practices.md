...
See [Token Types on Push Chain](/push-chain-website/pr-preview/pr-1242/docs/chain/important-concepts/#token-types-on-push-chain) for the distinction. Two habits will save you most of the debugging:
...
-   Create [Universal Signer](/push-chain-website/pr-preview/pr-1242/docs/chain/build/create-universal-signer/) from existing signer
-   Abstract away creation of the Universal Signer using [UI Kit](/push-chain-website/pr-preview/pr-1242/docs/chain/ui-kit/)
-   Revist [Important Concepts](/push-chain-website/pr-preview/pr-1242/docs/chain/important-concepts/)
