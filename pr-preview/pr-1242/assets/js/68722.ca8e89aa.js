...
let W3mInputToken = class W3mInputToken extends lit/* LitElement */.WF {
    ...
    onInputChange(event) {
        SendController/* SendController */.R.setTokenAmount(String(event.detail));
    }
    onMaxClick() {
        if (this.token) {
            ...
            if (!this.token.address && this.gasPrice) {
                ...
                SendController/* SendController */.R.setTokenAmount(maxAfterGas.gt(0) ? maxAfterGas.toFixed(decimals, 0) : '0');
            }
            else {
                SendController/* SendController */.R.setTokenAmount(maxValue.toFixed(decimals, 0));
            }
        }
    }
};
...
let W3mWalletSendView = class W3mWalletSendView extends lit/* LitElement */.WF {
    constructor() {
        ...
        this.gasFee = SwapController/* SwapController */.GN.state.gasFee;
        ...
        this.unsubscribe.push(...[
            ...
            SwapController/* SwapController */.GN.subscribeKey('gasFee', val => {
                this.gasFee = val;
            })
        ]);
    }
    ...
    async fetchNetworkPrice() {
        ...
        await SwapController/* SwapController */.GN.getInitialGasPrice();
    }
    onButtonClick() {
    ...
    getMessage() {
        ...
        if (NumberUtil/* NumberUtil */.S.bigNumber(this.sendTokenAmount).gt(this.token.quantity.numeric)) {
            return SEND_BUTTON_MESSAGE.INSUFFICIENT_FUNDS;
        }
        if (!this.receiverAddress) {
            return SEND_BUTTON_MESSAGE.ADD_ADDRESS;
        }
        if (!CoreHelperUtil/* CoreHelperUtil */.w.isAddress(this.receiverAddress, ChainController/* ChainController */.W.state.activeChain)) {
    ...
    async handleSendParameters() {
        ...
        try {
            ...
            SendController/* SendController */.R.setTokenAmount(String(amount));
      ...
      <wui-flex gap="2" flexDirection="column" .padding=${['0', '2', '0', '2']}>
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            ...
            ? esm_exports/* UiHelperUtil */.Zv.roundNumber(Number(this.sendTokenAmount), 6, 5)
