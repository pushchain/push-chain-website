"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[70022],{
...
// UNUSED EXPORTS: Close, Description, Dialog, DialogClose, DialogContent, DialogDescription, DialogOverlay, DialogPortal, DialogTitle, DialogTrigger, Title, Trigger, WarningProvider, createDialogScope
...
var react_dom = __webpack_require__(440961);
...
function useEscapeKeydown(onEscapeKeyDownProp, ownerDocument = globalThis?.document) {
  const onEscapeKeyDown = dist_useCallbackRef(onEscapeKeyDownProp);
  react.useEffect(() => {
...
function react_use_callback_ref_dist_useCallbackRef(callback) {
  const callbackRef = react.useRef(callback);
  react.useEffect(() => {
    callbackRef.current = callback;
  });
...
var FocusScope = react.forwardRef((props, forwardedRef) => {
  ...
  const onMountAutoFocus = react_use_callback_ref_dist_useCallbackRef(onMountAutoFocusProp);
  const onUnmountAutoFocus = react_use_callback_ref_dist_useCallbackRef(onUnmountAutoFocusProp);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(dist_Primitive.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var react_primitive_dist_NODES = [
  "a",
  "button",
  "div",
  "form",
...
var react_primitive_dist_Primitive = react_primitive_dist_NODES.reduce((primitive, node) => {
  const Slot = createSlot(`Primitive.${node}`);
  const Node = react.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot : node;
...
function react_primitive_dist_dispatchDiscreteCustomEvent(target, event) {
  if (target) ReactDOM.flushSync(() => target.dispatchEvent(event));
}
var _radix_ui_react_primitive_dist_Root = (/* unused pure expression or super */ null && (react_primitive_dist_Primitive));
...
var Portal = react.forwardRef((props, forwardedRef) => {
  ...
  return container ? react_dom.createPortal(/* @__PURE__ */ (0,jsx_runtime.jsx)(react_primitive_dist_Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var _radix_ui_react_primitive_dist_NODES = [
  "a",
  "button",
  "div",
  "form",
...
var _radix_ui_react_primitive_dist_Primitive = _radix_ui_react_primitive_dist_NODES.reduce((primitive, node) => {
  const Slot = createSlot(`Primitive.${node}`);
  const Node = react.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot : node;
...
function _radix_ui_react_primitive_dist_dispatchDiscreteCustomEvent(target, event) {
  if (target) ReactDOM.flushSync(() => target.dispatchEvent(event));
}
var node_modules_radix_ui_react_primitive_dist_Root = (/* unused pure expression or super */ null && (_radix_ui_react_primitive_dist_Primitive));
...
var DialogTrigger = react.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      _radix_ui_react_primitive_dist_Primitive.button,
      {
        type: "button",
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: react.Children.map(children, (child) => /* @__PURE__ */ (0,jsx_runtime.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlay = react.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? /* @__PURE__ */ (0,jsx_runtime.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(DialogOverlayImpl, { ...overlayProps, ref: forwardedRef }) }) : null;
  }
);
...
var DialogOverlayImpl = react.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Combination, { as: dist_Slot, allowPinchZoom: true, shards: [context.contentRef], children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        _radix_ui_react_primitive_dist_Primitive.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
          ref: forwardedRef,
...
var DialogContent = react.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? /* @__PURE__ */ (0,jsx_runtime.jsx)(DialogContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ (0,jsx_runtime.jsx)(DialogContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var DialogTitle = react.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(_radix_ui_react_primitive_dist_Primitive.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
...
var DialogDescription = react.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(_radix_ui_react_primitive_dist_Primitive.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
