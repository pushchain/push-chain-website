(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[85005],{
...
const SnackbarInstance = ({ autoExpand, message, menuItems, }) => {
    const [hidden, setHidden] = hooks_module_d(true);
    const [expanded, setExpanded] = hooks_module_d(autoExpand !== null && autoExpand !== void 0 ? autoExpand : false);
    hooks_module_y(() => {
        const timers = [
            window.setTimeout(() => {
                setHidden(false);
