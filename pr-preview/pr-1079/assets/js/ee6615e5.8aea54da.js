...
// @ts-nocheck
const ChainKnowledgeBaseGridPartners=()=>{const isMobile=(0,useMediaQuery/* default */.A)(globals/* device */.jO.mobileL);const isTablet=(0,useMediaQuery/* default */.A)(globals/* device */.jO.tablet);const gridRows=(0,CreateGridRows/* createGridRows */.y)(ChainKnowledgeBasePartners);console.log(gridRows,'grid grid',ChainKnowledgeBasePartners);return/*#__PURE__*/(0,jsx_runtime.jsxs)(ChainKnowledgeBaseGridWrapper,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(SharedStyling/* ItemV */.y8,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(SharedStyling.H2,{fontSize:isMobile?'32px':'40px',fontWeight:"500",fontFamily:"N27",lineHeight:isMobile?'100%':'140%',letterSpacing:"-0.8px",textAlign:"center",children:"Hey! Meet our Partners"})}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ChainKnowledgeGridWrapper,{children:[!isTablet&&(gridRows===null||gridRows===void 0?void 0:gridRows.map((row,rowIndex)=>/*#__PURE__*/(0,jsx_runtime.jsx)(ChainKnowledgeGrid,{itemsInRow:row.length,children:row.map((item,index)=>/*#__PURE__*/(0,jsx_runtime.jsx)(ChannelKnowledgeBaseComponentItem/* default */.A,{item:item,index:index}))},rowIndex))),/*#__PURE__*/(0,jsx_runtime.jsx)(ChainKnowledgeGrid,{children:isTablet&&(ChainKnowledgeBasePartners===null||ChainKnowledgeBasePartners===void 0?void 0:ChainKnowledgeBasePartners.map((item,index)=>/*#__PURE__*/(0,jsx_runtime.jsx)(ChannelKnowledgeBaseComponentItem/* default */.A,{item:item,index:index})))})]})]});};/* harmony default export */ const ChainKnowledgeBasePartnersGrid = (ChainKnowledgeBaseGridPartners);const ChainKnowledgeBaseGridWrapper=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"ChainKnowledgeBasePartnersGrid__ChainKnowledgeBaseGridWrapper",componentId:"sc-j718i0-0"})(["margin:200px auto 0 auto;@media ","{margin:153px auto 0 auto;}"],globals/* device */.jO.mobileL);const ChainKnowledgeGridWrapper=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"ChainKnowledgeBasePartnersGrid__ChainKnowledgeGridWrapper",componentId:"sc-j718i0-1"})(["display:flex;flex-direction:column;gap:24px;margin:48px 0 0 0;"]);const ChainKnowledgeGrid=styled_components_browser_esm/* default */.Ay.div.withConfig({displayName:"ChainKnowledgeBasePartnersGrid__ChainKnowledgeGrid",componentId:"sc-j718i0-2"})(["display:grid;grid-template-columns:",";gap:24px;width:100%;justify-content:center;@media ","{grid-template-columns:repeat(2,1fr);}@media ","{grid-template-columns:1fr;}"],_ref=>{let{itemsInRow}=_ref;return itemsInRow===3?'repeat(3, 1fr)':'repeat(2, 1fr)';},globals/* device */.jO.tablet,globals/* device */.jO.mobileL);
;// ./src/components/Chain/ChainKnowledgeBasePartners/ChainKnowledgeBasePartners.tsx
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-nocheck
const ChainKnowledgeBasePartners_ChainKnowledgeBasePartners=()=>{return/*#__PURE__*/(0,jsx_runtime.jsx)(ChainWrapper,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(ChainInnerWrapper,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ChainKnowledgeBasePartnersGrid,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(ChainBottomComponent/* default */.A,{})]})});};/* harmony default export */ const Chain_ChainKnowledgeBasePartners_ChainKnowledgeBasePartners = (ChainKnowledgeBasePartners_ChainKnowledgeBasePartners);const ChainWrapper=(0,styled_components_browser_esm/* default */.Ay)(SharedStyling/* ItemV */.y8).withConfig({displayName:"ChainKnowledgeBasePartners__ChainWrapper",componentId:"sc-ymkh5j-0"})(["width:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;background:#e8eff8;font-family:N27,sans-serif;"]);const ChainInnerWrapper=(0,styled_components_browser_esm/* default */.Ay)(SharedStyling/* ItemV */.y8).withConfig({displayName:"ChainKnowledgeBasePartners__ChainInnerWrapper",componentId:"sc-ymkh5j-1"})(["width:1200px;margin:0 auto;@media ","{width:1400px;}@media ","{width:1200px;}@media (max-width:1248px){width:100%;padding:0 24px;}@media ","{padding:0 24px;}@media ","{padding:0 16px;}"],globals/* device */.jO.desktopL,globals/* device */.jO.desktop,globals/* device */.jO.tablet,globals/* device */.jO.mobileL);
