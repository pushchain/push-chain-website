...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   JW: () => (/* binding */ tt),
/* harmony export */   XX: () => (/* binding */ et),
/* harmony export */   c0: () => (/* binding */ N),
/* harmony export */   qy: () => (/* binding */ Y)
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AH: () => (/* binding */ p),
/* harmony export */   Rf: () => (/* binding */ d),
/* harmony export */   sk: () => (/* binding */ y)
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   WF: () => (/* binding */ n)
/* harmony export */ });
/* harmony import */ var _lit_reactive_element_2_0_4_node_modules_lit_reactive_element_reactive_element_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(394687);
/* harmony import */ var _lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(76058);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class n extends _lit_reactive_element_2_0_4_node_modules_lit_reactive_element_reactive_element_mjs__WEBPACK_IMPORTED_MODULE_0__/* .ReactiveElement */ .mN {
  constructor() {
  ...
  update(e) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = (0,_lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__/* .render */ .XX)(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
  ...
  render() {
    return _lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__/* .noChange */ .c0;
  }
}
var o;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ec: () => (/* binding */ y),
/* harmony export */   W3: () => (/* binding */ d),
/* harmony export */   mN: () => (/* binding */ c)
/* harmony export */ });
/* harmony import */ var _css_tag_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(111893);
...
class c extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const i of s) e.unshift((0,_css_tag_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getCompatibleStyle */ .sk)(i));
    } else t !== void 0 && e.push((0,_css_tag_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getCompatibleStyle */ .sk)(t));
    return e;
  }
  static _$Eu(t, e) {
    const s = e.attribute;
  ...
  createRenderRoot() {
    ...
    return (0,_css_tag_mjs__WEBPACK_IMPORTED_MODULE_0__/* .adoptStyles */ .Rf)(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t, e;
...
/* harmony import */ var _reactive_element_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(394687);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const b = { attribute: !0, type: String, converter: _reactive_element_mjs__WEBPACK_IMPORTED_MODULE_0__/* .defaultConverter */ .W3, reflect: !1, hasChanged: _reactive_element_mjs__WEBPACK_IMPORTED_MODULE_0__/* .notEqual */ .Ec }, w = (e = b, t, r) => {
...
t.weightsMap = /* @__PURE__ */ new Map([
  [
    "thin",
    (0,_node_modules_pnpm_lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__/* .svg */ .JW)`<path d="M220,128a4,4,0,0,1-4,4H49.66l65.17,65.17a4,4,0,0,1-5.66,5.66l-72-72a4,4,0,0,1,0-5.66l72-72a4,4,0,0,1,5.66,5.66L49.66,124H216A4,4,0,0,1,220,128Z"/>`
  ],
  [
    "light",
    (0,_node_modules_pnpm_lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__/* .svg */ .JW)`<path d="M222,128a6,6,0,0,1-6,6H54.49l61.75,61.76a6,6,0,1,1-8.48,8.48l-72-72a6,6,0,0,1,0-8.48l72-72a6,6,0,0,1,8.48,8.48L54.49,122H216A6,6,0,0,1,222,128Z"/>`
  ],
  [
    "regular",
    (0,_node_modules_pnpm_lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__/* .svg */ .JW)`<path d="M224,128a8,8,0,0,1-8,8H59.31l58.35,58.34a8,8,0,0,1-11.32,11.32l-72-72a8,8,0,0,1,0-11.32l72-72a8,8,0,0,1,11.32,11.32L59.31,120H216A8,8,0,0,1,224,128Z"/>`
  ],
  [
    "bold",
    (0,_node_modules_pnpm_lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__/* .svg */ .JW)`<path d="M228,128a12,12,0,0,1-12,12H69l51.52,51.51a12,12,0,0,1-17,17l-72-72a12,12,0,0,1,0-17l72-72a12,12,0,0,1,17,17L69,116H216A12,12,0,0,1,228,128Z"/>`
  ],
  [
    "fill",
    (0,_node_modules_pnpm_lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__/* .svg */ .JW)`<path d="M224,128a8,8,0,0,1-8,8H120v64a8,8,0,0,1-13.66,5.66l-72-72a8,8,0,0,1,0-11.32l72-72A8,8,0,0,1,120,56v64h96A8,8,0,0,1,224,128Z"/>`
  ],
  [
    "duotone",
    (0,_node_modules_pnpm_lit_html_3_1_4_node_modules_lit_html_lit_html_mjs__WEBPACK_IMPORTED_MODULE_1__/* .svg */ .JW)`<path d="M112,56V200L40,128Z" opacity="0.2"/><path d="M216,120H120V56a8,8,0,0,0-13.66-5.66l-72,72a8,8,0,0,0,0,11.32l72,72A8,8,0,0,0,120,200V136h96a8,8,0,0,0,0-16ZM104,180.69,51.31,128,104,75.31Z"/>`
  ]
]);
...
t = l([
  (0,_node_modules_pnpm_lit_reactive_element_2_0_4_node_modules_lit_reactive_element_decorators_custom_element_mjs__WEBPACK_IMPORTED_MODULE_3__/* .customElement */ .E)("ph-arrow-left")
], t);
