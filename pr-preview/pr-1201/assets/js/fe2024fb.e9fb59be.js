"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[1640],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_101_advanced_section_mdx_fe2_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-101-advanced-section-mdx-fe2.json
const site_docs_chain_03_build_101_advanced_section_mdx_fe2_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-advanced-section","title":"Advanced","description":"Advanced Section | Build | Push Chain Docs","source":"@site/docs/chain/03-build/101-Advanced-Section.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/advanced","permalink":"/push-chain-website/pr-preview/pr-1201/docs/chain/build/advanced","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/101-Advanced-Section.mdx","tags":[],"version":"current","sidebarPosition":101,"frontMatter":{"id":"docs-chain-build-advanced-section","title":"Advanced","hide_title":false,"slug":"./advanced","displayed_sidebar":"pushChainSidebar","sidebar_position":101,"image":"/assets/docs/previews/docs_chain_build__section--advanced.png"},"sidebar":"pushChainSidebar","previous":{"title":"Contract Helpers","permalink":"/push-chain-website/pr-preview/pr-1201/docs/chain/build/contract-helpers"},"next":{"title":"Custom Universal Signer","permalink":"/push-chain-website/pr-preview/pr-1201/docs/chain/build/advanced/custom-universal-signer"}}');
...
;// ./docs/chain/03-build/101-Advanced-Section.mdx
