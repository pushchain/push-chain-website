...
Progress hook follows the same structure as [Send Universal Transaction - Progress Hook](/push-chain-website/pr-preview/pr-1243/docs/chain/build/send-universal-transaction/#progress-hook-type-and-response). |
...
For the full response shape, see [Send Universal Transaction - TxResponse object](/push-chain-website/pr-preview/pr-1243/docs/chain/build/send-universal-transaction/#returns-tx-response).
...
-   Learn about signing messages with [Sign Universal Message](/push-chain-website/pr-preview/pr-1243/docs/chain/build/sign-universal-message/)
-   Explore helper functions in [Utility Functions](/push-chain-website/pr-preview/pr-1243/docs/chain/build/utility-functions/)
-   Build rich UIs with transaction tracking using the [UI Kit](/push-chain-website/pr-preview/pr-1243/docs/chain/ui-kit/)
-   Read blockchain state with [Reading Blockchain State](/push-chain-website/pr-preview/pr-1243/docs/chain/build/reading-blockchain-state/)
