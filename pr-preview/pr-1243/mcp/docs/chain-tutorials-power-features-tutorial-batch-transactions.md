...
-   `Counter.sol` from [Simple Counter Tutorial](/push-chain-website/pr-preview/pr-1243/docs/chain/tutorials/basics/tutorial-simple-counter/) → to increment the counter.
-   `ERC20.sol` from [Mint Universal ERC-20 Tutorial](/push-chain-website/pr-preview/pr-1243/docs/chain/tutorials/basics/tutorial-mint-erc-20-tokens/) → to mint $UNICORN token.
...
-   [Build a Counter App](/push-chain-website/pr-preview/pr-1243/docs/chain/tutorials/basics/tutorial-simple-counter/)
-   [Mint Universal ERC-20 Token](/push-chain-website/pr-preview/pr-1243/docs/chain/tutorials/basics/tutorial-mint-erc-20-tokens/)
...
Check out the next tutorial to learn how to [derive Universal Executor Accounts](/push-chain-website/pr-preview/pr-1243/docs/chain/tutorials/power-features/tutorial-derive-universal-executor-account/).
