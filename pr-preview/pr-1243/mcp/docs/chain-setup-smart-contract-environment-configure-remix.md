...
> If you haven’t yet, follow [Wallet Setup](/push-chain-website/pr-preview/pr-1243/docs/chain/setup/tooling/wallet-setup/) to add Push Chain as a custom network in your wallet.
...
-   Deploy from the console with [Foundry](/push-chain-website/pr-preview/pr-1243/docs/chain/setup/smart-contract-environment/configure-foundry/)
-   Script deployments with [Hardhat](/push-chain-website/pr-preview/pr-1243/docs/chain/setup/smart-contract-environment/configure-hardhat/)
