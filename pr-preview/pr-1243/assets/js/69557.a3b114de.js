(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[69557],{
...
/* harmony export */ });
/* harmony import */ var _chunk_WU5MYG2G_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(970594);
/* harmony import */ var _chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(607188);
/* harmony import */ var _chunk_4BX2VUAB_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(225871);
/* harmony import */ var _chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(762447);
/* harmony import */ var _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(573706);
...
var DEFAULT_ARCHITECTURE_CONFIG = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .defaultConfig_default */ .UI.architecture;
var ArchitectureDB = class {
  ...
  getConfig() {
    return (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .cleanAndMerge */ .$t)({
      ...DEFAULT_ARCHITECTURE_CONFIG,
      ...(0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)().architecture
    });
  }
...
var architectureIcons = {
  ...
  icons: {
    ...
    unknown: _chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__/* .unknownIcon */ .Gc,
    blank: {
      body: wrapIcon("")
    }
  }
  ...
  await Promise.all(
    cy.edges().map(async (edge) => {
      ...
      if (edge[0]._private.rscratch) {
        ...
        g.insert("path").attr("d", `M ${startX},${startY} L ${midX},${midY} L${endX},${endY} `).attr("class", "edge").attr("id", `${diagramId}-${(0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getEdgeId */ .rY)(source, target, { prefix: "L" })}`);
        if (sourceArrow) {
        ...
        if (label) {
          ...
          await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__/* .createText */ .GZ)(
            textElem,
            label,
            {
              useHtmlLabels: false,
            ...
            (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()
          );
    ...
    cy.nodes().map(async (node) => {
      ...
      if (data.type === "group") {
        ...
        if (data.icon) {
          ...
          bkgElem.html(
            `<g>${await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getIconSVG */ .WY)(data.icon, { height: groupIconSize, width: groupIconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
          );
          bkgElem.attr(
            "transform",
...
var drawServices = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(db, elem, services, diagramId) {
  const config = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  for (const service of services) {
    ...
    if (service.icon) {
      bkgElem.html(
        `<g>${await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getIconSVG */ .WY)(service.icon, { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
    } else if (service.iconText) {
      bkgElem.html(
        `<g>${await (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getIconSVG */ .WY)("blank", { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
      const textElemContainer = bkgElem.append("g");
      const fo = textElemContainer.append("foreignObject").attr("width", iconSize).attr("height", iconSize);
      const divElem = fo.append("div").attr("class", "node-icon-text").attr("style", `height: ${iconSize}px;`).append("div").html((0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(service.iconText, config));
...
// src/diagrams/architecture/architectureRenderer.ts
(0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__/* .registerIconPacks */ .pC)([
  {
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async (text, id, _version, diagObj) => {
  ...
  positionNodes(db, cy);
  (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setupGraphViewbox */ .ot)(void 0, svg, db.getConfigField("padding"), db.getConfigField("useMaxWidth"));
}, "draw");
var renderer = { draw };
