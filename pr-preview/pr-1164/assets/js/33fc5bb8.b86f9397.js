...
/* harmony import */ var react_icons_bs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(796710);
/* harmony import */ var _site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(61530);
/* harmony import */ var _site_src_hooks_useMediaQuery__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(452005);
/* harmony import */ var _site_src_api_GetTwitterMetrics__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(976170);
...
// @ts-nocheck
//
const LikeAndRetweetItem=_ref=>{let{twitterId,text}=_ref;const isMobile=(0,_site_src_hooks_useMediaQuery__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)(_site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__/* .device */ .jO.tablet);const{data:twitterData}=(0,_site_src_api_GetTwitterMetrics__WEBPACK_IMPORTED_MODULE_6__/* .useTweetMetrics */ .k)(twitterId);if(!twitterData)return null;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(ShareRow,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(ResponsiveH2,{weight:"500",spacing:"-0.02em",lineHeight:"110%",color:"#00000",children:text}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_site_src_css_SharedStyling__WEBPACK_IMPORTED_MODULE_7__/* .ItemH */ .Oj,{justifyContent:"flex-end",flexWrap:"nowrap",gap:"8px",margin:isMobile&&'20px 0 0 0',children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(LikeButton,{title:"Developer Docs",self:isMobile?'stretch':'self',href:"https://x.com/PushChain/status/"+twitterId,target:"_blank",rel:"noopener noreferrer",title:"Like this post",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(react_icons_bs__WEBPACK_IMPORTED_MODULE_3__.BsHeart,{size:22,color:"var(--ifm-color-primary-text)",style:{marginRight:'10px'}}),(0,_site_src_utils_FormatTwitterCount__WEBPACK_IMPORTED_MODULE_8__/* .formatTwitterCount */ .Q)(twitterData===null||twitterData===void 0?void 0:twitterData.like_count)||'']}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(RetweetButton,{title:"Developer Docs",href:"https://twitter.com/intent/retweet?tweet_id="+twitterId,target:"_blank",rel:"noopener noreferrer",title:"Retweet this post",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(react_icons_bs__WEBPACK_IMPORTED_MODULE_3__.BsTwitterX,{size:22,color:"var(--ifm-color-white)",style:{marginRight:'10px'}}),"Retweet"]})]})]});};const ResponsiveH2=(0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_site_src_css_SharedStyling__WEBPACK_IMPORTED_MODULE_7__.H2).withConfig({displayName:"LikeAndRetweetItem__ResponsiveH2",componentId:"sc-c60ajk-0"})(["font-size:1.25rem;@media ","{font-size:1.25rem;}"],_site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__/* .device */ .jO.mobileL);const ShareRow=styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({displayName:"LikeAndRetweetItem__ShareRow",componentId:"sc-c60ajk-1"})(["display:flex;justify-content:space-between;align-items:center;@media ","{display:flex;flex-direction:column;justify-content:space-between;align-items:center;}"],_site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__/* .device */ .jO.mobileL);const RetweetButton=(0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A).withConfig({displayName:"LikeAndRetweetItem__RetweetButton",componentId:"sc-c60ajk-2"})(["background:var(--ifm-color-custom-pink);border-radius:16px;padding:14px 20px;font-size:1rem;font-weight:500;letter-spacing:-0.03em;line-height:26px;display:flex;flex-direction:row;align-items:center;border:none;color:var(--ifm-color-white);align-self:",";&:hover{color:var(--ifm-color-white);opacity:0.8;cursor:pointer;}@media ","{width:100%;justify-content:center;}"],props=>props.self,_site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__/* .device */ .jO.mobileL);const LikeButton=(0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A).withConfig({displayName:"LikeAndRetweetItem__LikeButton",componentId:"sc-c60ajk-3"})(["background:transparent;border-radius:16px;padding:14px 20px;font-size:1rem;font-weight:500;letter-spacing:-0.03em;line-height:26px;display:flex;flex-direction:row;align-items:center;border:1.5px solid var(--ifm-like-border-color);color:var(--ifm-color-primary-text);align-self:",";&:hover{color:var(--ifm-color-primary-text);opacity:0.8;cursor:pointer;}@media ","{width:100%;justify-content:center;}"],props=>props.self,_site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__/* .device */ .jO.mobileL);/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LikeAndRetweetItem);
...
return __webpack_require__(946452)[constantName];}function loadClientSideLibraryPushProtocolRestAPI(constantName){return typeof window!=='undefined'?__webpack_require__(514086)[constantName]:Promise.resolve({});// Return an empty object or appropriate placeholder for SSR.
}function loadClientSideLibraryPushProtocolUIWeb(constantName){return typeof window!=='undefined'?__webpack_require__(70843)[constantName]:Promise.resolve({});// Return an empty object or appropriate placeholder for SSR.
...
StandardMerkleTree:loadClientSideLibraryOpenZepplinMerkleTree('StandardMerkleTree'),PushAPI:loadClientSideLibraryPushProtocolRestAPI('PushAPI'),// CONSTANTS: loadClientSideLibraryPushProtocolRestAPI('CONSTANTS'),
...
/* harmony export */ });
/* harmony import */ var _tanstack_react_query__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(994315);
