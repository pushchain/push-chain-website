"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[49705],{
...
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/Icon/Socials/GitHub/styles.module.css
var styles_module = __webpack_require__(333242);
...
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/Icon/Socials/LinkedIn/styles.module.css
var LinkedIn_styles_module = __webpack_require__(437977);
...
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/Icon/Socials/Bluesky/styles.module.css
var Bluesky_styles_module = __webpack_require__(357214);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const SocialPlatformConfigs={twitter:{Icon:Socials_Twitter,label:'Twitter'},github:{Icon:Socials_GitHub,label:'GitHub'},stackoverflow:{Icon:Socials_StackOverflow,label:'Stack Overflow'},linkedin:{Icon:Socials_LinkedIn,label:'LinkedIn'},x:{Icon:Socials_X,label:'X'},bluesky:{Icon:Socials_Bluesky,label:'Bluesky'},instagram:{Icon:Socials_Instagram,label:'Instagram'},threads:{Icon:Socials_Threads,label:'Threads'},mastodon:{Icon:Socials_Mastodon,label:'Mastodon'},youtube:{Icon:Socials_YouTube,label:'YouTube'},twitch:{Icon:Socials_Twitch,label:'Twitch'},email:{Icon:Socials_Email,label:'Email'}};function getSocialPlatformConfig(platformKey){var _SocialPlatformConfig;return(_SocialPlatformConfig=SocialPlatformConfigs[platformKey])!==null&&_SocialPlatformConfig!==void 0?_SocialPlatformConfig:{Icon:Default,label:platformKey};}function SocialLink(_ref){let platform=_ref.platform,link=_ref.link;const _getSocialPlatformCon=getSocialPlatformConfig(platform),Icon=_getSocialPlatformCon.Icon,label=_getSocialPlatformCon.label;return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{className:Socials_styles_module/* default */.A.authorSocialLink,href:link,title:label,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Icon,{className:(0,clsx/* default */.A)(Socials_styles_module/* default */.A.authorSocialIcon)})});}function BlogAuthorSocials(_ref2){var _author$socials;let author=_ref2.author;const entries=Object.entries((_author$socials=author.socials)!==null&&_author$socials!==void 0?_author$socials:{});return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Socials_styles_module/* default */.A.authorSocials,children:entries.map(_ref3=>{let platform=_ref3[0],linkUrl=_ref3[1];return/*#__PURE__*/(0,jsx_runtime.jsx)(SocialLink,{platform:platform,link:linkUrl},platform);})});}
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/Heading/index.js
var Heading = __webpack_require__(444608);
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/Blog/Components/Author/styles.module.css
var Author_styles_module = __webpack_require__(84433);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function MaybeLink(props){if(props.href){return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,Object.assign({},props));}return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:props.children});}function AuthorTitle(_ref){let title=_ref.title;return/*#__PURE__*/(0,jsx_runtime.jsx)("small",{className:Author_styles_module/* default */.A.authorTitle,title:title,children:title});}function AuthorName(_ref2){let name=_ref2.name,as=_ref2.as;if(!as){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:Author_styles_module/* default */.A.authorName,translate:"no",children:name});}else{return/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* default */.A,{as:as,className:Author_styles_module/* default */.A.authorName,translate:"no",children:name});}}function AuthorBlogPostCount(_ref3){let count=_ref3.count;return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)(Author_styles_module/* default */.A.authorBlogPostCount),children:count});}// Note: in the future we might want to have multiple "BlogAuthor" components
...
function BlogAuthor(_ref4){let as=_ref4.as,author=_ref4.author,className=_ref4.className,count=_ref4.count;const name=author.name,title=author.title,url=author.url,imageURL=author.imageURL,email=author.email,page=author.page;const link=(page===null||page===void 0?void 0:page.permalink)||url||email&&"mailto:"+email||undefined;return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)('avatar margin-bottom--sm',className,Author_styles_module/* default */.A["author-as-"+as]),children:[imageURL&&/*#__PURE__*/(0,jsx_runtime.jsx)(MaybeLink,{href:link,className:"avatar__photo-link",children:/*#__PURE__*/(0,jsx_runtime.jsx)("img",{className:(0,clsx/* default */.A)('avatar__photo',Author_styles_module/* default */.A.authorImage),src:imageURL,alt:name})}),(name||title)&&/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)('avatar__intro',Author_styles_module/* default */.A.authorDetails),children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"avatar__name",children:[name&&/*#__PURE__*/(0,jsx_runtime.jsx)(MaybeLink,{href:link,children:/*#__PURE__*/(0,jsx_runtime.jsx)(AuthorName,{name:name,as:as})}),count!==undefined&&/*#__PURE__*/(0,jsx_runtime.jsx)(AuthorBlogPostCount,{count:count})]}),!!title&&/*#__PURE__*/(0,jsx_runtime.jsx)(AuthorTitle,{title:title}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogAuthorSocials,{author:author})]})]});}
...
/* harmony export */ });
/* unused harmony export useBlogTagsPostsPageTitle */
...
/* harmony import */ var _utils_usePluralForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(853465);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"authorSocials":"authorSocials_rSDt","authorSocialLink":"authorSocialLink_owbf","authorSocialIcon":"authorSocialIcon_XYv3"});
    if(true) {
      (function() {
        var localsJsonString = "{\"authorSocials\":\"authorSocials_rSDt\",\"authorSocialLink\":\"authorSocialLink_owbf\",\"authorSocialIcon\":\"authorSocialIcon_XYv3\"}";
        // 1788354442309
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"authorImage":"authorImage_XqGP","author-as-h1":"author-as-h1_n9oJ","author-as-h2":"author-as-h2_gXvM","authorDetails":"authorDetails_lV9A","authorName":"authorName_yefp","authorTitle":"authorTitle_nd0D","authorBlogPostCount":"authorBlogPostCount_iiJ5"});
    if(true) {
      (function() {
        var localsJsonString = "{\"authorImage\":\"authorImage_XqGP\",\"author-as-h1\":\"author-as-h1_n9oJ\",\"author-as-h2\":\"author-as-h2_gXvM\",\"authorDetails\":\"authorDetails_lV9A\",\"authorName\":\"authorName_yefp\",\"authorTitle\":\"authorTitle_nd0D\",\"authorBlogPostCount\":\"authorBlogPostCount_iiJ5\"}";
        // 1788354428305
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"blueskySvg":"blueskySvg_AzZw"});
    if(true) {
      (function() {
        var localsJsonString = "{\"blueskySvg\":\"blueskySvg_AzZw\"}";
        // 1788354443397
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"githubSvg":"githubSvg_Uu4N"});
    if(true) {
      (function() {
        var localsJsonString = "{\"githubSvg\":\"githubSvg_Uu4N\"}";
        // 1788354443400
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"instagramSvg":"instagramSvg_YC40"});
    if(true) {
      (function() {
        var localsJsonString = "{\"instagramSvg\":\"instagramSvg_YC40\"}";
        // 1788354443399
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"linkedinSvg":"linkedinSvg_FCgI"});
    if(true) {
      (function() {
        var localsJsonString = "{\"linkedinSvg\":\"linkedinSvg_FCgI\"}";
        // 1788354443395
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"threadsSvg":"threadsSvg_PTXY"});
    if(true) {
      (function() {
        var localsJsonString = "{\"threadsSvg\":\"threadsSvg_PTXY\"}";
        // 1788354443407
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"xSvg":"xSvg_y3PF"});
    if(true) {
      (function() {
        var localsJsonString = "{\"xSvg\":\"xSvg_y3PF\"}";
        // 1788354443405
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
