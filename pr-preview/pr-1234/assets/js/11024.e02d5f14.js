(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[11024],{
 ...
 */const codeBlockTitleRegex=/*#__PURE__*/(0,wrapRegExp/* default */.A)(/title=(["'])(.*?)\1/,{quote:1,title:2});const metastringLinesRangeRegex=/*#__PURE__*/(0,wrapRegExp/* default */.A)(/\{([\d,-]+)\}/,{range:1});// Supported types of highlight comments
const popularCommentPatterns={js:{start:'\\/\\/',end:''},jsBlock:{start:'\\/\\*',end:'\\*\\/'},jsx:{start:'\\{\\s*\\/\\*',end:'\\*\\/\\s*\\}'},bash:{start:'#',end:''},html:{start:'<!--',end:'-->'}};const commentPatterns=Object.assign({},popularCommentPatterns,{// shallow copy is sufficient
...
const commentPattern=languages.map(lang=>{const _commentPatterns$lang=commentPatterns[lang],start=_commentPatterns$lang.start,end=_commentPatterns$lang.end;return"(?:"+start+"\\s*("+magicCommentDirectives.flatMap(d=>{var _d$block,_d$block2;return[d.line,(_d$block=d.block)===null||_d$block===void 0?void 0:_d$block.start,(_d$block2=d.block)===null||_d$block2===void 0?void 0:_d$block2.end].filter(Boolean);}).join('|')+")\\s*"+end+")";}).join('|');// White space is allowed, but otherwise it should be on it's own line
...
return getCommentPattern(popularCommentTypes,magicCommentDirectives);}}function parseCodeBlockTitle(metastring){var _metastring$match$gro,_metastring$match;return(_metastring$match$gro=metastring===null||metastring===void 0||(_metastring$match=metastring.match(codeBlockTitleRegex))===null||_metastring$match===void 0?void 0:_metastring$match.groups.title)!==null&&_metastring$match$gro!==void 0?_metastring$match$gro:'';}function getMetaLineNumbersStart(metastring){const showLineNumbersMeta=metastring===null||metastring===void 0?void 0:metastring.split(' ').find(str=>str.startsWith('showLineNumbers'));if(showLineNumbersMeta){if(showLineNumbersMeta.startsWith('showLineNumbers=')){const value=showLineNumbersMeta.replace('showLineNumbers=','');return parseInt(value,10);}return 1;}return undefined;}function getLineNumbersStart(_ref){let showLineNumbers=_ref.showLineNumbers,metastring=_ref.metastring;const defaultStart=1;if(typeof showLineNumbers==='boolean'){return showLineNumbers?defaultStart:undefined;}if(typeof showLineNumbers==='number'){return showLineNumbers;}return getMetaLineNumbersStart(metastring);}// TODO Docusaurus v4: remove, only kept for internal retro-compatibility
//  See https://github.com/facebook/docusaurus/pull/11153
function containsLineNumbers(metastring){return Boolean(metastring===null||metastring===void 0?void 0:metastring.includes('showLineNumbers'));}function parseCodeLinesFromMetastring(code,_ref2){let metastring=_ref2.metastring,magicComments=_ref2.magicComments;// Highlighted lines specified in props: don't parse the content
if(metastring&&metastringLinesRangeRegex.test(metastring)){const linesRange=metastring.match(metastringLinesRangeRegex).groups.range;if(magicComments.length===0){throw new Error("A highlight range has been given in code block's metastring (``` "+metastring+"), but no magic comment config is available. Docusaurus applies the first magic comment entry's className for metastring ranges.");}const metastringRangeClassName=magicComments[0].className;const lines=parse_numeric_range_default()(linesRange).filter(n=>n>0).map(n=>[n-1,[metastringRangeClassName]]);return{lineClassNames:Object.fromEntries(lines),code};}return null;}function parseCodeLinesFromContent(code,params){const language=params.language,magicComments=params.magicComments;if(language===undefined){return{lineClassNames:{},code};}const directiveRegex=getAllMagicCommentDirectiveStyles(language,magicComments);// Go through line by line
const lines=code.split(/\r?\n/);const blocks=Object.fromEntries(magicComments.map(d=>[d.className,{start:0,range:''}]));const lineToClassName=Object.fromEntries(magicComments.filter(d=>d.line).map(_ref3=>{let className=_ref3.className,line=_ref3.line;return[line,className];}));const blockStartToClassName=Object.fromEntries(magicComments.filter(d=>d.block).map(_ref4=>{let className=_ref4.className,block=_ref4.block;return[block.start,className];}));const blockEndToClassName=Object.fromEntries(magicComments.filter(d=>d.block).map(_ref5=>{let className=_ref5.className,block=_ref5.block;return[block.end,className];}));for(let lineNumber=0;lineNumber<lines.length;){const line=lines[lineNumber];const match=line.match(directiveRegex);if(!match){// Lines without directives are unchanged
lineNumber+=1;continue;}const directive=match.slice(1).find(item=>item!==undefined);if(lineToClassName[directive]){blocks[lineToClassName[directive]].range+=lineNumber+",";}else if(blockStartToClassName[directive]){blocks[blockStartToClassName[directive]].start=lineNumber;}else if(blockEndToClassName[directive]){blocks[blockEndToClassName[directive]].range+=blocks[blockEndToClassName[directive]].start+"-"+(lineNumber-1)+",";}lines.splice(lineNumber,1);}const lineClassNames={};Object.entries(blocks).forEach(_ref6=>{let className=_ref6[0],range=_ref6[1].range;parse_numeric_range_default()(range).forEach(l=>{var _lineClassNames$l;(_lineClassNames$l=lineClassNames[l])!==null&&_lineClassNames$l!==void 0?_lineClassNames$l:lineClassNames[l]=[];lineClassNames[l].push(className);});});return{code:lines.join('\n'),lineClassNames};}/**
...
return(_parseCodeLinesFromMe=parseCodeLinesFromMetastring(newCode,Object.assign({},params)))!==null&&_parseCodeLinesFromMe!==void 0?_parseCodeLinesFromMe:parseCodeLinesFromContent(newCode,Object.assign({},params));}/**
 ...
 */function ensureLanguageClassName(_ref8){let className=_ref8.className,language=_ref8.language;return (0,dist_clsx/* default */.A)(className,language&&!(className!==null&&className!==void 0&&className.includes("language-"+language))&&"language-"+language);}function createCodeBlockMetadata(params){const language=getLanguage({language:params.language,defaultLanguage:params.defaultLanguage,className:params.className});const _parseLines=parseLines(params.code,{metastring:params.metastring,magicComments:params.magicComments,language}),lineClassNames=_parseLines.lineClassNames,code=_parseLines.code;const className=ensureLanguageClassName({className:params.className,language});const title=parseCodeBlockTitle(params.metastring)||params.title;const lineNumbersStart=getLineNumbersStart({showLineNumbers:params.showLineNumbers,metastring:params.metastring});return{codeInput:params.code,code,className,language,title,lineNumbersStart,lineClassNames};}function getPrismCssVariables(prismTheme){const mapping={color:'--prism-color',backgroundColor:'--prism-background-color'};const properties={};Object.entries(prismTheme.plain).forEach(_ref9=>{let key=_ref9[0],value=_ref9[1];const varName=mapping[key];if(varName&&typeof value==='string'){properties[varName]=value;}});return properties;}const CodeBlockContext=/*#__PURE__*/(0,react.createContext)(null);function CodeBlockContextProvider(_ref0){let metadata=_ref0.metadata,wordWrap=_ref0.wordWrap,children=_ref0.children;// Should we optimize this in 2 contexts?
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function CodeBlockContainer(_ref){let As=_ref.as,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);const prismTheme=(0,usePrismTheme/* usePrismTheme */.A)();const prismCssVariables=getPrismCssVariables(prismTheme);return/*#__PURE__*/(0,jsx_runtime.jsx)(As// Polymorphic components are hard to type, without `oneOf` generics
,Object.assign({},props,{style:prismCssVariables,className:(0,clsx/* default */.A)(props.className,styles_module/* default */.A.codeBlockContainer,ThemeClassNames/* ThemeClassNames */.G.common.codeBlock)}));}
...
function CodeBlockTitle(_ref){let children=_ref.children;return children;}
...
const Token_excluded=["line","token"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */// Pass-through components that users can swizzle and customize
function CodeBlockLineToken(_ref){let line=_ref.line,token=_ref.token,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,Token_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)("span",Object.assign({},props));}
...
const Pre=/*#__PURE__*/react.forwardRef((props,ref)=>{return/*#__PURE__*/(0,jsx_runtime.jsx)("pre",Object.assign({ref:ref/* eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex */,tabIndex:0},props,{className:(0,clsx/* default */.A)(props.className,Content_styles_module/* default */.A.codeBlock,'thin-scrollbar')}));});function Code(props){const _useCodeBlockContext=useCodeBlockContext(),metadata=_useCodeBlockContext.metadata;return/*#__PURE__*/(0,jsx_runtime.jsx)("code",Object.assign({},props,{className:(0,clsx/* default */.A)(props.className,Content_styles_module/* default */.A.codeBlockLines,metadata.lineNumbersStart!==undefined&&Content_styles_module/* default */.A.codeBlockLinesWithNumbering),style:Object.assign({},props.style,{counterReset:metadata.lineNumbersStart===undefined?undefined:"line-count "+(metadata.lineNumbersStart-1)})}));}function CodeBlockContent(_ref){let classNameProp=_ref.className;const _useCodeBlockContext2=useCodeBlockContext(),metadata=_useCodeBlockContext2.metadata,wordWrap=_useCodeBlockContext2.wordWrap;const prismTheme=(0,usePrismTheme/* usePrismTheme */.A)();const code=metadata.code,language=metadata.language,lineNumbersStart=metadata.lineNumbersStart,lineClassNames=metadata.lineClassNames;return/*#__PURE__*/(0,jsx_runtime.jsx)(dist/* Highlight */.f4,{theme:prismTheme,code:code,language:language,children:_ref2=>{let className=_ref2.className,style=_ref2.style,lines=_ref2.tokens,getLineProps=_ref2.getLineProps,getTokenProps=_ref2.getTokenProps;return/*#__PURE__*/(0,jsx_runtime.jsx)(Pre,{ref:wordWrap.codeBlockRef,className:(0,clsx/* default */.A)(classNameProp,className),style:style,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Code,{children:lines.map((line,i)=>/*#__PURE__*/(0,jsx_runtime.jsx)(CodeBlockLine,{line:line,getLineProps:getLineProps,getTokenProps:getTokenProps,classNames:lineClassNames[i],showLineNumbers:lineNumbersStart!==undefined},i))})});}});}
...
const Button_excluded=["className"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function CodeBlockButton(_ref){let className=_ref.className,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,Button_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)("button",Object.assign({type:"button"},props,{className:(0,clsx/* default */.A)('clean-btn',className)}));}
...
const _await$import=await __webpack_require__.e(/* import() */ 33436).then(__webpack_require__.bind(__webpack_require__, 933436)),copy=_await$import.default;return copy(text);}function useCopyButton(){const _useCodeBlockContext=useCodeBlockContext(),code=_useCodeBlockContext.metadata.code;const _useState=(0,react.useState)(false),isCopied=_useState[0],setIsCopied=_useState[1];const copyTimeout=(0,react.useRef)(undefined);const copyCode=(0,react.useCallback)(()=>{copyToClipboard(code).then(()=>{setIsCopied(true);copyTimeout.current=window.setTimeout(()=>{setIsCopied(false);},1000);});// Errors are intentionally not caught so they remain unhandled and can
// be captured by observability tools (e.g. Sentry, PostHog).
},[code]);(0,react.useEffect)(()=>()=>window.clearTimeout(copyTimeout.current),[]);return{copyCode,isCopied};}function CopyButton(_ref){let className=_ref.className;const _useCopyButton=useCopyButton(),copyCode=_useCopyButton.copyCode,isCopied=_useCopyButton.isCopied;return/*#__PURE__*/(0,jsx_runtime.jsx)(CodeBlockButton,{"aria-label":ariaLabel(isCopied),title:title(),className:(0,clsx/* default */.A)(className,CopyButton_styles_module/* default */.A.copyButton,isCopied&&CopyButton_styles_module/* default */.A.copyButtonCopied),onClick:copyCode,children:/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:CopyButton_styles_module/* default */.A.copyButtonIcons,"aria-hidden":"true",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(IconCopy,{className:CopyButton_styles_module/* default */.A.copyButtonIcon}),/*#__PURE__*/(0,jsx_runtime.jsx)(IconSuccess,{className:CopyButton_styles_module/* default */.A.copyButtonSuccessIcon})]})});}
...
function CodeBlockButtons(_ref){let className=_ref.className;return/*#__PURE__*/(0,jsx_runtime.jsx)(BrowserOnly/* default */.A,{children:()=>/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)(className,Buttons_styles_module/* default */.A.buttonGroup),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(WordWrapButton,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(CopyButton,{})]})});}
...
const CodeBlock_excluded=["children"];/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
...
return Array.isArray(children)?children.join(''):children;}function CodeBlock(_ref){let rawChildren=_ref.children,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,CodeBlock_excluded);// The Prism theme on SSR is always the default theme but the site theme can
// be in a different mode. React hydration doesn't update DOM styles that come
// from SSR. Hence force a re-render after mounting to apply the current
// relevant styles.
const isBrowser=(0,useIsBrowser/* default */.A)();const children=maybeStringifyChildren(rawChildren);const CodeBlockComp=typeof children==='string'?CodeBlockString:CodeBlockJSX;return/*#__PURE__*/(0,jsx_runtime.jsx)(CodeBlockComp,Object.assign({},props,{children:children}),String(isBrowser));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function LiveCodeBlock(props){return/*#__PURE__*/(0,jsx_runtime.jsx)(Playground/* default */.A,Object.assign({scope:ReactLiveScope/* default */.A},props));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function isLiveCodeBlock(props){return!!props.live&&(typeof props.children==='undefined'||typeof props.children==='string');}function CodeBlockEnhancer(props){return isLiveCodeBlock(props)?/*#__PURE__*/(0,jsx_runtime.jsx)(LiveCodeBlock,Object.assign({},props)):/*#__PURE__*/(0,jsx_runtime.jsx)(CodeBlock,Object.assign({},props));}
