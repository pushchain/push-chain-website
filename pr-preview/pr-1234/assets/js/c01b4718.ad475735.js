"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[88807],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_102_contract_initiated_examples_section_mdx_c01_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-102-contract-initiated-examples-section-mdx-c01.json
const site_docs_chain_03_build_102_contract_initiated_examples_section_mdx_c01_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-contract-initiated-examples-section","title":"Contract-Initiated Examples","description":"Contract-Initiated Examples Section | Build | Push Chain Docs","source":"@site/docs/chain/03-build/102-Contract-Initiated-Examples-Section.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/contract-initiated-examples","permalink":"/push-chain-website/pr-preview/pr-1234/docs/chain/build/contract-initiated-examples","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/102-Contract-Initiated-Examples-Section.mdx","tags":[],"version":"current","sidebarPosition":102,"frontMatter":{"id":"docs-chain-build-contract-initiated-examples-section","title":"Contract-Initiated Examples","hide_title":false,"slug":"./contract-initiated-examples","displayed_sidebar":"pushChainSidebar","sidebar_position":102,"image":"/assets/docs/previews/docs_chain_build__section--contract-initiated_examples.png"},"sidebar":"pushChainSidebar","previous":{"title":"Upgrade Universal Account","permalink":"/push-chain-website/pr-preview/pr-1234/docs/chain/build/advanced/upgrade-universal-account"},"next":{"title":"Inbound to Push Chain","permalink":"/push-chain-website/pr-preview/pr-1234/docs/chain/build/contract-initiated-examples/inbound-to-push-chain"}}');
...
;// ./docs/chain/03-build/102-Contract-Initiated-Examples-Section.mdx
...
const frontMatter = {
	...
	image: '/assets/docs/previews/docs_chain_build__section--contract-initiated_examples.png'
};
const contentTitle = 'Contract-Initiated Examples Section';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      children: (0,jsx_runtime.jsx)("title", {
        children: "Contract-Initiated Examples Section | Build | Push Chain Docs"
      })
    }), "\n", "\n", "\n", (0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "contract-initiated-examples-section",
        children: "Contract-Initiated Examples Section"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Reference implementations including examples of cross-chain smart contracts on Push Chain. Each example is a complete, deployable contract you can copy, adapt, and ship."
