(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[73410],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_07_universal_transaction_scenarios_mdx_a60_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-07-universal-transaction-scenarios-mdx-a60.json
const site_docs_chain_03_build_07_universal_transaction_scenarios_mdx_a60_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-universal-transaction-scenarios","title":"Universal Transaction Scenarios","description":"Universal Transaction Scenarios | Build | Push Chain Docs","source":"@site/docs/chain/03-build/07-Universal-Transaction-Scenarios.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/universal-transaction-scenarios","permalink":"/push-chain-website/pr-preview/pr-1234/docs/chain/build/universal-transaction-scenarios","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/07-Universal-Transaction-Scenarios.mdx","tags":[],"version":"current","sidebarPosition":7,"frontMatter":{"id":"docs-chain-build-universal-transaction-scenarios","title":"Universal Transaction Scenarios","hide_title":false,"slug":"./universal-transaction-scenarios","displayed_sidebar":"pushChainSidebar","sidebar_position":7,"image":"/assets/docs/previews/docs_chain_build--universal_transaction_scenarios.png"},"sidebar":"pushChainSidebar","previous":{"title":"Send Universal Transaction","permalink":"/push-chain-website/pr-preview/pr-1234/docs/chain/build/send-universal-transaction"},"next":{"title":"Send Multichain Transactions","permalink":"/push-chain-website/pr-preview/pr-1234/docs/chain/build/send-multichain-transactions"}}');
