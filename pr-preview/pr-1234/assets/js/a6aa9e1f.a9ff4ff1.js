 ...
 */function useContextValue(_ref){let content=_ref.content,isBlogPostPage=_ref.isBlogPostPage;return (0,react.useMemo)(()=>({metadata:content.metadata,frontMatter:content.frontMatter,assets:content.assets,toc:content.toc,isBlogPostPage}),[content,isBlogPostPage]);}/**
 * This is a very thin layer around the `content` received from the MDX loader.
 * It provides metadata about the blog post to the children tree.
 */function BlogPostProvider(_ref2){let children=_ref2.children,content=_ref2.content,_ref2$isBlogPostPage=_ref2.isBlogPostPage,isBlogPostPage=_ref2$isBlogPostPage===void 0?false:_ref2$isBlogPostPage;const contextValue=useContextValue({content,isBlogPostPage});return/*#__PURE__*/(0,jsx_runtime.jsx)(Context.Provider,{value:contextValue,children:children});}/**
...
/* unused harmony import specifier */ var sidebarUtils_Link;
/* unused harmony import specifier */ var groupBy;
 ...
 */function useVisibleBlogSidebarItems(items){const _useLocation=useLocation(),pathname=_useLocation.pathname;return useMemo(()=>items.filter(item=>isVisible(item,pathname)),[items,pathname]);}function groupBlogSidebarItemsByYear(items){const groupedByYear=groupBy(items,item=>{return""+new Date(item.date).getFullYear();});// "as" is safe here
...
entries.reverse();return entries;}function BlogSidebarItemList(_ref){let items=_ref.items,ulClassName=_ref.ulClassName,liClassName=_ref.liClassName,linkClassName=_ref.linkClassName,linkActiveClassName=_ref.linkActiveClassName;return/*#__PURE__*/_jsx("ul",{className:ulClassName,children:items.map(item=>/*#__PURE__*/_jsx("li",{className:liClassName,children:/*#__PURE__*/_jsx(sidebarUtils_Link,{isNavLink:true,to:item.permalink,className:linkClassName,activeClassName:linkActiveClassName,children:item.title})},item.permalink))});}
...
const blogtags_namespaceObject = /*#__PURE__*/JSON.parse('[{"name":"Featured","slug":"featured","link":"/blog/tags/featured/","priority":0,"category":"Featured","count":11},{"name":"Product","slug":"product","link":"/blog/tags/product/","priority":1,"category":"Product","count":28},{"name":"Key Features","slug":"key-features","link":"/blog/tags/key-features/","priority":2,"category":"Key Features","count":20},{"name":"Technical","slug":"technical","link":"/blog/tags/technical/","priority":3,"category":"Technical","count":7},{"name":"Programs","slug":"programs","link":"/blog/tags/programs/","priority":4,"category":"Programs","count":6},{"name":"Thought Leadership","slug":"thought-leadership","link":"/blog/tags/thought-leadership/","priority":5,"category":"Thought Leadership","count":6},{"name":"Case Studies","slug":"case-studies","link":"/blog/tags/case-studies/","priority":6,"category":"Case Studies","count":1},{"name":"Ecosystem","slug":"ecosystem","link":"/blog/tags/ecosystem/","priority":7,"category":"Ecosystem","count":10},{"name":"Partnerships","slug":"partnerships","link":"/blog/tags/partnerships/","priority":8,"category":"Partnerships","count":15},{"name":"Maker Monday","slug":"maker-monday","link":"/blog/tags/maker-monday/","priority":9,"category":"Maker Monday","count":19},{"name":"Deep Dives","slug":"deep-dives","link":"/blog/tags/deep-dives/","priority":10,"category":"Deep Dives","count":15},{"name":"Push 101","slug":"push-101","link":"/blog/tags/push-101/","priority":11,"category":"Push 101","count":5}]');
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(296540);
...
// EXTERNAL MODULE: ./src/theme/BlogListPaginator/index.js
var BlogListPaginator = __webpack_require__(603345);
...
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(474848);
;// ./src/components/Blog/FeaturedBlogPosts.js
const FeaturedBlogPosts=()=>{const _useFetchRecentBlogs=(0,useFetchRecentBlogs/* default */.A)(),recentBlogs=_useFetchRecentBlogs.recentBlogs;const _useTranslation=(0,es/* useTranslation */.Bd)(),t=_useTranslation.t;const _useBaseUrlUtils=(0,useBaseUrl/* useBaseUrlUtils */.hH)(),withBaseUrl=_useBaseUrlUtils.withBaseUrl;if(!recentBlogs||recentBlogs.length===0){return null;}const _recentBlogs$slice=recentBlogs.slice(0,4),firstPost=_recentBlogs$slice[0],remainingPosts=_arrayLikeToArray(_recentBlogs$slice).slice(1);return/*#__PURE__*/(0,jsx_runtime.jsxs)(FeaturedContainer,{children:[firstPost&&/*#__PURE__*/(0,jsx_runtime.jsxs)(MainFeaturedPost,{as:"a",href:withBaseUrl(firstPost.link),title:firstPost.title,"aria-label":t('components.blog.featured.post-aria-label',{title:firstPost.title}),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(MainFeaturedImage,{src:withBaseUrl(firstPost.imageUrl),alt:t('components.blog.featured.image-alt',{title:firstPost.title}),loading:"lazy"}),/*#__PURE__*/(0,jsx_runtime.jsxs)(MainFeaturedContent,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(MetadataRow,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(date/* Date */.n9,{date:firstPost.pubDate,formattedDate:firstPost.pubDate,mr:'3px'}),typeof firstPost.readingTime!=='undefined'&&/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(date/* Spacer */.hK,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(date/* ReadingTime */.uR,{readingTime:firstPost.readingTime})]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(MainFeaturedTitle,{children:firstPost.title}),/*#__PURE__*/(0,jsx_runtime.jsx)(MainFeaturedDescription,{children:firstPost.description})]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(SecondaryFeaturedGrid,{children:remainingPosts.slice(0,3).map((post,index)=>/*#__PURE__*/(0,jsx_runtime.jsxs)(SecondaryFeaturedPost,{as:"a",href:withBaseUrl(post.link),title:post.title,"aria-label":t('components.blog.featured.post-aria-label',{title:post.title}),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(SecondaryFeaturedImage,{src:withBaseUrl(post.imageUrl),alt:t('components.blog.featured.image-alt',{title:post.title}),loading:"lazy"}),/*#__PURE__*/(0,jsx_runtime.jsxs)(SecondaryFeaturedContent,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(MetadataRow,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(date/* Date */.n9,{date:post.pubDate,formattedDate:post.pubDate,mr:'3px'}),typeof post.readingTime!=='undefined'&&/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(date/* Spacer */.hK,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(date/* ReadingTime */.uR,{readingTime:post.readingTime})]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(SecondaryFeaturedTitle,{children:post.title})]})]},index))})]});};/* harmony default export */ const Blog_FeaturedBlogPosts = (FeaturedBlogPosts);const FeaturedContainer=styled_components_browser_esm["default"].div.withConfig({displayName:"FeaturedBlogPosts__FeaturedContainer",componentId:"sc-sf0wj8-0"})(["display:flex;flex-direction:column;gap:64px;margin-top:32px;"]);const MainFeaturedPost=styled_components_browser_esm["default"].div.withConfig({displayName:"FeaturedBlogPosts__MainFeaturedPost",componentId:"sc-sf0wj8-1"})(["display:flex;flex-direction:row;gap:32px;padding:0;background:transparent;border:none;text-decoration:none;cursor:pointer;@media ","{flex-direction:column;gap:24px;}"],globals/* device */.jO.tablet);const MainFeaturedImage=(0,styled_components_browser_esm["default"])(SharedStyling/* Image */._V).withConfig({displayName:"FeaturedBlogPosts__MainFeaturedImage",componentId:"sc-sf0wj8-2"})(["width:50%;height:auto;border-radius:24px;object-fit:cover;aspect-ratio:16 / 9;@media ","{width:100%;}"],globals/* device */.jO.tablet);const MainFeaturedContent=styled_components_browser_esm["default"].div.withConfig({displayName:"FeaturedBlogPosts__MainFeaturedContent",componentId:"sc-sf0wj8-3"})(["display:flex;flex-direction:column;justify-content:center;gap:0;flex:1;"]);const MetadataRow=(0,styled_components_browser_esm["default"])(SharedStyling/* ItemH */.Oj).withConfig({displayName:"FeaturedBlogPosts__MetadataRow",componentId:"sc-sf0wj8-4"})(["align-items:flex-start;align-self:flex-start;flex:0;color:var(--ifm-color-blog-date);justify-content:flex-start;font-size:0.9rem;font-style:normal;font-weight:400;line-height:150%;letter-spacing:normal;"]);const MainFeaturedTitle=(0,styled_components_browser_esm["default"])(SharedStyling.H2).withConfig({displayName:"FeaturedBlogPosts__MainFeaturedTitle",componentId:"sc-sf0wj8-5"})(["color:var(--ifm-color-primary-blog);font-size:1.75rem;font-weight:600;line-height:140%;margin:0;text-align:left;letter-spacing:normal;overflow:hidden;display:-webkit-box !important;-webkit-line-clamp:2;-webkit-box-orient:vertical;transition:color 0.2s ease;",":hover &{color:var(--ifm-color-primary);}@media ","{font-size:1.5rem;}"],MainFeaturedPost,globals/* device */.jO.tablet);const MainFeaturedDescription=(0,styled_components_browser_esm["default"])(SharedStyling/* Span */.L9).withConfig({displayName:"FeaturedBlogPosts__MainFeaturedDescription",componentId:"sc-sf0wj8-6"})(["color:var(--ifm-color-secondary-blog);font-size:1.25rem;font-style:normal;font-weight:400;line-height:135%;letter-spacing:normal;overflow:hidden;display:-webkit-box !important;-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:16px 0 0 0;text-align:start;"]);const SecondaryFeaturedGrid=styled_components_browser_esm["default"].div.withConfig({displayName:"FeaturedBlogPosts__SecondaryFeaturedGrid",componentId:"sc-sf0wj8-7"})(["display:grid;grid-template-columns:repeat(3,1fr);gap:32px;@media ","{grid-template-columns:1fr;gap:24px;}"],globals/* device */.jO.tablet);const SecondaryFeaturedPost=styled_components_browser_esm["default"].div.withConfig({displayName:"FeaturedBlogPosts__SecondaryFeaturedPost",componentId:"sc-sf0wj8-8"})(["display:flex;flex-direction:column;gap:12px;padding:0;background:transparent;border:none;text-decoration:none;cursor:pointer;"]);const SecondaryFeaturedImage=(0,styled_components_browser_esm["default"])(SharedStyling/* Image */._V).withConfig({displayName:"FeaturedBlogPosts__SecondaryFeaturedImage",componentId:"sc-sf0wj8-9"})(["width:100%;height:auto;border-radius:16px;object-fit:cover;aspect-ratio:16 / 9;"]);const SecondaryFeaturedContent=styled_components_browser_esm["default"].div.withConfig({displayName:"FeaturedBlogPosts__SecondaryFeaturedContent",componentId:"sc-sf0wj8-10"})(["display:flex;flex-direction:column;gap:0;"]);const SecondaryFeaturedTitle=(0,styled_components_browser_esm["default"])(SharedStyling.H2).withConfig({displayName:"FeaturedBlogPosts__SecondaryFeaturedTitle",componentId:"sc-sf0wj8-11"})(["color:var(--ifm-color-primary-blog);font-size:1.5rem;font-weight:600;line-height:140%;margin:0;text-align:left;letter-spacing:normal;overflow:hidden;display:-webkit-box !important;-webkit-line-clamp:2;-webkit-box-orient:vertical;transition:color 0.2s ease;",":hover &{color:var(--ifm-color-primary);}@media ","{font-size:1.5rem;}"],SecondaryFeaturedPost,globals/* device */.jO.tablet);
// EXTERNAL MODULE: ./static/content/featuredblogs.json
var featuredblogs = __webpack_require__(998894);
 ...
 * LICENSE file in the root directory of this source tree.
 */// Internal Configs
function BlogListPageMetadata(props){const metadata=props.metadata;const _useDocusaurusContext=(0,useDocusaurusContext/* default */.A)(),siteTitle=_useDocusaurusContext.siteConfig.title;const blogDescription=metadata.blogDescription,blogTitle=metadata.blogTitle,permalink=metadata.permalink;const location=(0,react_router/* useLocation */.zy)();const pathname=location===null||location===void 0?void 0:location.pathname;const isBlogOnlyMode=permalink==='/';const isBlogMainPage=pathname.includes('/page/')||pathname=='/blog/'||pathname=='/blog';const title=isBlogOnlyMode?siteTitle:blogTitle;return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[!isBlogMainPage&&/*#__PURE__*/(0,jsx_runtime.jsx)(metadataUtils/* PageMetadata */.be,{title:title,description:blogDescription}),/*#__PURE__*/(0,jsx_runtime.jsx)(SearchMetadata/* default */.A,{tag:"blog_posts_list"})]});}function BlogListPageContent(props){const _useTranslation=(0,es/* useTranslation */.Bd)(),t=_useTranslation.t;const metadata=props.metadata,items=props.items;// Extract slugs from imported featured blogs data
const featuredSlugs=featuredblogs.map(post=>post.slug);// Filter out featured posts from items on page 1
const filteredItems=(metadata===null||metadata===void 0?void 0:metadata.page)==1&&featuredSlugs.length>0?items.filter(item=>{const slug=item.content.metadata.permalink.replace('/blog/','').replace(/\/$/,'');return!featuredSlugs.includes(slug);}):items;return/*#__PURE__*/(0,jsx_runtime.jsxs)(Wrapper,{children:[(metadata===null||metadata===void 0?void 0:metadata.page)==1&&/*#__PURE__*/(0,jsx_runtime.jsx)(SharedStyling/* MultiContent */.H,{className:"large",children:/*#__PURE__*/(0,jsx_runtime.jsx)(BlogTags/* default */.A,{})}),(metadata===null||metadata===void 0?void 0:metadata.page)==1&&/*#__PURE__*/(0,jsx_runtime.jsxs)(SharedStyling/* MultiContent */.H,{className:"large",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(FeaturedTitle,{children:t('components.blog.featured.title')}),/*#__PURE__*/(0,jsx_runtime.jsx)(Blog_FeaturedBlogPosts,{})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(SharedStyling/* MultiContent */.H,{className:"large",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ListSpan,{isFirstPage:(metadata===null||metadata===void 0?void 0:metadata.page)==1,children:(metadata===null||metadata===void 0?void 0:metadata.page)==1?t('components.blog.list.recent-updates'):t('components.blog.list.page-title',{page:metadata===null||metadata===void 0?void 0:metadata.page})}),(metadata===null||metadata===void 0?void 0:metadata.page)==1&&/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItems/* default */.A,{items:filteredItems===null||filteredItems===void 0?void 0:filteredItems.slice(0,4),list:true}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem,{marginTop:(metadata===null||metadata===void 0?void 0:metadata.page)==1?true:false,children:/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItems/* default */.A,{items:filteredItems===null||filteredItems===void 0?void 0:filteredItems.slice((metadata===null||metadata===void 0?void 0:metadata.page)==1?4:0,11)})}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogListPaginator/* default */.A,{metadata:metadata})]})]});}function BlogListPage(props){return/*#__PURE__*/(0,jsx_runtime.jsx)(metadataUtils/* HtmlClassNameProvider */.e3,{className:(0,clsx_m/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.wrapper.blogPages,ThemeClassNames/* ThemeClassNames */.G.page.blogListPage),children:/*#__PURE__*/(0,jsx_runtime.jsxs)(BlogLayout/* default */.A,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(BlogListPageMetadata,Object.assign({},props)),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogListPageContent,Object.assign({},props))]})});}const Wrapper=styled_components_browser_esm["default"].div.withConfig({displayName:"BlogListPage__Wrapper",componentId:"sc-9t9q8y-0"})(["margin-top:24px;display:flex;flex-direction:column;"]);const GridItem=styled_components_browser_esm["default"].div.withConfig({displayName:"BlogListPage__GridItem",componentId:"sc-9t9q8y-1"})(["width:100%;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:33px;box-sizing:border-box;margin-top:",";& > *:nth-child(odd){justify-self:start;}& > *:nth-child(even){justify-self:end;}@media (max-width:1200px){margin-top:10px;gap:30px;}@media ","{grid-template-columns:repeat(1,minmax(0,1fr));}"],props=>props.marginTop?'100px':'30px',globals/* device */.jO.tablet);const ListSpan=(0,styled_components_browser_esm["default"])(SharedStyling/* Span */.L9).withConfig({displayName:"BlogListPage__ListSpan",componentId:"sc-9t9q8y-2"})(["color:var(--ifm-color-primary-blog);font-family:DM Sans,sans-serif;font-size:37px;font-style:normal;font-weight:700;line-height:110%;letter-spacing:-1.2px;margin-bottom:",";"],props=>props.isFirstPage?'0':'24px');const FeaturedTitle=(0,styled_components_browser_esm["default"])(SharedStyling/* Span */.L9).withConfig({displayName:"BlogListPage__FeaturedTitle",componentId:"sc-9t9q8y-3"})(["color:var(--ifm-color-primary-blog);font-family:DM Sans,sans-serif;font-size:37px;font-style:normal;font-weight:700;line-height:110%;letter-spacing:-1.2px;display:block;"]);
...
/* harmony import */ var react_i18next__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(777255);
 ...
 * LICENSE file in the root directory of this source tree.
 */// Internal Configs
function BlogListPaginator(props){const _useTranslation=(0,react_i18next__WEBPACK_IMPORTED_MODULE_2__/* .useTranslation */ .Bd)(),t=_useTranslation.t;const metadata=props.metadata;const previousPage=metadata.previousPage,nextPage=metadata.nextPage;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(NavItem// className="pagination-nav"
,{"aria-label":t('components.blog.paginator.nav-aria-label'),children:[previousPage?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_theme_PaginatorNavLink__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A,{permalink:previousPage,title:t('components.blog.paginator.newer-entries')}):/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div",{}),nextPage&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_theme_PaginatorNavLink__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A,{permalink:nextPage,title:t('components.blog.paginator.older-entries'),isNext:true})]});}const NavItem=styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].nav.withConfig({displayName:"BlogListPaginator__NavItem",componentId:"sc-1wmbmmd-0"})(["margin:0 auto 72px auto;display:flex;flex-direction:row;gap:32px;justify-content:space-between;width:100%;@media ","{flex-direction:column;gap:16px;}"],_site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__/* .device */ .jO.tablet);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ BlogPostItemHeaderInfo)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(296540);
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(320053);
/* harmony import */ var _docusaurus_plugin_content_blog_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(244096);
/* harmony import */ var _styles_module_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(293398);
/* harmony import */ var _site_src_components_reusables_date_tsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(856977);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(474848);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogPostItemHeaderInfo(_ref){let className=_ref.className,morePosts=_ref.morePosts;const _useBlogPost=(0,_docusaurus_plugin_content_blog_client__WEBPACK_IMPORTED_MODULE_2__/* .useBlogPost */ .e7)(),metadata=_useBlogPost.metadata,isBlogPostPage=_useBlogPost.isBlogPostPage;const date=metadata.date,formattedDate=metadata.formattedDate,readingTime=metadata.readingTime;if(morePosts){const blogDate=morePosts.date;const blogFormattedDate=morePosts.formattedDate;const blogReadingTime=morePosts.readingTime;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div",{className:(0,clsx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(_styles_module_css__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A.container,!isBlogPostPage?'margin-vert--sm':'',className),children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_site_src_components_reusables_date_tsx__WEBPACK_IMPORTED_MODULE_4__/* .Date */ .n9,{date:blogDate,formattedDate:blogFormattedDate}),typeof blogReadingTime!=='undefined'&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_site_src_components_reusables_date_tsx__WEBPACK_IMPORTED_MODULE_4__/* .Spacer */ .hK,{}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_site_src_components_reusables_date_tsx__WEBPACK_IMPORTED_MODULE_4__/* .ReadingTime */ .uR,{readingTime:blogReadingTime})]})]});}else{return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div",{className:(0,clsx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(_styles_module_css__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A.container,!isBlogPostPage?'margin-vert--sm':'',className),children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_site_src_components_reusables_date_tsx__WEBPACK_IMPORTED_MODULE_4__/* .Date */ .n9,{date:date,formattedDate:formattedDate}),typeof readingTime!=='undefined'&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_site_src_components_reusables_date_tsx__WEBPACK_IMPORTED_MODULE_4__/* .Spacer */ .hK,{}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_site_src_components_reusables_date_tsx__WEBPACK_IMPORTED_MODULE_4__/* .ReadingTime */ .uR,{readingTime:readingTime})]})]});}}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogPostItemContainer(_ref){var _assets$image,_frontMatter$keywords;let children=_ref.children,className=_ref.className;const _useBlogPost=(0,client/* useBlogPost */.e7)(),frontMatter=_useBlogPost.frontMatter,assets=_useBlogPost.assets,description=_useBlogPost.metadata.description;const _useBaseUrlUtils=(0,useBaseUrl/* useBaseUrlUtils */.hH)(),withBaseUrl=_useBaseUrlUtils.withBaseUrl;const image=(_assets$image=assets.image)!==null&&_assets$image!==void 0?_assets$image:frontMatter.image;const keywords=(_frontMatter$keywords=frontMatter.keywords)!==null&&_frontMatter$keywords!==void 0?_frontMatter$keywords:[];return/*#__PURE__*/(0,jsx_runtime.jsxs)(StyledArticle,{className:className,itemProp:"blogPost",itemScope:true,itemType:"https://schema.org/BlogPosting",children:[description&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{itemProp:"description",content:description}),image&&/*#__PURE__*/(0,jsx_runtime.jsx)("link",{itemProp:"image",href:withBaseUrl(image,{absolute:true})}),keywords.length>0&&/*#__PURE__*/(0,jsx_runtime.jsx)("meta",{itemProp:"keywords",content:keywords.join(',')}),children]});}const StyledArticle=styled_components_browser_esm["default"].article.withConfig({displayName:"Container__StyledArticle",componentId:"sc-1ilgswo-0"})(["width:100%;max-width:100%;box-sizing:border-box;@media (min-width:1200px){max-width:90%;}"]);
// EXTERNAL MODULE: ./node_modules/@docusaurus/core/lib/client/exports/Link.js
var Link = __webpack_require__(328774);
// EXTERNAL MODULE: ./src/config/globals.js
var globals = __webpack_require__(61530);
 ...
 * LICENSE file in the root directory of this source tree.
 */// Internal Configs
function BlogPostItemHeaderTitle(){const _useBlogPost=(0,client/* useBlogPost */.e7)(),metadata=_useBlogPost.metadata,isBlogPostPage=_useBlogPost.isBlogPostPage;const permalink=metadata.permalink,title=metadata.title;return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:isBlogPostPage?/*#__PURE__*/(0,jsx_runtime.jsx)(PostTitle,{children:title}):/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{itemProp:"url",to:permalink,children:/*#__PURE__*/(0,jsx_runtime.jsx)(LinkText,{children:title})})});}const LinkText=styled_components_browser_esm["default"].h1.withConfig({displayName:"Title__LinkText",componentId:"sc-1u7sfya-0"})(["overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;color:var(--ifm-color-primary-blog) !important;font-family:DM Sans;font-size:1.5rem;font-style:normal;font-weight:700;line-height:36px;&:hover{color:var(--ifm-color-primary) !important;}"]);const PostTitle=styled_components_browser_esm["default"].h1.withConfig({displayName:"Title__PostTitle",componentId:"sc-1u7sfya-1"})(["color:var(--ifm-color-primary-blog) !important;font-family:DM Sans;font-size:2.625rem;font-style:normal;font-weight:700;line-height:55.5px;@media ","{font-size:25px;line-height:30px;}"],globals/* device */.jO.tablet);
// EXTERNAL MODULE: ./src/theme/BlogPostItem/Header/Info/index.js
var Info = __webpack_require__(834010);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function MaybeLink(props){if(props.href){return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,Object.assign({},props));}return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:props.children});}function BlogPostItemHeaderAuthor(_ref){let author=_ref.author,index=_ref.index;const baseURL=(0,useSiteBaseUrl/* useSiteBaseUrl */.p)()||'';const name=author.name,title=author.title,url=author.url,imageURL=author.imageURL,email=author.email;const link=url||email&&"mailto:"+email||undefined;// Handle image URL construction for different environments
...
return baseURL+'/'+imageURL;};return/*#__PURE__*/(0,jsx_runtime.jsxs)(AvatarDiv,{children:[imageURL&&/*#__PURE__*/(0,jsx_runtime.jsx)(MaybeLink,{href:link,className:"avatar__photo-link",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Img,{src:getImageSrc(),alt:name,itemProp:"image"})}),/*#__PURE__*/(0,jsx_runtime.jsxs)(AvatarItem,{children:[name&&/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{itemProp:"author",itemScope:true,itemType:"https://schema.org/Person",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"avatar__name",children:/*#__PURE__*/(0,jsx_runtime.jsx)(MaybeLink,{href:link,itemProp:"url",children:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{itemProp:"name",children:name})})}),title&&/*#__PURE__*/(0,jsx_runtime.jsx)("small",{className:"avatar__subtitle",itemProp:"description",children:title})]}),index===0&&/*#__PURE__*/(0,jsx_runtime.jsx)(Info/* default */.A,{})]})]});}const AvatarItem=styled_components_browser_esm["default"].div.withConfig({displayName:"Author__AvatarItem",componentId:"sc-zksgx5-0"})(["display:flex;flex-direction:column;"]);const Img=styled_components_browser_esm["default"].img.withConfig({displayName:"Author__Img",componentId:"sc-zksgx5-1"})(["width:56px;height:56px;border:var(--ifm-blog-avatar-border);border-radius:100%;background:white;"]);const AvatarDiv=styled_components_browser_esm["default"].div.withConfig({displayName:"Author__AvatarDiv",componentId:"sc-zksgx5-2"})(["display:flex;flex-direction:row;gap:16px;align-items:center;"]);
// EXTERNAL MODULE: ./src/theme/BlogPostItem/Header/Authors/styles.module.css
var styles_module = __webpack_require__(531378);
...
function BlogPostItemHeaderAuthors(_ref){let className=_ref.className;const _useBlogPost=(0,client/* useBlogPost */.e7)(),authors=_useBlogPost.metadata.authors,assets=_useBlogPost.assets;const authorsCount=authors.length;if(authorsCount===0){return null;}const imageOnly=authors.every(_ref2=>{let name=_ref2.name;return!name;});return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx_m/* default */.A)('margin-top--md margin-bottom--sm',imageOnly?styles_module/* default */.A.imageOnlyAuthorRow:'row',className),children:authors.map((author,idx)=>{var _assets$authorsImageU;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx_m/* default */.A)(!imageOnly&&'col col--6',imageOnly?styles_module/* default */.A.imageOnlyAuthorCol:styles_module/* default */.A.authorCol),children:/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemHeaderAuthor,{index:idx,author:Object.assign({},author,{// Handle author images using relative paths
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogPostItemHeader(_ref){let list=_ref.list;const _useBlogPost=(0,client/* useBlogPost */.e7)(),isBlogPostPage=_useBlogPost.isBlogPostPage;if(list){return/*#__PURE__*/(0,jsx_runtime.jsxs)("header",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Info/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemHeaderTitle,{})]});}else{return/*#__PURE__*/(0,jsx_runtime.jsxs)("header",{children:[isBlogPostPage&&/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemHeaderAuthors,{}),!isBlogPostPage&&/*#__PURE__*/(0,jsx_runtime.jsx)(Info/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemHeaderTitle,{})]});}}
...
var modern_queryClient = __webpack_require__(964756);
...
var MDXContent = __webpack_require__(520636);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogPostItemContent(_ref){var _metadata$frontMatter2;let children=_ref.children,className=_ref.className;const _useBlogPost=(0,client/* useBlogPost */.e7)(),isBlogPostPage=_useBlogPost.isBlogPostPage,metadata=_useBlogPost.metadata;const _useState=(0,react.useState)(false),hasInjectedSocialButtons=_useState[0],setHasInjectedSocialButtons=_useState[1];const contentRef=(0,react.useRef)(null);const injectSocialButtons=()=>{var _contentRef$current,_metadata$frontMatter;const firstImage=(_contentRef$current=contentRef.current)===null||_contentRef$current===void 0?void 0:_contentRef$current.querySelector('p > img');if(!firstImage)return false;const socialContainer=document.createElement('div');const insertionPoint=firstImage.parentNode.nextSibling;firstImage.parentNode.parentNode.insertBefore(socialContainer,insertionPoint);const _require=__webpack_require__(205338),createRoot=_require.createRoot;const queryClient=new modern_queryClient/* QueryClient */.E();const root=createRoot(socialContainer);root.render(/*#__PURE__*/(0,jsx_runtime.jsx)(QueryClientProvider/* QueryClientProvider */.Ht,{client:queryClient,children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{marginBottom:'32px'},children:/*#__PURE__*/(0,jsx_runtime.jsx)(LikeAndRetweetItem/* default */.A,{twitterId:metadata===null||metadata===void 0||(_metadata$frontMatter=metadata.frontMatter)===null||_metadata$frontMatter===void 0?void 0:_metadata$frontMatter.twitterId})})}));return true;};(0,react.useEffect)(()=>{if(!isBlogPostPage||hasInjectedSocialButtons||!contentRef.current){return;}const timer=setTimeout(()=>{const success=injectSocialButtons();if(success){setHasInjectedSocialButtons(true);}},100);return()=>clearTimeout(timer);},[isBlogPostPage,hasInjectedSocialButtons,metadata===null||metadata===void 0||(_metadata$frontMatter2=metadata.frontMatter)===null||_metadata$frontMatter2===void 0?void 0:_metadata$frontMatter2.twitterId]);return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{id:isBlogPostPage?lib/* blogPostContainerID */.LU:undefined,className:(0,clsx_m/* default */.A)('markdown',className),itemProp:"articleBody",ref:contentRef,children:/*#__PURE__*/(0,jsx_runtime.jsx)(MDXContent/* default */.A,{children:children})});}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function ReadMoreLabel(){return/*#__PURE__*/(0,jsx_runtime.jsx)("b",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(Translate/* default */.A,{id:"theme.blog.post.readMore",description:"The label used in blog post item excerpts to link to full blog posts",children:"Read More"})});}function BlogPostItemFooterReadMoreLink(props){const blogPostTitle=props.blogPostTitle,linkProps=(0,objectWithoutPropertiesLoose/* default */.A)(props,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,Object.assign({"aria-label":(0,Translate/* translate */.T)({message:'Read more about {title}',id:'theme.blog.post.readMoreLabel',description:'The ARIA label for the link to full blog posts from excerpts'},{title:blogPostTitle})},linkProps,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(ReadMoreLabel,{})}));}
// EXTERNAL MODULE: ./src/theme/BlogPostItem/Footer/styles.module.css
var Footer_styles_module = __webpack_require__(522329);
...
function useContainerClassName(){const _useBlogPost=(0,client/* useBlogPost */.e7)(),isBlogPostPage=_useBlogPost.isBlogPostPage;const isMobile=(0,useMediaQuery/* default */.A)(globals/* device */.jO.tablet);return!isBlogPostPage&&!isMobile?'margin-bottom--xl':!isBlogPostPage&&isMobile?'margin-bottom--md':undefined;}function BlogPostItem(_ref){let children=_ref.children,className=_ref.className,list=_ref.list;const containerClassName=useContainerClassName();const _useBlogPost2=(0,client/* useBlogPost */.e7)(),isBlogPostPage=_useBlogPost2.isBlogPostPage,metadata=_useBlogPost2.metadata;const permalink=metadata.permalink;if(list){var _children$type;return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{itemProp:"url",to:permalink,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(ListView,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Content,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemContent,{children:children})}),/*#__PURE__*/(0,jsx_runtime.jsxs)(TextView,{children:[!isBlogPostPage&&/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemHeader,{list:list}),/*#__PURE__*/(0,jsx_runtime.jsx)(TextSpan,{children:children===null||children===void 0||(_children$type=children.type)===null||_children$type===void 0||(_children$type=_children$type.frontMatter)===null||_children$type===void 0?void 0:_children$type.text}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemFooter,{})]})]})});}else{var _children$type2;return/*#__PURE__*/(0,jsx_runtime.jsxs)(BlogPostItemContainer,{className:(0,clsx_m/* default */.A)(containerClassName,className),children:[isBlogPostPage&&/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemHeader,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemContent,{children:children}),!isBlogPostPage&&/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemHeader,{}),!isBlogPostPage&&/*#__PURE__*/(0,jsx_runtime.jsx)(TextSpan,{children:children===null||children===void 0||(_children$type2=children.type)===null||_children$type2===void 0||(_children$type2=_children$type2.frontMatter)===null||_children$type2===void 0?void 0:_children$type2.text}),/*#__PURE__*/(0,jsx_runtime.jsx)(BlogPostItemFooter,{})]});}}const ListView=styled_components_browser_esm["default"].div.withConfig({displayName:"BlogPostItem__ListView",componentId:"sc-wy7hmx-0"})(["display:flex;flex-direction:row;margin:32px 0;align-items:center;gap:32px;@media (max-width:1200px){flex-direction:column;gap:0px;}&:hover h1{color:var(--ifm-color-primary) !important;}"]);const Content=styled_components_browser_esm["default"].div.withConfig({displayName:"BlogPostItem__Content",componentId:"sc-wy7hmx-1"})(["min-width:544px;max-width:544px;@media (max-width:1200px){min-width:100%;max-width:100%;}"]);const TextView=styled_components_browser_esm["default"].div.withConfig({displayName:"BlogPostItem__TextView",componentId:"sc-wy7hmx-2"})(["@media (max-width:1200px){width:100%;}"]);const TextSpan=styled_components_browser_esm["default"].div.withConfig({displayName:"BlogPostItem__TextSpan",componentId:"sc-wy7hmx-3"})(["color:var(--ifm-color-secondary-blog);font-family:DM Sans,sans-serif;font-size:1.25rem;font-style:normal;font-weight:300;line-height:32px;margin-bottom:20px;overflow:hidden;display:-webkit-box !important;-webkit-line-clamp:3;-webkit-box-orient:vertical;"]);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(296540);
/* harmony import */ var _docusaurus_Link__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(328774);
/* harmony import */ var react_icons_bs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(796710);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(309751);
/* harmony import */ var _site_src_api_GetTwitterMetrics__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(976170);
/* harmony import */ var _site_src_config_globals__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(61530);
/* harmony import */ var _site_src_hooks_useMediaQuery__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(452005);
/* harmony import */ var _site_src_css_SharedStyling__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(113490);
/* harmony import */ var _site_src_utils_FormatTwitterCount__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(515874);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(474848);
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-nocheck
//
const LikeAndRetweetItem=_ref=>{let twitterId=_ref.twitterId,text=_ref.text;const isMobile=(0,_site_src_hooks_useMediaQuery__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(_site_src_config_globals__WEBPACK_IMPORTED_MODULE_5__/* .device */ .jO.tablet);const _useTweetMetrics=(0,_site_src_api_GetTwitterMetrics__WEBPACK_IMPORTED_MODULE_4__/* .useTweetMetrics */ .k)(twitterId),twitterData=_useTweetMetrics.data;const trackLikeClick=()=>{if(typeof window!=='undefined'&&window.gtag){window.gtag('event','blog_like_click',{event_category:'engagement',event_label:twitterId,value:1});}};const trackRetweetClick=()=>{if(typeof window!=='undefined'&&window.gtag){window.gtag('event','blog_retweet_click',{event_category:'engagement',event_label:twitterId,value:1});}};if(!twitterData)return null;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(ShareRow,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(ResponsiveH2,{weight:"500",spacing:"-0.02em",lineHeight:"110%",color:"#00000",children:text}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_site_src_css_SharedStyling__WEBPACK_IMPORTED_MODULE_7__/* .ItemH */ .Oj,{justifyContent:"flex-end",flexWrap:"nowrap",gap:"8px",margin:isMobile&&'20px 0 0 0',children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(LikeButton,{title:"Developer Docs",self:isMobile?'stretch':'self',href:"https://x.com/PushChain/status/"+twitterId,target:"_blank",rel:"noopener noreferrer",title:"Like this post",onClick:trackLikeClick,children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(react_icons_bs__WEBPACK_IMPORTED_MODULE_2__.BsHeart,{size:22,color:"var(--ifm-color-primary-text)",style:{marginRight:'10px'}}),(0,_site_src_utils_FormatTwitterCount__WEBPACK_IMPORTED_MODULE_8__/* .formatTwitterCount */ .Q)(twitterData===null||twitterData===void 0?void 0:twitterData.like_count)||'']}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(RetweetButton,{title:"Developer Docs",href:"https://twitter.com/intent/retweet?tweet_id="+twitterId,target:"_blank",rel:"noopener noreferrer",title:"Retweet this post",onClick:trackRetweetClick,children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(react_icons_bs__WEBPACK_IMPORTED_MODULE_2__.BsTwitterX,{size:22,color:"var(--ifm-color-white)",style:{marginRight:'10px'}}),"Retweet"]})]})]});};const ResponsiveH2=(0,styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_site_src_css_SharedStyling__WEBPACK_IMPORTED_MODULE_7__.H2).withConfig({displayName:"LikeAndRetweetItem__ResponsiveH2",componentId:"sc-c60ajk-0"})(["font-size:1.25rem;@media ","{font-size:1.25rem;}"],_site_src_config_globals__WEBPACK_IMPORTED_MODULE_5__/* .device */ .jO.mobileL);const ShareRow=styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({displayName:"LikeAndRetweetItem__ShareRow",componentId:"sc-c60ajk-1"})(["display:flex;justify-content:space-between;align-items:center;@media ","{display:flex;flex-direction:column;justify-content:space-between;align-items:center;}"],_site_src_config_globals__WEBPACK_IMPORTED_MODULE_5__/* .device */ .jO.mobileL);const RetweetButton=(0,styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A).withConfig({displayName:"LikeAndRetweetItem__RetweetButton",componentId:"sc-c60ajk-2"})(["background:var(--ifm-color-custom-pink);border-radius:16px;padding:14px 20px;font-size:1rem;font-weight:500;letter-spacing:-0.03em;line-height:26px;display:flex;flex-direction:row;align-items:center;border:none;color:var(--ifm-color-white);align-self:",";&:hover{color:var(--ifm-color-white);opacity:0.8;cursor:pointer;}@media ","{width:100%;justify-content:center;}"],props=>props.self,_site_src_config_globals__WEBPACK_IMPORTED_MODULE_5__/* .device */ .jO.mobileL);const LikeButton=(0,styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A).withConfig({displayName:"LikeAndRetweetItem__LikeButton",componentId:"sc-c60ajk-3"})(["background:transparent;border-radius:16px;padding:14px 20px;font-size:1rem;font-weight:500;letter-spacing:-0.03em;line-height:26px;display:flex;flex-direction:row;align-items:center;border:1.5px solid var(--ifm-like-border-color);color:var(--ifm-color-primary-text);align-self:",";&:hover{color:var(--ifm-color-primary-text);opacity:0.8;cursor:pointer;}@media ","{width:100%;justify-content:center;}"],props=>props.self,_site_src_config_globals__WEBPACK_IMPORTED_MODULE_5__/* .device */ .jO.mobileL);/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LikeAndRetweetItem);
...
/* harmony export */ });
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(320053);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(296540);
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(309751);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(474848);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(296540);
/* harmony import */ var _docusaurus_Translate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(721312);
/* harmony import */ var _theme_Tag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(150058);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(309751);
/* harmony import */ var _site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(61530);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(474848);
/**
...
function TagsListInline(_ref){let tags=_ref.tags;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment,{children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Ul,{children:tags.map(_ref2=>{let label=_ref2.label,tagPermalink=_ref2.permalink;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Li,{children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_theme_Tag__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{label:label,permalink:tagPermalink})},tagPermalink);})})});}const Li=styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].li.withConfig({displayName:"TagsListInline__Li",componentId:"sc-1ggehkj-0"})(["list-style:none;display:flex !important;flex-direction:row;flex-wrap:wrap;margin:0 0.4rem 0.5rem 0;@media ","{display:flex !important;flex-direction:row;flex-wrap:wrap;}"],_site_src_config_globals__WEBPACK_IMPORTED_MODULE_4__/* .device */ .jO.laptopL);const Ul=styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].ul.withConfig({displayName:"TagsListInline__Ul",componentId:"sc-1ggehkj-1"})(["margin:0 0;padding:0 0;display:flex !important;flex-direction:row;flex-wrap:wrap;"]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"blogPostFooterDetailsFull":"blogPostFooterDetailsFull_Wr5y"});
    if(true) {
      (function() {
        var localsJsonString = "{\"blogPostFooterDetailsFull\":\"blogPostFooterDetailsFull_Wr5y\"}";
        // 1788428312747
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"authorCol":"authorCol_q4o9","imageOnlyAuthorRow":"imageOnlyAuthorRow_lXe7","imageOnlyAuthorCol":"imageOnlyAuthorCol_cxD5"});
    if(true) {
      (function() {
        var localsJsonString = "{\"authorCol\":\"authorCol_q4o9\",\"imageOnlyAuthorRow\":\"imageOnlyAuthorRow_lXe7\",\"imageOnlyAuthorCol\":\"imageOnlyAuthorCol_cxD5\"}";
        // 1788428313271
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"container":"container_iJTo"});
    if(true) {
      (function() {
        var localsJsonString = "{\"container\":\"container_iJTo\"}";
        // 1788428312758
        var cssReload = __webpack_require__(129140)(module.id, {"esModule":true});
        // only invalidate when locals change
        if (
