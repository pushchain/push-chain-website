"use strict";
(globalThis["webpackChunkpush_chain_website"] = globalThis["webpackChunkpush_chain_website"] || []).push([[58693],{
...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9002);
...
var TextDimensionCalculatorWithFont = class {
  ...
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_chunk_U2HBQHQK_mjs__WEBPACK_IMPORTED_MODULE_1__/* .computeDimensionOfText */ .W6)(elem, 1, t);
...
function getChartDefaultThemeConfig() {
  const defaultThemeVariables = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getThemeVariables */ .P$)();
  const config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(getChartDefaultThemeConfig, "getChartDefaultThemeConfig");
function getChartDefaultConfig() {
  const config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(
    _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.xyChart,
    config.xyChart
  );
}
...
function textSanitizer(text) {
  const config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .sanitizeText */ .jZ)(text.trim(), config);
}
...
function getDrawableElem() {
  ...
  xyChartData.title = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getDiagramTitle */ .ab)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((txt, id, _version, diagObj) => {
  ...
  (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */ .a$)(svg, chartConfig.height, chartConfig.width, true);
      ...
      case "rect":
        ...
        if (chartConfig.showDataLabel) {
          ...
          if (chartConfig.chartOrientation === "horizontal") {
            ...
            const determineLabelXPosition = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((item) => {
            ...
            const uniformFontSize = Math.floor(Math.min(...candidateFontSizes));
            const determineLabelYPosition = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((item) => {
              if (showDataLabelOutsideBar) {
