...
This mapping is stored on the [UEAFactory contract](/push-chain-website/pr-preview/pr-1244/docs/chain/build/contract-helpers/#ueafactory-interface) and can be queried either **on-chain** or through the SDK. This ensures every user’s identity remains consistent across chains, and their UEA always maps back to the same origin wallet.
...
-   🔁 [Universal Counter Tutorial](/push-chain-website/pr-preview/pr-1244/docs/chain/tutorials/basics/tutorial-universal-counter/#live-playground) — showcases UEA persistence across origin chains.
