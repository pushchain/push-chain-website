(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[3056],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_07_reading_blockchain_state_mdx_0a0_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-07-reading-blockchain-state-mdx-0a0.json
const site_docs_chain_03_build_07_reading_blockchain_state_mdx_0a0_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/docs-chain-build-reading-blockchain-state","title":"Reading Blockchain State","description":"Reading Blockchain State | Build | Push Chain Docs","source":"@site/docs/chain/03-build/07-Reading-Blockchain-State.mdx","sourceDirName":"chain/03-build","slug":"/chain/build/reading-blockchain-state","permalink":"/push-chain-website/pr-preview/pr-1244/docs/chain/build/reading-blockchain-state","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/07-Reading-Blockchain-State.mdx","tags":[],"version":"current","sidebarPosition":7,"frontMatter":{"id":"docs-chain-build-reading-blockchain-state","title":"Reading Blockchain State","hide_title":false,"slug":"./reading-blockchain-state","displayed_sidebar":"pushChainSidebar","sidebar_position":7,"image":"/assets/docs/previews/docs_chain_build--reading_blockchain_state.png"},"sidebar":"pushChainSidebar","previous":{"title":"Utility Functions","permalink":"/push-chain-website/pr-preview/pr-1244/docs/chain/build/utility-functions"},"next":{"title":"Contract Helpers","permalink":"/push-chain-website/pr-preview/pr-1244/docs/chain/build/contract-helpers"}}');
...
;// ./docs/chain/03-build/07-Reading-Blockchain-State.mdx
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        ...
        children: "Choose between default (pruned) and archive RPC endpoints"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
      ...
      title: "Looking for state from other chains?",
      type: "note",
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["This page is about reading state over RPC from your frontend or backend, using standard tools like ethers and viem. If you need state from another chain (or from a web API) delivered on-chain to a Push Chain contract, with validators agreeing on the result and an optional callback, use ", (0,jsx_runtime.jsx)(_components.a, {
