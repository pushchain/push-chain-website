"use strict";
(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[73436],{
...
let W3mSwapView = class W3mSwapView extends lit/* LitElement */.WF {
    ...
    onSetMaxValue(target, balance) {
        ...
        const { networkAddress } = SwapController/* SwapController */.GN.getParams();
        const gasFee = SwapController/* SwapController */.GN.state.gasFee;
        if (target === 'sourceToken' && token?.address === networkAddress && gasFee && gasFee !== '0') {
            ...
            const gasCost = NumberUtil/* NumberUtil */.S.bigNumber(gasCostWei.toString()).div(NumberUtil/* NumberUtil */.S.bigNumber(10).pow(decimals));
