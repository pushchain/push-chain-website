(self["webpackChunkpush_chain_website"] = self["webpackChunkpush_chain_website"] || []).push([[38078],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_chain_03_build_03_universal_transactions_04_send_multichain_transactions_mdx_a4a_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-chain-03-build-03-universal-transactions-04-send-multichain-transactions-mdx-a4a.json
const site_docs_chain_03_build_03_universal_transactions_04_send_multichain_transactions_mdx_a4a_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"chain/build/universal-transactions/docs-chain-build-send-multichain-transactions","title":"Send Multichain Transactions","description":"Send Multichain Transactions | Build | Push Chain Docs","source":"@site/docs/chain/03-build/03-universal-transactions/04-Send-Multichain-Transactions.mdx","sourceDirName":"chain/03-build/03-universal-transactions","slug":"/chain/build/send-multichain-transactions","permalink":"/push-chain-website/pr-preview/pr-1244/docs/chain/build/send-multichain-transactions","draft":false,"unlisted":false,"editUrl":"https://github.com/pushchain/push-chain-website/blob/main/docs/chain/03-build/03-universal-transactions/04-Send-Multichain-Transactions.mdx","tags":[],"version":"current","sidebarPosition":4,"frontMatter":{"id":"docs-chain-build-send-multichain-transactions","title":"Send Multichain Transactions","hide_title":false,"slug":"/chain/build/send-multichain-transactions","displayed_sidebar":"pushChainSidebar","sidebar_position":4,"image":"/assets/docs/previews/docs_chain_build--send_multichain_transactions.png"},"sidebar":"pushChainSidebar","previous":{"title":"Universal Transaction Scenarios","permalink":"/push-chain-website/pr-preview/pr-1244/docs/chain/build/universal-transaction-scenarios"},"next":{"title":"Contract-Initiated Multichain Execution","permalink":"/push-chain-website/pr-preview/pr-1244/docs/chain/build/contract-initiated-multichain-execution"}}');
...
;// ./docs/chain/03-build/03-universal-transactions/04-Send-Multichain-Transactions.mdx
...
const frontMatter = {
	...
	hide_title: false,
	slug: '/chain/build/send-multichain-transactions',
