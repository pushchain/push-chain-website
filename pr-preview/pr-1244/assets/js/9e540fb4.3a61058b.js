...
const toc = [{
  ...
  "value": "Working with Users from Other Chains",
  "id": "working-with-users-from-other-chains",
  "level": 2
}, {
  "value": "Working with Universal Read",
  "id": "working-with-universal-read",
  "level": 2
}, {
  "value": "Moving Tokens Across Chains",
  "id": "moving-tokens-across-chains",
  "level": 2
}, {
  "value": "Speed run",
  "id": "speed-run",
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(Head, {
      ...
      id: "working-with-users-from-other-chains",
      children: "Working with Users from Other Chains"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "On Push Chain, a user can call your contract directly or from another chain like Ethereum Sepolia or Solana Devnet. Either way the call arrives as a normal transaction, so by default your contract has no idea where the user came from. Push Chain provides helper contracts that resolve any caller to its origin: the chain they came from and their address on it. This lets you:"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Tailor app behavior depending on user origin, such as showing chain-specific flows"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Monitor multichain adoption of your app"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Reward or incentivize activity coming from specific chains"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The helpers are deployed and maintained by Push Chain, so it is one call from your contract. See ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/docs/chain/build/contract-helpers/",
        children: "Contract Helpers"
      }), " for the interface and examples."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "working-with-universal-read",
      children: "Working with Universal Read"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: [(0,jsx_runtime.jsx)(_components.a, {
        href: "/docs/chain/build/universal-read/",
        children: "Read Universal State"
      }), " brings state from other blockchains, or from HTTPS endpoints, onto Push Chain with validator agreement. A typical use is a contract that needs a user's balance on Ethereum, a price from an API, or the state of a contract on Solana before it acts."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Use it when the result needs to land on-chain. When only your frontend or backend needs the data, a plain RPC call is cheaper and faster, and there is nothing to wait for."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "A read is a paid, asynchronous request: it costs gas plus a protocol fee, and the result arrives after validators agree on it. So save the request references before waiting, and check the full result before using the value. The Read Universal State page covers the flow, failure handling and recovery."
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "moving-tokens-across-chains",
      children: "Moving Tokens Across Chains"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Push Chain has two token standards:"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          children: "PRC-20"
        }), " for tokens that come in from an external chain, and"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          children: "PC-20"
        }), " for Push-native tokens that go out to one."]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      ...
      }), " for the distinction. Two habits will save you most of the debugging:"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            children: "Resolve decimals, never hardcode them."
          }), (0,jsx_runtime.jsx)("br", {}), "\n", (0,jsx_runtime.jsx)(_components.code, {
            children: "parseUnits('1', 6)"
          }), " is only correct for six-decimal tokens such as USDC and USDT. Both ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "getPRC20Address()"
          }), " and ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "getPC20Address()"
          }), " return the token's decimals."]
        }), "\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "Resolve the token first, then pass what it reports. Hardcoding the wrong exponent does not throw; it silently moves the wrong amount."
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsxs)(_components.strong, {
            children: ["When naming a token's chain, name where it ", (0,jsx_runtime.jsx)(_components.em, {
              children: "is"
            }), "."]
            ...
            children: "chain"
          }), " is the chain the tokens are sitting on right now, not the chain they are headed to. The destination is a separate field. Getting this backwards is rejected before anything is signed, so it fails loudly, but it is the single most common first mistake."]
        }), "\n"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "speed-run",
