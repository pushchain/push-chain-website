...
`
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        }), ": when a spec your contract builds leaves ", (0,jsx_runtime.jsx)(_components.code, {
          children: "revertRecipient"
        }), " as ", (0,jsx_runtime.jsx)(_components.code, {
          children: "address(0)"
        }), ", it defaults to the contract itself, so the contract needs a payable ", (0,jsx_runtime.jsx)(_components.code, {
          children: "receive()"
        }), ", or you point ", (0,jsx_runtime.jsx)(_components.code, {
          children: "revertRecipient"
        }), " at an EOA. Specs prepared by the SDK already carry the caller's Push account"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: [(0,jsx_runtime.jsx)(_components.strong, {
          children: "Gas bound"
          ...
          children: [(0,jsx_runtime.jsxs)(_components.tr, {
            ...
            children: [(0,jsx_runtime.jsx)(_components.td, {
              ...
              children: ["Where unused callback budget is returned. ", (0,jsx_runtime.jsx)(_components.code, {
                ...
                children: "receive()"
              }), " or point it at an EOA. The SDK fills it with the caller's Push account, or ", (0,jsx_runtime.jsx)(_components.code, {
                children: "refundTo"
              }), "."]
            })]
          })]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        children: ["Note: ", (0,jsx_runtime.jsx)(_components.code, {
          ...
          children: "payable"
        }), ". The value is the protocol fee plus the callback budget, as prepared by the SDK. The budget must cover ", (0,jsx_runtime.jsx)(_components.code, {
          children: "callbackGasLimit × Push base fee"
        }), ", or the node never fulfils the request and it expires. Forward the spec and gas limit unchanged: the SDK matches the request it sent by target, gas limit and spec, and throws ", (0,jsx_runtime.jsx)(_components.code, {
          children: "READ_REQUEST_MISMATCH"
        }), " after the transaction is mined if they differ. If you gate the entrypoint, authorize the Push-side account that actually submits the request: ", (0,jsx_runtime.jsx)(_components.code, {
...
`
        ...
        children: [(0,jsx_runtime.jsx)(_components.code, {
          ...
          children: "FULFILLED"
        }), " in that case, and ", (0,jsx_runtime.jsx)(_components.code, {
          children: "outcome"
        }), " is ", (0,jsx_runtime.jsx)(_components.code, {
