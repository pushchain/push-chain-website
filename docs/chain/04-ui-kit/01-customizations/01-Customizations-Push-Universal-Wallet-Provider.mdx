...
<Details summary="`config.login.socials` Options" className="alert alert--minimal code">
...
<Details summary="`config.toast` Options" className="alert alert--minimal code">
