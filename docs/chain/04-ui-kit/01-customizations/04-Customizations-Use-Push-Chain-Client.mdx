...
function MyComponent() {
  const { pushChainClient, isLoading, error } = usePushChainClient(uid); // optional: uid parameter for targeting a specific wallet instance
...
| ----------------- | ------------------- | ------------------------------------- |
| `pushChainClient` | `PushChain \| null` | Initialized PushChain client instance |
