...
## Next Steps
- Up your app vibe with themizing UI Kit from [Theme Overrides Example](/docs/chain/ui-kit/advanced/theme-overrides-example)
- Ensure consistent styling of wallet connect button with [Button Theme Overrides Example](/docs/chain/ui-kit/advanced/button-theme-overrides-example)
