...
As previously mentioned, the unique aspect of this smart contract is its ability to determine all imperative details of the user **( msg.sender )** instantly and natively.

This means, for any given **msg.sender** address, the contract is able to quickly identify:
...
This is enabled using **UEAFactory Interface.**

## Understanding the Universal Counter App

### Including UEAFactory Interface

The first step is to include the UEAFactory interface in your contract.

_This can either be imported or directly included in your contract._

This interfaces provides you with the function - `getOriginForUEA()` which plays the critical role of fetching and returning the information about the caller ( **_msg.sender )._**

The function mainly returns 2 data:
...
## Let's Test our UniversalCounter
