...
> **Ready to build?**  
> • Follow our [Quickstart](/docs/chain/quickstart/) to deploy your app in minutes.  
  ...
  <TabItem value="pushchain" attributes={{className: "codetab pushchain"}} default>
    ...
    async function main() {
      ...
      const txHash = await pushChainClient.universal.sendTransaction({
        ...
        value: PushChain.utils.helpers.parseUnits('0.001', 18), // 0.001 PC in uPC - equivalent to BigInt('1000000000000000'), // $PC Value to send
      });
