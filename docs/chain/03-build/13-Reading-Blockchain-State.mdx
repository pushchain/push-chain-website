...
This page covers direct RPC queries. To deliver validator-agreed state from an external chain or HTTPS endpoint to a Push contract, use [Universal Read](/docs/chain/build/universal-read/). Universal Read submits a paid request on Push Chain and completes asynchronously.
