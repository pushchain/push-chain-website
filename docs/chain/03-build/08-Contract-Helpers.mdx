...
In order to use the UEAFactory in your contract, there are 2 simple ways:

1. Import it directly from Push Chain Core Repository, or
2. Define the interface manually in your solidity contract.

#### 1. Import it directly from Push Chain Core Repository

This step is exactly like you to import any other contract in your solidity code.
...
3. Import the interface in your contract
```solidity
