...
| Arguments | Type             | Description                                                                                                                                                |
| --------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _`\_id`_      | UniversalAccountId | The Universal Account information containing:<br/>- **chainNamespace**: Chain namespace identifier (e.g., "eip155" for EVM based chains, "solana" for Solana, etc.)<br/>- **chainId**: Chain ID of the source chain of the owner of this UEA.<br/>- **owner**: Owner's public key or address in bytes format. |
