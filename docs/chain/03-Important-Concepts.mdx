...
- **Universal Origin Accounts (UOAs)**<br />
  The original source-chain wallet in [chain agnostic address](#chain-agnostic-address-examples 'Examples of chain agnostic address') format that is behind each UEA.
