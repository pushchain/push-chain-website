...
**A read is a paid, asynchronous request.** It costs gas plus a protocol fee and a callback budget, and completes after validators reach quorum. See [Read Universal State](/docs/chain/build/universal-read/) for the SDK flow.
