...
Do not apply these edits until `https://push.org/api/mcp` is live and answering the initialize handshake (see the Deployment section of `mcp/README.md`). The docs team applies them at release.
